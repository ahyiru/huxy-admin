(self.webpackChunk=self.webpackChunk||[]).push([[506],{3323:function(Rr,zt){function te(L,ot){var c=L.length;L.push(ot);t:for(;0<c;){var S=c-1>>>1,x=L[S];if(0<ze(x,ot))L[S]=ot,L[c]=x,c=S;else break t}}function Bt(L){return L.length===0?null:L[0]}function u(L){if(L.length===0)return null;var ot=L[0],c=L.pop();if(c!==ot){L[0]=c;t:for(var S=0,x=L.length,E=x>>>1;S<E;){var F=2*(S+1)-1,O=L[F],$=F+1,C=L[$];if(0>ze(O,c))$<x&&0>ze(C,O)?(L[S]=C,L[$]=c,S=$):(L[S]=O,L[F]=c,S=F);else if($<x&&0>ze(C,c))L[S]=C,L[$]=c,S=$;else break t}}return ot}function ze(L,ot){var c=L.sortIndex-ot.sortIndex;return c!==0?c:L.id-ot.id}if(typeof performance=="object"&&typeof performance.now=="function"){var Ne=performance;zt.unstable_now=function(){return Ne.now()}}else{var ft=Date,A=ft.now();zt.unstable_now=function(){return ft.now()-A}}var ut=[],jt=[],Wr=1,Vt=null,Ht=3,N=!1,M=!1,B=!1,V=typeof setTimeout=="function"?setTimeout:null,H=typeof clearTimeout=="function"?clearTimeout:null,tt=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function J(L){for(var ot=Bt(jt);ot!==null;){if(ot.callback===null)u(jt);else if(ot.startTime<=L)u(jt),ot.sortIndex=ot.expirationTime,te(ut,ot);else break;ot=Bt(jt)}}function rt(L){if(B=!1,J(L),!M)if(Bt(ut)!==null)M=!0,Wt(vt);else{var ot=Bt(jt);ot!==null&&ae(rt,ot.startTime-L)}}function vt(L,ot){M=!1,B&&(B=!1,H(Pt),Pt=-1),N=!0;var c=Ht;try{for(J(ot),Vt=Bt(ut);Vt!==null&&(!(Vt.expirationTime>ot)||L&&!Mt());){var S=Vt.callback;if(typeof S=="function"){Vt.callback=null,Ht=Vt.priorityLevel;var x=S(Vt.expirationTime<=ot);ot=zt.unstable_now(),typeof x=="function"?Vt.callback=x:Vt===Bt(ut)&&u(ut),J(ot)}else u(ut);Vt=Bt(ut)}if(Vt!==null)var E=!0;else{var F=Bt(jt);F!==null&&ae(rt,F.startTime-ot),E=!1}return E}finally{Vt=null,Ht=c,N=!1}}var wt=!1,Ft=null,Pt=-1,lt=5,$t=-1;function Mt(){return!(zt.unstable_now()-$t<lt)}function Zt(){if(Ft!==null){var L=zt.unstable_now();$t=L;var ot=!0;try{ot=Ft(!0,L)}finally{ot?k():(wt=!1,Ft=null)}}else wt=!1}var k;if(typeof tt=="function")k=function(){tt(Zt)};else if(typeof MessageChannel<"u"){var Lt=new MessageChannel,Rt=Lt.port2;Lt.port1.onmessage=Zt,k=function(){Rt.postMessage(null)}}else k=function(){V(Zt,0)};function Wt(L){Ft=L,wt||(wt=!0,k())}function ae(L,ot){Pt=V(function(){L(zt.unstable_now())},ot)}zt.unstable_IdlePriority=5,zt.unstable_ImmediatePriority=1,zt.unstable_LowPriority=4,zt.unstable_NormalPriority=3,zt.unstable_Profiling=null,zt.unstable_UserBlockingPriority=2,zt.unstable_cancelCallback=function(L){L.callback=null},zt.unstable_continueExecution=function(){M||N||(M=!0,Wt(vt))},zt.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):lt=0<L?Math.floor(1e3/L):5},zt.unstable_getCurrentPriorityLevel=function(){return Ht},zt.unstable_getFirstCallbackNode=function(){return Bt(ut)},zt.unstable_next=function(L){switch(Ht){case 1:case 2:case 3:var ot=3;break;default:ot=Ht}var c=Ht;Ht=ot;try{return L()}finally{Ht=c}},zt.unstable_pauseExecution=function(){},zt.unstable_requestPaint=function(){},zt.unstable_runWithPriority=function(L,ot){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var c=Ht;Ht=L;try{return ot()}finally{Ht=c}},zt.unstable_scheduleCallback=function(L,ot,c){var S=zt.unstable_now();switch(typeof c=="object"&&c!==null?(c=c.delay,c=typeof c=="number"&&0<c?S+c:S):c=S,L){case 1:var x=-1;break;case 2:x=250;break;case 5:x=1073741823;break;case 4:x=1e4;break;default:x=5e3}return x=c+x,L={id:Wr++,callback:ot,priorityLevel:L,startTime:c,expirationTime:x,sortIndex:-1},c>S?(L.sortIndex=c,te(jt,L),Bt(ut)===null&&L===Bt(jt)&&(B?(H(Pt),Pt=-1):B=!0,ae(rt,c-S))):(L.sortIndex=x,te(ut,L),M||N||(M=!0,Wt(vt))),L},zt.unstable_shouldYield=Mt,zt.unstable_wrapCallback=function(L){var ot=Ht;return function(){var c=Ht;Ht=ot;try{return L.apply(this,arguments)}finally{Ht=c}}}},1102:function(Rr,zt,te){Rr.exports=te(3323)},4335:function(Rr,zt,te){var Bt;te.d(zt,{$j:function(){return Mt},AN:function(){return rt},BQ:function(){return wt},GK:function(){return Zt},Hn:function(){return H},JX:function(){return Ht},PC:function(){return jt},Ud:function(){return M},V7:function(){return J},X2:function(){return $t},dy:function(){return N},h_:function(){return lt},mH:function(){return B},pC:function(){return Wt},s_:function(){return Pt},u_:function(){return Ft},zd:function(){return vt}});var u=te(7378),ze=te(1542),Ne={269:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`/*@height:2px;
@width:18px;
...
`,""]),C.locals={anico:"nstud",hline:"IZUmD",close:"ylzxZ",right:"Wy_0M",bottom:"bdjKS",play:"QPs9T",pause:"tx7CH"};const U=C},528:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`.kLIGi {
  --bar-color: #fff;
  --bar-width: 16px;
  position: relative;
  overflow: hidden;
...
`,""]),C.locals={"huxy-carousel":"kLIGi","huxy-carousel-wrap":"XoNs4","carousel-item":"x4UPo","carousel-switch":"qYuQn",dot:"GU0qu",active:"svhYU"};const U=C},434:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`@keyframes animate-drawer-right-in {
  0% {
    opacity: 0;
...
`,""]),C.locals={"drawer-wrap":"KsHNu",open:"c6aFy",right:"mlowE",left:"w0B0d","drawer-container":"W4gG3","drawer-content":"SMORg","drawer-header":"e3AWW","ico-close":"VSVwl","drawer-footer":"hlj9r"};const U=C},503:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`@keyframes animate-drop-in {
  0% {
    opacity: 0;
...
`,""]),C.locals={"drop-target":"TEYHV","drop-wrap":"NCYpg",open:"qjBWI"};const U=C},548:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`@keyframes animate-modal-in {
  0% {
    opacity: 0;
...
`,""]),C.locals={"modal-wrap":"SqXAN",open:"S3vb_","modal-container":"RiDlb","modal-header":"xdqLE","modal-content":"C91AO","modal-footer":"J6dpF",btn:"XOnmm",left:"t1Fx9",right:"YGj9K"};const U=C},232:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`.clear::after {
  clear: both;
  content: "";
  display: block;
  height: 0;
...
`,""]),C.locals={panel:"J8VWE",shadow1:"ohmPp",shadow2:"JzE05","panel-body":"rOxNb","panel-header":"OQwTX","panel-title":"W_1K6","panel-plugins":"eCk2_",link:"R2Mku"};const U=C},249:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`.cols-1 {
  width: 8.33333333%;
}
.cols-2 {
  width: 16.66666667%;
...
`,""]),C.locals={};const U=C},990:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`@keyframes before {
  0% {
    width: 0.6rem;
...
`,""]),C.locals={};const U=C},575:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`.clear::after {
  clear: both;
  content: "";
  display: block;
  height: 0;
...
`,""]),C.locals={};const U=C},918:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`.ofth_ {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  display: inline-block;
...
`,""]),C.locals={ellipsis:"ofth_","huxy-tooltip":"hVmF3","huxy-tooltip-topRight":"uzFyE","huxy-tooltip-topLeft":"Giihu","huxy-tooltip-bottomRight":"bFVVt","huxy-tooltip-bottomLeft":"oGmKq","huxy-tooltip-rightTop":"svYWD"};const U=C},942:(c,S,x)=>{x.d(S,{Z:()=>U});var E=x(601),F=x.n(E),O=x(609),$=x.n(O),C=$()(F());C.push([c.id,`.node-right-icon-close {
  height: 100%;
...
`,""]),C.locals={};const U=C},609:c=>{c.exports=function(S){var x=[];return x.toString=function(){return this.map(function(E){var F="",O=typeof E[5]<"u";return E[4]&&(F+="@supports (".concat(E[4],") {")),E[2]&&(F+="@media ".concat(E[2]," {")),O&&(F+="@layer".concat(E[5].length>0?" ".concat(E[5]):""," {")),F+=S(E),O&&(F+="}"),E[2]&&(F+="}"),E[4]&&(F+="}"),F}).join("")},x.i=function(E,F,O,$,C){typeof E=="string"&&(E=[[null,E,void 0]]);var U={};if(O)for(var xt=0;xt<this.length;xt++){var kt=this[xt][0];kt!=null&&(U[kt]=!0)}for(var Ut=0;Ut<E.length;Ut++){var Q=[].concat(E[Ut]);O&&U[Q[0]]||(typeof C<"u"&&(typeof Q[5]>"u"||(Q[1]="@layer".concat(Q[5].length>0?" ".concat(Q[5]):""," {").concat(Q[1],"}")),Q[5]=C),F&&(Q[2]&&(Q[1]="@media ".concat(Q[2]," {").concat(Q[1],"}")),Q[2]=F),$&&(Q[4]?(Q[1]="@supports (".concat(Q[4],") {").concat(Q[1],"}"),Q[4]=$):Q[4]="".concat($)),x.push(Q))}},x}},601:c=>{c.exports=function(S){return S[1]}},837:(c,S,x)=>{var E,F=x(810),O=Symbol.for("react.element"),$=Symbol.for("react.fragment"),C=Object.prototype.hasOwnProperty,U=F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,xt={key:!0,ref:!0,__self:!0,__source:!0};function kt(Ut,Q,Xt){var _t,qt={},le=null,ee=null;Xt!==void 0&&(le=""+Xt),Q.key!==void 0&&(le=""+Q.key),Q.ref!==void 0&&(ee=Q.ref);for(_t in Q)C.call(Q,_t)&&!xt.hasOwnProperty(_t)&&(qt[_t]=Q[_t]);if(Ut&&Ut.defaultProps)for(_t in Q=Ut.defaultProps,Q)qt[_t]===void 0&&(qt[_t]=Q[_t]);return{$$typeof:O,type:Ut,key:le,ref:ee,props:qt,_owner:U.current}}E=$,S.jsx=kt,S.jsxs=kt},322:(c,S,x)=>{c.exports=x(837)},62:c=>{var S=[];function x(O){for(var $=-1,C=0;C<S.length;C++)if(S[C].identifier===O){$=C;break}return $}function E(O,$){for(var C={},U=[],xt=0;xt<O.length;xt++){var kt=O[xt],Ut=$.base?kt[0]+$.base:kt[0],Q=C[Ut]||0,Xt="".concat(Ut," ").concat(Q);C[Ut]=Q+1;var _t=x(Xt),qt={css:kt[1],media:kt[2],sourceMap:kt[3],supports:kt[4],layer:kt[5]};if(_t!==-1)S[_t].references++,S[_t].updater(qt);else{var le=F(qt,$);$.byIndex=xt,S.splice(xt,0,{identifier:Xt,updater:le,references:1})}U.push(Xt)}return U}function F(O,$){var C=$.domAPI($);C.update(O);var U=function(xt){if(xt){if(xt.css===O.css&&xt.media===O.media&&xt.sourceMap===O.sourceMap&&xt.supports===O.supports&&xt.layer===O.layer)return;C.update(O=xt)}else C.remove()};return U}c.exports=function(O,$){$=$||{},O=O||[];var C=E(O,$);return function(U){U=U||[];for(var xt=0;xt<C.length;xt++){var kt=C[xt],Ut=x(kt);S[Ut].references--}for(var Q=E(U,$),Xt=0;Xt<C.length;Xt++){var _t=C[Xt],qt=x(_t);S[qt].references===0&&(S[qt].updater(),S.splice(qt,1))}C=Q}}},793:c=>{var S={};function x(F){if(typeof S[F]>"u"){var O=document.querySelector(F);if(window.HTMLIFrameElement&&O instanceof window.HTMLIFrameElement)try{O=O.contentDocument.head}catch{O=null}S[F]=O}return S[F]}function E(F,O){var $=x(F);if(!$)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");$.appendChild(O)}c.exports=E},173:c=>{function S(x){var E=document.createElement("style");return x.setAttributes(E,x.attributes),x.insert(E,x.options),E}c.exports=S},892:(c,S,x)=>{function E(F){var O=x.nc;O&&F.setAttribute("nonce",O)}c.exports=E},36:c=>{function S(F,O,$){var C="";$.supports&&(C+="@supports (".concat($.supports,") {")),$.media&&(C+="@media ".concat($.media," {"));var U=typeof $.layer<"u";U&&(C+="@layer".concat($.layer.length>0?" ".concat($.layer):""," {")),C+=$.css,U&&(C+="}"),$.media&&(C+="}"),$.supports&&(C+="}");var xt=$.sourceMap;xt&&typeof btoa<"u"&&(C+=`
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(xt))))," */")),O.styleTagTransform(C,F,O.options)}function x(F){if(F.parentNode===null)return!1;F.parentNode.removeChild(F)}function E(F){if(typeof document>"u")return{update:function(){},remove:function(){}};var O=F.insertStyleElement(F);return{update:function($){S(O,F,$)},remove:function(){x(O)}}}c.exports=E},464:c=>{function S(x,E){if(E.styleSheet)E.styleSheet.cssText=x;else{for(;E.firstChild;)E.removeChild(E.firstChild);E.appendChild(document.createTextNode(x))}}c.exports=S},810:c=>{var S=E=>{var F={};return A.d(F,E),F},x=E=>()=>E;c.exports=Bt||(Bt=te.t(u,2))}},ft={};function A(c){var S=ft[c];if(S!==void 0)return S.exports;var x=ft[c]={id:c,exports:{}};return Ne[c](x,x.exports,A),x.exports}A.n=c=>{var S=c&&c.__esModule?()=>c.default:()=>c;return A.d(S,{a:S}),S},A.d=(c,S)=>{for(var x in S)A.o(S,x)&&!A.o(c,x)&&Object.defineProperty(c,x,{enumerable:!0,get:S[x]})},A.o=(c,S)=>Object.prototype.hasOwnProperty.call(c,S),A.nc=void 0;var ut={};(()=>{A.d(ut,{PC:()=>ee,rK:()=>tr,lr:()=>yr,JX:()=>_e,dy:()=>z,Ud:()=>Zr,mH:()=>q,SV:()=>Ct,Hn:()=>Xe,rj:()=>Gr,V7:()=>qe,AN:()=>se,zd:()=>we,BQ:()=>Jr,u_:()=>so,s_:()=>ho,h_:()=>Be,X2:()=>Ee,$j:()=>co,GK:()=>Ao,u:()=>m,mp:()=>Lo,C2:()=>Ot,pC:()=>St,ff:()=>to,d2:()=>Or,Uw:()=>Do});var c=A(322),S=A(62),x=A.n(S),E=A(36),F=A.n(E),O=A(793),$=A.n(O),C=A(892),U=A.n(C),xt=A(173),kt=A.n(xt),Ut=A(464),Q=A.n(Ut),Xt=A(269),_t={};_t.styleTagTransform=Q(),_t.setAttributes=U(),_t.insert=$().bind(null,"head"),_t.domAPI=F(),_t.insertStyleElement=kt();var qt=x()(Xt.Z,_t);const le=Xt.Z&&Xt.Z.locals?Xt.Z.locals:void 0,ee=i=>(0,c.jsx)("span",{className:le.anico,children:(0,c.jsx)("span",{className:[le.hline,...(i.type||"").split(" ").map(a=>le[a]).filter(Boolean)].join(" ")})});var K=A(810);const he=i=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(i),Qe=i=>new Promise((a,f)=>{const v=new FileReader;v.readAsDataURL(i),v.addEventListener("load",()=>a(v.result)),v.addEventListener("error",j=>f(j))}),Me=async i=>{if(!he(i))return i;const a=await(await fetch(decodeURIComponent(i))).blob();return await Qe(a)},Yr=i=>{const[a,f]=(0,K.useState)(i);return(0,K.useEffect)(()=>{(async v=>{const j=await Me(v);f(j)})(i)},[]),a},tr=({src:i,...a})=>{const f=Yr(i);return(0,c.jsx)("img",{...a,src:f})};var hr=i=>{var a={};return A.d(a,i),a},fr=i=>()=>i;const er=hr({createPortal:()=>ze.createPortal,flushSync:()=>ze.flushSync}),pr=(i,a)=>{const f=(0,K.useRef)();(0,K.useEffect)(()=>{f.current=i},[i]),(0,K.useEffect)(()=>{if(a){const v=setInterval(()=>f.current(),a);return()=>clearInterval(v)}},[a])},ce=()=>![typeof window,typeof document].includes("undefined"),rr=i=>Object.prototype.toString.call(i).slice(8,-1).toLowerCase(),Ae=i=>rr(i).indexOf("element")>-1,fe=(i=null)=>ce()?Ae(i)?{width:i.clientWidth,height:i.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},or=(i=()=>{},a=60)=>{let f=null;return function(...v){clearTimeout(f),f=setTimeout(()=>i.apply(this,v),a)}},mr=(i,a)=>Object.prototype.hasOwnProperty.call(i??{},a),oe=i=>mr(i,"current"),jr=(i,a)=>{const f=[],v=i.children??[];for(let j=0,I=v.length;j<I;j++){const R=v[j];R.className.indexOf(a)>-1&&f.push(R)}return f.length===0?null:f.length===1?f[0]:f},nr=(i,a)=>{getComputedStyle(i).position==="static"&&(i.style.position="relative");const f=document.createElement("object");return f.setAttribute("style","display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0"),f.setAttribute("class","resize-sensor"),f.onload=()=>{f.contentDocument.defaultView.addEventListener("resize",a,!1),a()},f.type="text/html",i.appendChild(f),f.data="about:blank",f},Vr=(i,a=60)=>{if(!ce())return;i=oe(i)?i.current:i??document.body;let f=jr(i,"resize-sensor"),v=[];const j=or(()=>v.map(nt=>nt(i)),a),I=nt=>{jr(i,"resize-sensor")||(f=nr(i,j)),v.indexOf(nt)===-1&&v.push(nt)},R=nt=>{const it=v.indexOf(nt);it!==-1&&v.splice(it,1),v.length===0&&f&&G()},G=()=>{f&&f.parentNode&&(f.contentDocument&&f.contentDocument.defaultView.removeEventListener("resize",j,!1),f.parentNode.removeChild(f),f=void 0,v=[])};return{element:i,bind:I,unbind:R,destroy:G}},xr=(i={})=>{const a=(0,K.useRef)(0),[f,v]=(0,K.useState)(i),j=(0,K.useCallback)(I=>{cancelAnimationFrame(a.current),a.current=requestAnimationFrame(()=>v(I))},[]);return(0,K.useEffect)(()=>()=>cancelAnimationFrame(a.current),[]),[f,j]},Mr=(i=null,a=60)=>{const f=oe(i)?i.current:i,{bind:v,destroy:j}=Vr(f,a),[I,R]=xr(fe(f));return(0,K.useEffect)(()=>(v(()=>f&&R(fe(f))),()=>j()),[f]),I};var Ie=A(528),Pe={};Pe.styleTagTransform=Q(),Pe.setAttributes=U(),Pe.insert=$().bind(null,"head"),Pe.domAPI=F(),Pe.insertStyleElement=kt();var ir=x()(Ie.Z,Pe);const ve=Ie.Z&&Ie.Z.locals?Ie.Z.locals:void 0,yr=({children:i,active:a=0,delay:f=5e3,className:v,...j})=>{const[I,R]=(0,K.useState)(a+1),[G,nt]=(0,K.useState)(!1),it=(0,K.useRef)(),bt=(0,K.useRef)(""),{width:ht}=Mr(it);i=Array.isArray(i)?i:[i];const mt=i[0],Gt=[i[i.length-1],...i,mt],re=Gt.length;pr(()=>{let Yt=I+1;Yt=Yt===re?1:Yt,bt.current&&(bt.current=""),R(Yt),Yt===re-1&&setTimeout(()=>{bt.current="none",R(1)},500)},G?null:f);const At=(Yt,ie)=>{ie.stopPropagation(),bt.current="",R(Yt),(0,er.flushSync)(()=>nt(!0)),nt(!1)},Dt={width:`${re*ht}px`,transform:`translateX(${-ht*I}px)`,transition:bt.current};return(0,c.jsxs)("div",{className:`${ve["huxy-carousel"]}${v?` ${v}`:""}`,...j,ref:it,children:[(0,c.jsx)("div",{className:ve["huxy-carousel-wrap"],style:Dt,children:Gt.map((Yt,ie)=>(0,c.jsx)("div",{className:`${ve["carousel-item"]} ${I===ie?ve.active:""}`,style:{width:`${ht}px`},children:Yt},`huxy-carousel-${ie}`))}),(0,c.jsx)("div",{className:ve["carousel-switch"],children:i.map((Yt,ie)=>(0,c.jsx)("span",{className:`${ve.dot} ${I===ie+1?ve.active:""}`,onClick:Ge=>At(ie+1,Ge)},`huxy-carousel-switch-${ie}`))})]})},$e=(i,a)=>{let f="",v="";if(typeof a=="number"&&(f=`col-${i}-${a}`),typeof a=="object"){const{span:j,offset:I}=a;f=j?`col-${i}-${j}`:"",v=I?`offset-${i}-${I}`:""}return{sp:f,os:v}},_e=(0,K.forwardRef)(({span:i,offset:a,xl:f,lg:v,md:j,sm:I,xs:R,style:G,width:nt,auto:it,offsetWidth:bt="0px",className:ht,...mt},Gt)=>{const re=ht?` ${ht}`:"",At=`col-${i||12}`,Dt=a?`offset-${a}`:"",{sp:Yt,os:ie}=$e("xs",R),{sp:Ge,os:Je}=$e("sm",I),{sp:Kr,os:Te}=$e("md",j),{sp:Er,os:ur}=$e("lg",v),{sp:Ye,os:de}=$e("xl",f),Ve=[At,Ye,Er,Kr,Ge,Yt,Dt,de,ur,Te,Je,ie].filter(Boolean).join(" "),Br=it?{width:"auto",flex:1,maxWidth:`calc(100% - ${bt})`}:{width:nt};return(0,c.jsx)("div",{className:`${Ve}${re}`,...mt,style:{...Br,...G},ref:Gt})}),Sr=()=>{const i=(0,K.useRef)(!0);return i.current?(i.current=!1,!0):!1},gr=(i,a=[])=>{const f=Sr();(0,K.useEffect)(()=>{if(!f)return i()},a)},zr=(i,a=450)=>{const[f,v]=(0,K.useState)(i);return gr(()=>{let j;return i||a===0?v(i):j=setTimeout(()=>v(i),a),()=>j&&clearTimeout(j)},[i]),[f,v]},Be=({children:i,mountNode:a=document.body})=>(0,er.createPortal)(i,a),Ze={position:"fixed",top:0,left:0,bottom:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",zIndex:99999},br={position:"fixed",top:0,left:0,bottom:0,right:0,background:"rgba(0, 0, 0, 0.5)",zIndex:1e5},$r=document.body,we=({open:i,close:a,delay:f=300,children:v,mountNode:j,hasMask:I=!0,style:R,className:G="h-mask",relative:nt})=>{const[it]=zr(i,f);(j??$r).style.overflow=it?"hidden":"";const bt=nt?"absolute":"fixed";return(0,c.jsx)(Be,{mountNode:j,children:(0,c.jsx)("div",{children:it?(0,c.jsxs)("div",{className:G,style:{...Ze,position:bt},children:[I?(0,c.jsx)("div",{style:{...br,position:bt},onClick:ht=>a?.(ht)}):null,K.Children.map(v,ht=>(0,K.isValidElement)(ht)?(0,K.cloneElement)(ht,{style:{position:"relative",zIndex:100001,...ht.props.style}}):ht)]}):null})})};var pe=A(434),s={};s.styleTagTransform=Q(),s.setAttributes=U(),s.insert=$().bind(null,"head"),s.domAPI=F(),s.insertStyleElement=kt();var b=x()(pe.Z,s);const y=pe.Z&&pe.Z.locals?pe.Z.locals:void 0,z=({open:i,close:a,footer:f,header:v,className:j,style:I,children:R,width:G="300px",mountNode:nt,position:it="right",relative:bt})=>{const ht=["drawer-wrap",it,i?"open":"",...j?.split(" ")??[]].filter(Boolean).map(mt=>y[mt]).join(" ");return(0,c.jsx)(we,{open:i,close:a,delay:250,hasMask:!0,relative:bt,mountNode:nt,className:"huxy-drawer",children:(0,c.jsx)("div",{className:ht,style:{width:G,position:bt?"absolute":"fixed",...I},children:(0,c.jsxs)("div",{className:y["drawer-container"],children:[(0,c.jsxs)("div",{className:y["drawer-header"],children:[(0,c.jsx)("span",{className:`link ${y["ico-close"]}`,onClick:mt=>a?.(mt)}),(0,c.jsx)("div",{children:v})]}),(0,c.jsx)("div",{className:y["drawer-content"],children:R}),f?(0,c.jsx)("div",{className:y["drawer-footer"],children:f}):null]})})})},T=(i,a,f="click")=>{(0,K.useEffect)(()=>{const v=I=>{const R=oe(i)?i.current:i;R?.contains&&!R.contains(I.target)&&a(I)},j=typeof f=="string"?[f]:f;return j.map(I=>{document.addEventListener(I,v,!1)}),()=>{j.map(I=>{document.removeEventListener(I,v,!1)})}},[i,a,f])},X=i=>i?.$$typeof&&typeof i.$$typeof=="symbol"&&i.$$typeof.description==="react.element",yt=(i="")=>i.replace(/^\S/,a=>a.toUpperCase()),dt=i=>{if(ce())return i=oe(i)?i.current:i??document.body,i.getBoundingClientRect?.()},at=i=>{if(!ce())return;const a=document.createElement("div");return a.innerHTML=i,a.children[0]},It=(i,a={},f=!1)=>{if(Ae(i)){if(f){let v="";Object.keys(a).map(j=>{v+=`${j}: ${a[j]};`}),i.style=v;return}Object.keys(a).map(v=>i.style.setProperty(v,a[v]))}},me=(i=350)=>new Promise(a=>setTimeout(a,i)),Le=(i=100)=>{const a=Date.now();for(;Date.now()-a<=i;);},He=me,xe=async(i,a=15)=>{if(!ce())return;if(typeof i=="string"&&(i=at(i)),i=oe(i)?i.current:i,!Ae(i))return{};const f=i.cloneNode(!0);It(f,{"pointer-events":"none","z-index":-1,opacity:0,display:"block",animation:"none"}),i.parentNode.appendChild(f),await He(a);const v=dt(f);return i.parentNode.removeChild(f),v},ar=/(\s|^)(huxy-drop-arrow-lt|huxy-drop-arrow-rt|huxy-drop-arrow-lb|huxy-drop-arrow-rb|huxy-drop-arrow-tl|huxy-drop-arrow-tr|huxy-drop-arrow-bl|huxy-drop-arrow-br)(\s|$)/,vr=/huxy-drop-arrow-lt|huxy-drop-arrow-rt|huxy-drop-arrow-lb|huxy-drop-arrow-rb|huxy-drop-arrow-tl|huxy-drop-arrow-tr|huxy-drop-arrow-bl|huxy-drop-arrow-br/,Fe=(i,a)=>{a=`huxy-drop-arrow-${a}`;const f=i.getAttribute("class")??"";ar.test(f)?i.setAttribute("class",f.replace(vr,a)):i.setAttribute("class",`${f} ${a}`)},ke=async(i,a,f)=>{const{left:v,right:j,top:I,bottom:R}=dt(i),{width:G,height:nt}=fe(),{width:it,height:bt}=await xe(a);if(j<0||R<0||v>G||I>nt)return{};if(f==="vertical"){const ht={left:v+"px",top:R+10+"px",right:"auto",bottom:"auto"};let mt="lt";v+it>G&&(ht.left=j-it+"px",mt="rt"),R+10+bt>nt&&(ht.top=I-10-bt+"px",mt=mt==="lt"?"lb":"rb"),It(a,ht),Fe(a,mt)}else{const ht={left:j+10+"px",top:I+"px",right:"auto",bottom:"auto"};let mt="tl";j+10+it>G&&(ht.left=v-10-it+"px",mt="tr"),I+bt>nt&&(ht.top=R-bt+"px",mt=mt==="tl"?"bl":"br"),It(a,ht),Fe(a,mt)}},Ce=(i,a,f="horizontal")=>{const v=or(ke),j=()=>v(i,a,f);window.addEventListener("scroll",j,!1),window.addEventListener("resize",j,!1);const I=()=>{window.removeEventListener("scroll",j),window.removeEventListener("resize",j),It(a,{left:"",top:"",right:"",bottom:""})};return ke(i,a,f),I},lo=({open:i,delay:a=250,children:f,mountNode:v,style:j,className:I="huxy-mask"})=>{const[R]=zr(i,a);return(0,c.jsx)(Be,{mountNode:v,children:(0,c.jsx)("div",{children:(0,c.jsx)("div",{className:I,children:(0,c.jsx)("div",{style:{...j,display:R?"block":"none"},children:f})})})})};var Ue=A(503),Re={};Re.styleTagTransform=Q(),Re.setAttributes=U(),Re.insert=$().bind(null,"head"),Re.domAPI=F(),Re.insertStyleElement=kt();var no=x()(Ue.Z,Re);const _r=Ue.Z&&Ue.Z.locals?Ue.Z.locals:void 0,Zr=({trigger:i="click",type:a,dropList:f,className:v,wrapStyle:j,children:I,...R})=>{const[G,nt]=(0,K.useState)(!1),it=(0,K.useRef)(),bt=(0,K.useRef)(),ht=(0,K.useRef)();T(it,Dt=>G&&nt(!1),[...new Set(["click",i.toLowerCase()])]),(0,K.useEffect)(()=>()=>ht.current?.(),[]);const mt=Dt=>{Dt.preventDefault(),nt(!0),ht.current=Ce(it.current,bt.current,a)},Gt={[`on${yt(i)}`]:mt},re=["drop-wrap",G?"open":""].filter(Boolean).map(Dt=>_r[Dt]).join(" "),At=X(f)?f:f?.(()=>nt(!1),G);return(0,c.jsxs)("span",{ref:it,className:`${_r["drop-target"]}${v?` ${v}`:""}`,...Gt,...R,children:[I,(0,c.jsx)(lo,{open:G,className:"huxy-drop",children:(0,c.jsx)("div",{ref:bt,className:re,style:j,children:At})})]})},Hr=(i,a,f)=>{if(!ce())return;f=oe(f)?f.current:f??document.body;const v=document.createElement("span");v.setAttribute("style","pointer-events: none; z-index: -1; opacity: 0;"),a&&It(v,a),v.innerText=(i??"").replace(/[\r\n]/g,""),f.appendChild(v);const j=v.getBoundingClientRect();return f.removeChild(v),j};var l=A(918),h={};h.styleTagTransform=Q(),h.setAttributes=U(),h.insert=$().bind(null,"head"),h.domAPI=F(),h.insertStyleElement=kt();var w=x()(l.Z,h);const g=l.Z&&l.Z.locals?l.Z.locals:void 0,m=({title:i,placement:a="topRight",children:f,ellipsis:v,className:j,...I})=>(0,c.jsx)("span",{className:`${g[`huxy-tooltip-${a}`]}${j?` ${j}`:""}`,tooltip:i??f,...I,children:(0,c.jsx)("span",{className:v?g.ellipsis:"",children:f})}),Y={overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",display:"inline-block",width:"100%"},Z=i=>{const{children:a,style:f}=i,v=typeof a=="string",j=v?a:a?.props?.title??a?.props?.children,I=(0,K.useRef)(),[R,G]=(0,K.useState)(!0);return(0,K.useEffect)(()=>{if(I.current){const{width:nt}=Hr(j,null,I.current.parentNode),{width:it}=dt(I.current),bt=~~nt>~~it;bt!==R&&G(bt)}},[j]),(0,c.jsx)("span",{ref:I,style:{display:"flex",width:"100%",...f},children:R?v?(0,c.jsx)(m,{...i,ellipsis:!0}):(0,c.jsx)("span",{style:Y,children:a}):v?a:a?.props?.children})},q=i=>i.children==null?"":(0,c.jsx)(Z,{...i});var W=Object.defineProperty,P=(i,a,f)=>a in i?W(i,a,{enumerable:!0,configurable:!0,writable:!0,value:f}):i[a]=f,gt=(i,a,f)=>(P(i,typeof a!="symbol"?a+"":a,f),f);class Ct extends K.default.Component{constructor(){super(...arguments),gt(this,"state",{error:null})}static getDerivedStateFromError(a){return{error:a}}componentDidCatch(a,f){const{errorReport:v}=this.props;typeof v=="function"&&v({error:a,info:f.componentStack})}render(){const{error:a}=this.state,{fallback:f,children:v}=this.props;return a?f(a):v}}const Ot=i=>a=>{if(typeof a=="function"||typeof a?.render=="function")return(0,c.jsx)(a,{});if(typeof a=="string"){const f=i?.[a];return f?(0,c.jsx)(f,{}):(0,c.jsx)("i",{className:a})}return a??null},pt=i=>Ot(i),St=i=>({icon:a,defaultIcon:f})=>a?pt(i)(a):a===!1?null:f,Tt=["","webkit","moz","ms"],ct=i=>Tt.map(a=>a?`${a}FullscreenElement`:"fullscreenElement").find(a=>i[a]),st=i=>Tt.map(a=>a?`${a}RequestFullscreen`:"requestFullscreen").find(a=>i[a]),Nt=i=>Tt.map(a=>a?`${a}ExitFullscreen`:"exitFullscreen").find(a=>i[a]),Kt=Tt.map(i=>`${i}fullscreenchange`),ne=i=>{if(!ce())return;i=oe(i)?i.current:i??document.body;const a=ct(document),f=st(i),v=Nt(document);document[a]?document[v]?.():i[f]?.()},ue=i=>ce()?(Kt.map(a=>document.addEventListener(a,i,!1)),()=>Kt.map(a=>document.removeEventListener(a,i,!1))):void 0,ye=i=>(0,c.jsx)("i",{...i,children:"..."}),Xe=({panel:i,fullIcon:a=ye,exitIcon:f=ye,...v})=>{const j=oe(i)?i.current:i,[I,R]=(0,K.useState)();(0,K.useEffect)(()=>{const nt=ue(()=>{R(it=>!it)});return()=>nt()},[]);const G=I?f:a;return(0,c.jsx)(G,{onClick:nt=>ne(j),...v})};var Oe=A(249),De={};De.styleTagTransform=Q(),De.setAttributes=U(),De.insert=$().bind(null,"head"),De.domAPI=F(),De.insertStyleElement=kt();var lr=x()(Oe.Z,De);const Fr=Oe.Z&&Oe.Z.locals?Oe.Z.locals:void 0,We=({gutter:i=10,className:a,overflow:f="hidden",...v},j)=>{const I=a?` ${a}`:"";let R=10;if(Array.isArray(i)){const G=[...i];i=G[0],R=G[1]??G[0]}return(0,c.jsx)("div",{className:"row-wrap",style:{"--gutter":`${Math.floor(i/2)}px`,"--rowgap":`${Math.floor(R/2)}px`,overflow:f},children:(0,c.jsx)("div",{className:`row${I}`,...v,ref:j})})},Ee=(0,K.forwardRef)(We),Gr=({rowProps:i,colProps:a,children:f,Row:v=Ee,Col:j=_e})=>{const I=[];return K.Children.map(f,R=>{R&&(R.type?.description==="react.fragment"?I.push(...R.props.children):I.push(R))}),(0,c.jsx)(v,{...i,children:I.map((R,G)=>(0,c.jsx)(j,{...a,...R.props.itemprops,children:R},`huuxy_grid_${G}`))})},Or=(i,a)=>(0,c.jsx)("div",{dangerouslySetInnerHTML:{__html:i},...a}),se=i=>{const{error:a={},info:f=""}=i||{},{message:v,stack:j,errMsg:I}=a;let R=I||j||a.toString();R=`${R}
${f}`.replace(/\r|\n|\r\n/g,"<br/>"),R=R.replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;"),R=R.replace(/\s/g,"&nbsp;");const G=v?.slice(0,120).split(". ").slice(0,2).join(". ");return(0,c.jsxs)("div",{style:{padding:"15px 20px",backgroundColor:"#fff",wordWrap:"break-word"},children:[Or(R,{style:{color:"red"}}),G&&(0,c.jsxs)("a",{style:{display:"inline-block",padding:"15px",color:"#00b4cf"},href:`https://stackoverflow.com/search?q=${G}`,target:"_blank",children:[" ","--> \u53BB\u7F51\u4E0A\u67E5\u627E\u9519\u8BEF\u539F\u56E0\uFF1F"]})]})},qe=({children:i,report:a})=>{const f=(0,K.useRef)();return f.current?.state&&(f.current.state.error=null),(0,c.jsx)(Ct,{ref:f,fallback:(v,j)=>se({error:v,info:j}),errorReport:a,children:i})},ge=(i,a)=>Object.keys(a).map(f=>i.style[f]=a[f]),wr=(i,a)=>Object.keys(a).map(f=>i.style[f]=""),Dr={overflow:"auto",position:"fixed",zIndex:5555,transition:"all .2s"},Ur=({left:i,top:a,width:f,height:v})=>({left:`${i}px`,top:`${a}px`,width:`${f}px`,height:`${v}px`}),je=i=>(0,c.jsx)("i",{...i,children:"..."}),Ke=i=>{const{left:a,top:f}=dt(i),{width:v,height:j}=fe(i);return{left:a,top:f,width:v,height:j}},Jr=({panel:i,target:a,fullIcon:f=je,exitIcon:v=je})=>{i=oe(i)?i.current:i||document.body;const[j,I]=(0,K.useState)(),R=(0,K.useRef)(),G=(0,K.useRef)();(0,K.useEffect)(()=>{const bt=typeof a=="function"?a:()=>document.getElementsByClassName(a)[0];G.current=Ur(Ke(bt())),R.current={...Dr,...Ur(Ke(i))}},[i]);const nt=(bt,ht)=>{bt?(ge(ht,R.current),setTimeout(()=>{ge(ht,G.current)},0)):wr(ht,R.current),I(bt)},it=j?v:f;return(0,c.jsx)(it,{onClick:bt=>nt(!j,i)})};var Se=A(548),sr={};sr.styleTagTransform=Q(),sr.setAttributes=U(),sr.insert=$().bind(null,"head"),sr.domAPI=F(),sr.insertStyleElement=kt();var Tr=x()(Se.Z,sr);const be=Se.Z&&Se.Z.locals?Se.Z.locals:void 0,so=({open:i,close:a,hasMask:f=!0,cancelText:v="\u53D6\u6D88",submit:j,submitText:I="\u786E\u5B9A",title:R="Modal \u5F39\u7A97",className:G,children:nt,delay:it=250,...bt})=>{const ht=["modal-wrap",i?"open":"",...G?.split(" ")??[]].filter(Boolean).map(mt=>be[mt]).join(" ");return(0,c.jsx)(we,{open:i,close:a,delay:it,hasMask:f,className:"huxy-modal",children:(0,c.jsx)("div",{className:ht,...bt,children:(0,c.jsxs)("div",{className:be["modal-container"],children:[(0,c.jsx)("div",{className:be["modal-header"],children:R}),(0,c.jsx)("div",{className:be["modal-content"],children:nt}),(0,c.jsxs)("div",{className:be["modal-footer"],children:[(0,c.jsx)("div",{className:`${be.btn} ${be.left}`,onClick:mt=>a?.(mt),children:v}),(0,c.jsx)("div",{className:`${be.btn} ${be.right}`,onClick:mt=>j?.(mt),children:I})]})]})})})};var Nr=A(990),cr={};cr.styleTagTransform=Q(),cr.setAttributes=U(),cr.insert=$().bind(null,"head"),cr.domAPI=F(),cr.insertStyleElement=kt();var rn=x()(Nr.Z,cr);const zo=Nr.Z&&Nr.Z.locals?Nr.Z.locals:void 0,co=({global:i,absolute:a})=>(0,c.jsx)("div",{className:`spinner${i?" global":""}${a?" absolute":""}`,children:(0,c.jsx)("figure",{className:"spinning"})});var Xr=A(232),Ar={};Ar.styleTagTransform=Q(),Ar.setAttributes=U(),Ar.insert=$().bind(null,"head"),Ar.domAPI=F(),Ar.insertStyleElement=kt();var $o=x()(Xr.Z,Ar);const Ir=Xr.Z&&Xr.Z.locals?Xr.Z.locals:void 0,_o=i=>i?.filter?.(a=>typeof a=="function"),uo=(i,a)=>{const f=(0,K.useRef)(),{loading:v,title:j,plugins:I,children:R,className:G,...nt}=i,it=_o(I),bt=it?.length,ht=G?` ${G}`:"",mt=oe(a)?a:f;return(0,c.jsxs)("div",{className:`${Ir.panel}${ht}`,...nt,ref:mt,children:[(j||bt)&&(0,c.jsxs)("div",{className:Ir["panel-header"],children:[j&&(0,c.jsx)("h4",{className:Ir["panel-title"],children:j}),bt&&(0,c.jsx)("div",{className:Ir["panel-plugins"],children:it.map((Gt,re)=>(0,c.jsx)("span",{className:"link",children:(0,c.jsx)(Gt,{panel:mt})},re))})]}),(0,c.jsx)("div",{className:Ir["panel-body"],children:R}),v&&(0,c.jsx)(co,{})]})},ho=(0,K.forwardRef)(uo),Qr=i=>rr(i)==="array",Fo=i=>Qr(i)&&!!i.length,fo=({to:i,preventDefault:a,stopPropagation:f,...v})=>a?(0,c.jsx)("span",{...v}):(0,c.jsx)("a",{href:i,...v}),Oo=({item:i,...a})=>(0,c.jsx)("ul",{...a}),qr=(i,...a)=>{const f={};return Object.keys(i).filter(Boolean).map(v=>{f[v]=j=>i[v](j,...a)}),f},po=({data:i=[],events:a={},List:f=Oo,Link:v=fo,leftIcon:j,rightIcon:I,isHorizontal:R,isCollapsed:G,level:nt=0,parentOpen:it=!0})=>{const bt=G&&!nt,ht=!R&&!G&&!it;return i.map(mt=>{const{name:Gt,path:re,icon:At,rightIcon:Dt,active:Yt,open:ie,children:Ge,linkProps:Je}=mt,Kr=Fo(Ge),Te=mt.id||re||Gt,Er=bt?mt.title??Gt:void 0,ur=ht?"hidden":"",Ye=At??j,de=Dt??I,Ve=Ye?(0,c.jsx)("div",{className:"node-left-icon",children:Ye===!0?(0,c.jsx)("i",{className:"default-left-icon"}):Ye}):null,Br=Gt?(0,c.jsx)("div",{className:"node-text",children:(0,c.jsx)("span",{children:Gt})}):null;if(Kr){const Ro=qr(a,mt,nt),vo=[ur,ie?"open":""].filter(Boolean).join(" ");return(0,c.jsxs)("li",{className:vo,"has-children":"true",...Ro,children:[(0,c.jsxs)(v,{title:Er,className:`link${Yt?" active":""}`,to:re,preventDefault:!0,stopPropagation:!1,...Je,children:[Ve,Br,de?(0,c.jsx)("div",{className:"node-right-icon",children:de===!0?(0,c.jsx)("i",{className:"default-right-icon"}):de}):null]}),(0,c.jsx)(f,{item:mt,children:po({data:Ge,events:a,List:f,Link:v,leftIcon:j,rightIcon:I,isHorizontal:R,isCollapsed:G,level:nt+1,parentOpen:!!ie})})]},Te)}return(0,c.jsx)("li",{className:ur,children:(0,c.jsxs)(v,{title:Er,className:`link${Yt?" active":""}`,to:re,...Je,children:[Ve,Br]})},Te)})},to=po,Do=(i,...a)=>(0,c.jsx)("div",{"v-html":i,...a});var Pr=A(575),kr={};kr.styleTagTransform=Q(),kr.setAttributes=U(),kr.insert=$().bind(null,"head"),kr.domAPI=F(),kr.insertStyleElement=kt();var on=x()(Pr.Z,kr);const To=Pr.Z&&Pr.Z.locals?Pr.Z.locals:void 0,No=i=>(0,c.jsx)("div",{style:{padding:"6px 15px"},children:i}),eo=({activekey:i,tabs:a=[],switchTab:f,trackColor:v,flex:j,...I},R)=>{const[G,nt]=(0,K.useState)(i??a[0]?.key),[it,bt]=(0,K.useState)({}),ht=(0,K.useRef)({}),mt=(0,K.useRef)();(0,K.useEffect)(()=>{const At=ht.current[G];At&&Gt(At)},[]);const Gt=At=>{const{left:Dt,width:Yt}=dt(At),ie=dt(mt.current).left;bt({left:Dt-ie,width:Yt})},re=(At,Dt)=>{At.stopPropagation(),nt(Dt),typeof f=="function"&&f(Dt),Gt(At.currentTarget)};return(0,c.jsxs)("div",{className:"tabs-header-wrap",...I,ref:R,children:[(0,c.jsx)("ul",{className:`tabs-header${j?" flex":""}`,ref:mt,children:a.map(At=>(0,c.jsx)("li",{ref:Dt=>ht.current[At.key]=Dt,className:`th-item${G===At.key?" active":""}`,onClick:Dt=>re(Dt,At.key),children:typeof At.renderTabs=="function"?At.renderTabs(At,G===At.key):No(At.value)},At.key))}),(0,c.jsx)("div",{className:"th-track",style:{...it,color:v}})]})},Ao=(0,K.forwardRef)(eo),mo=(i,a,f="id",v="children")=>{if(!Qr(i))return null;const j=I=>{for(let R=0,G=I.length;R<G;R++){const nt=I[R];if(nt[f]===a)return[nt];if(Qr(nt[v])){const it=j(nt[v]);if(it)return[nt].concat(it)}}};return j(i)},Io=i=>++i,xo=()=>{const[,i]=(0,K.useState)(0);return(0,K.useCallback)(()=>i(Io),[])},yo=i=>{const{children:a,open:f}=i;let v=0;if(f&&a?.length){v=a.length;let j=0;return a.map(I=>j+=yo(I)),v+j}return v},go=({item:i,style:a,...f})=>(0,c.jsx)("ul",{style:{...a,"--count":yo(i)},...f});var ro=A(942),Cr={};Cr.styleTagTransform=Q(),Cr.setAttributes=U(),Cr.insert=$().bind(null,"head"),Cr.domAPI=F(),Cr.insertStyleElement=kt();var nn=x()(ro.Z,Cr);const Po=ro.Z&&ro.Z.locals?ro.Z.locals:void 0,Bo=i=>(0,c.jsx)("ul",{...i}),bo=(i,a)=>i?go:({item:f,...v})=>(0,c.jsx)(Bo,{className:a==="right"?"left":"",...v}),Lo=i=>{const{data:a=[],collapsed:f=!1,type:v="vertical",Link:j,width:I,bgColor:R,itemHeight:G,collapsedWidth:nt,itemPadding:it,style:bt,className:ht,...mt}=i,Gt=(0,K.useRef)(),re=(0,K.useRef)();(0,K.useEffect)(()=>()=>clearTimeout(Gt.current),[]);const At=xo(),Dt=v==="horizontal",Yt=!Dt&&f,ie={onClick:(ur,Ye)=>{if(ur.stopPropagation(),!Dt&&!Yt){const de=mo(a,Ye.path,"path"),Ve=de[de.length-1];Ve.open=!Ve.open,At()}},onMouseEnter:(ur,Ye,de)=>{Yt&&!de&&(clearTimeout(Gt.current),re.current.style.width="var(--maxWidth)")},onMouseLeave:(ur,Ye,de)=>{Yt&&!de&&(Gt.current=setTimeout(()=>re.current.style.width="",200))}},Ge=(Dt?["huxy-horizontal-tree",ht]:["huxy-tree",ht,Yt?"collapsed":""]).filter(Boolean).join(" "),{float:Je,...Kr}=mt?.style??{},Te={"--bgColor":R,"--itemHeight":G,"--nodeListWidth":I,...Kr};Dt?(Te["--itemPadding"]=it,Te["--nodeFloat"]=Je):(Te["--width"]=I,Te["--collapsedWidth"]=nt);const Er=bo(!Dt&&!Yt,Je);return(0,c.jsx)("div",{ref:re,className:Ge,style:Te,...mt,children:(0,c.jsx)("div",{className:"huxy-tree-track",children:(0,c.jsx)("ul",{className:"huxy-tree-root",children:to({data:a,events:ie,List:Er,Link:j,leftIcon:!0,rightIcon:!0,isHorizontal:Dt,isCollapsed:Yt})})})})}})();var jt=ut.PC,Wr=ut.rK,Vt=ut.lr,Ht=ut.JX,N=ut.dy,M=ut.Ud,B=ut.mH,V=ut.SV,H=ut.Hn,tt=ut.rj,J=ut.V7,rt=ut.AN,vt=ut.zd,wt=ut.BQ,Ft=ut.u_,Pt=ut.s_,lt=ut.h_,$t=ut.X2,Mt=ut.$j,Zt=ut.GK,k=ut.u,Lt=ut.mp,Rt=ut.C2,Wt=ut.pC,ae=ut.ff,L=ut.d2,ot=ut.Uw},8611:function(Rr,zt,te){var Bt;te.d(zt,{Bv:function(){return Wr},rU:function(){return ut},tv:function(){return Ht},yj:function(){return Vt}});var u=te(7378),ze={990:(N,M,B)=>{B.d(M,{Z:()=>vt});var V=B(601),H=B.n(V),tt=B(609),J=B.n(tt),rt=J()(H());rt.push([N.id,`@keyframes before {
  0% {
    width: 0.6rem;
    box-shadow: 1.2rem -0.6rem #ff3e38, -1.2rem 0.6rem #318ffa;
  }
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(wt))))," */")),tt.styleTagTransform(rt,H,tt.options)}function B(H){if(H.parentNode===null)return!1;H.parentNode.removeChild(H)}function V(H){var tt=H.insertStyleElement(H);return{update:function(J){M(tt,H,J)},remove:function(){B(tt)}}}N.exports=V},464:N=>{function M(B,V){if(V.styleSheet)V.styleSheet.cssText=B;else{for(;V.firstChild;)V.removeChild(V.firstChild);V.appendChild(document.createTextNode(B))}}N.exports=M},810:N=>{var M=V=>{var H={};return ft.d(H,V),H},B=V=>()=>V;N.exports=Bt||(Bt=te.t(u,2))}},Ne={};function ft(N){var M=Ne[N];if(M!==void 0)return M.exports;var B=Ne[N]={id:N,exports:{}};return ze[N](B,B.exports,ft),B.exports}ft.n=N=>{var M=N&&N.__esModule?()=>N.default:()=>N;return ft.d(M,{a:M}),M},ft.d=(N,M)=>{for(var B in M)ft.o(M,B)&&!ft.o(N,B)&&Object.defineProperty(N,B,{enumerable:!0,get:M[B]})},ft.o=(N,M)=>Object.prototype.hasOwnProperty.call(N,M),ft.nc=void 0;var A={};(()=>{ft.d(A,{rU:()=>no,cb:()=>Hr,Bv:()=>Zr,yj:()=>_r,tv:()=>vr});var N=ft(810);const M=l=>Object.prototype.toString.call(l).slice(8,-1).toLowerCase(),B=l=>M(l)==="array",V=l=>M(l)==="object",H=l=>l?.$$typeof&&typeof l.$$typeof=="symbol"&&l.$$typeof.description==="react.element",tt=l=>l?.__v_isVNode,J=(l,h)=>Object.prototype.hasOwnProperty.call(l??{},h),rt=l=>{if(!B(l)&&!V(l))return l;const h=B(l)?[]:{};for(const w in l)if(J(l,w)){const g=l[w];h[w]=H(g)||tt(g)||typeof g!="object"?g:g!==l?rt(g):"cyclic"}else Object.setPrototypeOf(h,{[w]:l[w]});return h},vt=rt,wt=l=>M(l)==="function",Ft=l=>M(l)==="promise"||V(l)&&wt(l.then),Pt=(l,h=12e4,w="\u8BF7\u6C42\u8D85\u65F6\uFF01")=>{if(!Ft(l))return{};let g=null,m=null;return{promiseFn:new Promise((Y,Z)=>{g=(q="canceled")=>{clearTimeout(m),Y({canceled:!0,errMsg:q})},h&&(h=typeof h!="number"?12e4:h,m=setTimeout(()=>g(w),h)),l.then(q=>{clearTimeout(m),Y({result:q,errMsg:!1})}).catch(q=>{clearTimeout(m),Z(q)})}),cancelFn:g}},lt=l=>l?l.charAt(l.length-1)==="/"?l.slice(0,-1):l:"";var $t=ft(322);const Mt=(l,h)=>(0,$t.jsx)("div",{dangerouslySetInnerHTML:{__html:l},...h}),Zt=l=>{const{error:h={},info:w=""}=l||{},{message:g,stack:m,errMsg:Y}=h;let Z=Y||m||h.toString();Z=`${Z}
${w}`.replace(/\r|\n|\r\n/g,"<br/>"),Z=Z.replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;"),Z=Z.replace(/\s/g,"&nbsp;");const q=g?.slice(0,120).split(". ").slice(0,2).join(". ");return(0,$t.jsxs)("div",{style:{padding:"15px 20px",backgroundColor:"#fff",wordWrap:"break-word"},children:[Mt(Z,{style:{color:"red"}}),q&&(0,$t.jsxs)("a",{style:{display:"inline-block",padding:"15px",color:"#00b4cf"},href:`https://stackoverflow.com/search?q=${q}`,target:"_blank",children:[" ","--> \u53BB\u7F51\u4E0A\u67E5\u627E\u9519\u8BEF\u539F\u56E0\uFF1F"]})]})},k=()=>{const l={};return{on:(h,w)=>{l[h]||(l[h]=[]),l[h].indexOf(w)===-1&&l[h].push(w)},emit:(h,w)=>{l[h]&&l[h].map(g=>g(w))},off:(h,w=null)=>{if(l[h]){if(typeof w!="function")return delete l[h];const g=l[h].indexOf(w);g>-1&&(l[h].splice(g,1),l[h].length||delete l[h])}}}},Lt=l=>{const h={};for(let w in l)J(l,w)||(h[w]=l[w]);return h},Rt=(l,h)=>{if(!V(l))return h;if(!V(h))return l;const w={...Lt(l),...Lt(h)},g={...l,...h};return Object.keys(w).map(m=>{Object.setPrototypeOf(g,{[m]:w[m]})}),g},Wt=()=>{const{on:l,emit:h,off:w}=k(),g={};return{getState:m=>vt(g[m]),setState:(m,Y=!1)=>{if(typeof m=="function"&&(m=m(vt(g))),!V(m))throw TypeError("\u5FC5\u987B\u4F20\u5165object\u5BF9\u8C61\uFF01");const Z=vt(m);Object.keys(Z).map(q=>{const W=g[q],P=Z[q],gt=V(P)&&V(W)?Rt(W,P):P;!Y&&h(q,gt),g[q]=gt})},subscribe:(m,Y)=>(l(m,Y),()=>w(m,Y)),unsubscribe:w,clean:m=>{typeof m=="string"?g[m]=void 0:Array.isArray(m)?m.map(Y=>g[Y]=void 0):Object.keys(g).map(Y=>g[Y]=void 0)}}},ae=l=>(h,w)=>{const[g,m]=(0,N.useState)(()=>{const W=l?.getState(h);return W!==void 0?W:(w!==void 0&&l?.setState({[h]:w},!0),w)}),Y=(0,N.useCallback)(W=>l?.setState({[h]:typeof W=="function"?W(l?.getState(h)):W}),[]),Z=(0,N.useCallback)(W=>l?.subscribe(h,W),[]),q=(0,N.useCallback)((W=W)=>l?.clean(W),[]);return(0,N.useEffect)(()=>{l?.subscribe(h,W=>m(W))},[]),[g,Y,Z,q]},L=Wt(),ot=ae(L),c=k(),S=k(),x="push-emitter",E="replace-emitter",F="useRoute-emitter",O={delay:8e3,timeoutMsg:"\u8BF7\u6C42\u8D85\u65F6\uFF01",cancelMsg:"\u8BF7\u6C42\u5DF2\u53D6\u6D88\uFF01"},$="/404",C={getState:()=>history.state,go:l=>history.go(l),forward:()=>history.forward(),back:()=>history.back()},U=(l,h,w,g,m=[])=>{const Y=W=>{for(let P=0,gt=W.length;P<gt;P++){const Ct=W[P],Ot=Ct[g].split("?")[0];if(new RegExp("^"+Ot.replace(/:[^/]+/g,"[^/]+")+"$").test(h))return Ct;if(B(Ct[w])){const pt=Y(Ct[w]);if(pt)return pt}}},Z=Y(l);if(!Z)return $;const{redirect:q}=Z;return q?m.includes(q)?m:(m.push(q),U(l,q.split("?")[0],w,g,m)):m[m.length-1]},xt=(l,h,w,g,m)=>{if(!B(l))return null;const Y=gt=>{const Ct=gt.split("/"),Ot=h.split("/"),pt={};return Ct.map((St,Tt)=>St.indexOf(":")===0&&(pt[St.slice(1)]=Ot[Tt])),pt},Z=(gt,Ct)=>{const Ot=[],pt=Ct.split("/:")[0];for(let St=0,Tt=gt.length;St<Tt;St++){const ct=gt[St];if(ct[m]===pt){ct.active=!0;const{name:st,title:Nt,icon:Kt,params:ne}=ct;Ot.push({name:st,title:Nt,icon:Kt,params:ne,[m]:pt})}else if(Ct.indexOf(`${ct[m]}/`)===0){ct.active=!0;const st=Y(ct[m]),Nt=Object.keys(st).map(Xe=>st[Xe]).join("/"),{name:Kt,title:ne,icon:ue}=ct,ye=Nt?`${pt}/${Nt}`:ct[m];Ot.push({name:Kt,title:ne,icon:ue,[m]:ye,params:{...ct.params,...st}})}else if(ct[m]===Ct){ct.active=!0;const st=Y(ct[m]),{[g]:Nt,...Kt}=ct;Ot.push({...Kt,[m]:h,params:{...Kt.params,...w,...st}})}}return Ot},q=(gt,Ct)=>{for(let Ot=0,pt=gt.length;Ot<pt;Ot++){const St=gt[Ot];if(Ct.indexOf(`${St[m]}/`)===0){St.active=!0;return}}},W=gt=>{for(let Ct=0,Ot=gt.length;Ct<Ot;Ct++){const pt=gt[Ct],St=(pt[m]||"").split("?")[0];if(St===h){pt.hideMenu&&q(gt,pt.parentPath||St),pt.active=!0;const{[g]:Tt,...ct}=pt;return[{...ct,params:{...ct.params,...w}}]}if(new RegExp("^"+St.replace(/:[^/]+/g,"[^/]+")+"$").test(h))return Z(gt,St);if(B(pt[g])){const Tt=W(pt[g]);if(Tt){pt.active=!0,pt.open=!0;const{[g]:ct,...st}=pt;return[st,...Tt]}}}},P=W(l)||[];return{result:l,current:P}},kt=(l,h,w)=>l.filter(g=>g.hideMenu||g[w].indexOf("/:")>-1?!1:(B(g[h])&&(g[h]=kt(g[h],h,w)),!0)),Ut=(l,h,w,g="children",m="path")=>{const Y=U(l,h,g,m);if(Y)return{redirect:Y};const{result:Z,current:q}=xt(l,h,w,g,m),W=kt(Z,g,m);return{current:q,menu:W}},Q=l=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(l),Xt=(l,h)=>{const w=["#/","/"],g=w[!!h-0];if(!l||w.includes(l))return g;const m=l.charAt(l.length-1)==="/"?l.slice(0,-1):l;return h||m.indexOf("#/")>-1?m:`#${m}`},_t=(l,h,w,g=!1)=>{const m=Xt(h,w);return g?m:w?l&&m==="/"?l:`${l}${m}`:l?`${l}/${m}`:m},qt=(l,h,w,g,m,Y)=>{if(!B(l))return l;const Z=(q,W="")=>q.filter(P=>!P.denied).map(P=>{if(!Y&&!P.exact&&!Q(P[g])){(!P[g]||P[g]==="javascript:;")&&(P[g]="");const gt=P[g].charAt(0)==="/"&&W.charAt(W.length-1)==="/"?P[g].slice(1):P[g].charAt(0)!=="/"&&W.charAt(W.length-1)!=="/"?`/${P[g]}`:P[g];P[g]=W?W+gt:_t(m,gt,h)}return P.redirect&&(P.redirect=_t(m,P.redirect,h)),B(P[w])&&(P[w]=Z(P[w],P[g]),!P.redirect&&P[w].length&&(P.redirect=P[w][0][g])),P});return Z(l)},le=l=>{if(!V(l))return"";const h=[];return Object.keys(l).map((w,g)=>{const m=g>0?"&":"?";h.push(`${m}${w}=${l[w]}`)}),h.join("")},ee=(l="")=>{const[h,w]=l.split("?");if(w){const g={};return w.split("&").map(m=>{const[Y,Z]=m.split("=");g[Y]=Z}),{path:h,params:g}}return{path:h}},K=()=>{document.documentElement.scrollTop?document.documentElement.scrollTop=0:document.body.scrollTop&&(document.body.scrollTop=0)},he=(l,h)=>{for(let w=l.length-1,g;g=l[w--];){const{title:m,name:Y}=g;if(typeof m=="string"&&m.length)return document.title=m;if((m==null||m===!0)&&Y)return document.title=h?`${Y}-${h}`:Y;if(h)return document.title=h}},Qe=l=>{const{pathname:h,search:w,hash:g}=location;if(l){const q=Xt(h,l),W=decodeURIComponent(`${q}${w}`),{params:P}=ee(W);return{path:W,params:P}}const m=decodeURIComponent(Xt(g,l)),{params:Y}=ee(m),Z=lt(h);return{path:Z?`${Z}/${m}`:m,params:Y}},Me=(l,h,w)=>{typeof l=="function"&&l({...h,stay:new Date-w})},Yr=(l,h,w,g)=>{let m,Y,Z;if(typeof l=="string")m=l;else if(V(l))m=l.path,Y=l.params,Z=l.query;else return;!m||m==="."||m==="./"?m=g:m.indexOf("./")===0?m=`${g.split("?")[0]}${m.replace("./","/")}`:m.indexOf("../")===0&&(m=`${g.split("?")[0].split("/").slice(0,-1).join("/")}${m.replace("../","/")}`),m=_t(h,m,w,l?.exact);const q=ee(m);m=q.path;const W={...q.params,...Z},P=le(W);return m=`${m}${P}`,Y={...Y,...W},{path:m,params:Y}},tr=(l,h)=>{const w=l.split(h);return w.length>1?["","/"].includes(w[1].slice(0,1)):!1},hr=k(),fr=l=>{const{on:h,emit:w,off:g}=hr;return{on:m=>h(l,m),emit:m=>w(l,m),off:m=>g(l,m)}},er=l=>(h,w)=>{const{getState:g,setState:m,subscribe:Y,unsubscribe:Z,clean:q}=l;return w!==void 0&&m({[h]:w},!0),{getState:()=>g(h),setState:(W,P)=>m({[h]:W},P),subscribe:W=>Y(h,W),unsubscribe:()=>Z(h),clean:()=>q(h)}},pr=Wt(),ce=er(pr),rr=fr("push-emitter"),Ae=fr("replace-emitter"),fe=ce("route-store"),or=k(),mr=Wt(),oe=ae(mr),jr=()=>![typeof window,typeof document].includes("undefined"),nr=l=>{if(!jr())return;const h=document.createElement("div");return h.innerHTML=l,h.children[0]};var Vr=Object.defineProperty,xr=(l,h,w)=>h in l?Vr(l,h,{enumerable:!0,configurable:!0,writable:!0,value:w}):l[h]=w,Mr=(l,h,w)=>(xr(l,typeof h!="symbol"?h+"":h,w),w);class Ie extends N.default.Component{constructor(){super(...arguments),Mr(this,"state",{error:null})}static getDerivedStateFromError(h){return{error:h}}componentDidCatch(h,w){const{errorReport:g}=this.props;typeof g=="function"&&g({error:h,info:w.componentStack})}render(){const{error:h}=this.state,{fallback:w,children:g}=this.props;return h?w(h):g}}const Pe=({children:l,report:h})=>{const w=(0,N.useRef)();return w.current?.state&&(w.current.state.error=null),(0,$t.jsx)(Ie,{ref:w,fallback:(g,m)=>Zt({error:g,info:m}),errorReport:h,children:l})};var ir=ft(62),ve=ft.n(ir),yr=ft(36),$e=ft.n(yr),_e=ft(793),Sr=ft.n(_e),gr=ft(892),zr=ft.n(gr),Be=ft(173),Ze=ft.n(Be),br=ft(464),$r=ft.n(br),we=ft(990),pe={};pe.styleTagTransform=$r(),pe.setAttributes=zr(),pe.insert=Sr().bind(null,"head"),pe.domAPI=$e(),pe.insertStyleElement=Ze();var s=ve()(we.Z,pe);const b=we.Z&&we.Z.locals?we.Z.locals:void 0,y=({global:l,absolute:h})=>(0,$t.jsx)("div",{className:`spinner${l?" global":""}${h?" absolute":""}`,children:(0,$t.jsx)("figure",{className:"spinning"})}),z=()=>{const l=(0,N.useRef)([]);return(0,N.useEffect)(()=>()=>{l.current.map(h=>h.cancelFn()),l.current=[]},[]),{cancelablePromise:(0,N.useCallback)((h,w=!0)=>{const g=Pt(h,w);return l.current.indexOf(g)===-1&&l.current.push(g),g.promiseFn},[])}},T=(l={})=>{const{cancelablePromise:h}=z(),[w,g]=(0,N.useState)(l),m=(0,N.useRef)({}),Y=(0,N.useRef)({}),Z=(0,N.useCallback)((W=null)=>{Array.isArray(W)&&W.length?W.map(P=>m.current[P]=l[P]):m.current=l},[]),q=(0,N.useCallback)((W,P,gt=!1)=>{const Ct=Object.keys(W),Ot=JSON.stringify(Ct.sort());if(!Y.current[Ot]){Y.current[Ot]=!0,gt&&Z(Array.isArray(gt)?gt:Ct),Ct.map(pt=>{m.current[pt]||(m.current[pt]={}),m.current[pt].pending=!0}),g({...m.current});for(let pt=0,St=Ct.length;pt<St;pt++){const Tt=Ct[pt];h(W[Tt]).then(ct=>{let{result:st,errMsg:Nt}=ct;pt===St-1&&(Y.current[Ot]=!1),typeof P=="function"&&(st=P(st)||st),m.current[Tt]={...st,pending:!1},Nt===!1&&g({...m.current})}).catch(ct=>{throw pt===St-1&&(Y.current[Ot]=!1),m.current[Tt]={error:ct,pending:!1},g({...m.current}),ct})}}},[]);return[w,q,Z]},X=l=>Object.keys(l).length,yt=l=>{const{Comp:h,restResolve:w,loadPromise:g,params:m,children:Y}=l,[Z,q]=T(),[W,P]=T();return(0,N.useEffect)(()=>{X(w)&&q(w),X(g)&&P(g)},[w,g]),(0,N.useEffect)(()=>{const gt=X(Z);gt&&gt===X(w)&&m.store.setState(Z)},[Z]),(0,$t.jsx)(h,{...m,...Z,...W,children:Y})},dt=l=>l===!1?null:H(l)?l:wt(l)?(0,$t.jsx)(l,{}):(0,$t.jsx)(y,{}),at=({Loading:l,ErrorBoundary:h,loadedComp:w})=>{const g=(0,$t.jsx)(N.Suspense,{fallback:dt(l),children:w});return h===!1?g:wt(h)?(0,$t.jsx)(h,{children:g}):(0,$t.jsx)(Pe,{children:g})},It=({Comp:l,routerProps:h,children:w})=>{const{params:g,...m}=h,{loading:Y,errorBoundary:Z,...q}=g,W=(0,$t.jsx)(yt,{Comp:l,...m,params:q,children:w});return at({Loading:Y,ErrorBoundary:Z,loadedComp:W})},me={},Le=(l,h,w,g)=>Ft(w)?w.then(m=>It({Comp:l,routerProps:h,children:m.default??m})):It({Comp:l,routerProps:h,children:w}),He=(l,h,w)=>{const g={},m={};return V(l)?(Object.keys(l).map(Y=>{const Z=h.getState(Y);Z==null?m[Y]=l[Y](w):g[Y]=Z}),{cachedResolve:g,restResolve:m}):{cachedResolve:g,restResolve:m}},xe=(l,h)=>{if(!V(l))return{};const w={};return Object.keys(l).map(g=>w[g]=l[g](h)),w},ar=l=>{const{current:h,menu:w,...g}=l,m=h.map(q=>{const{component:W,resolve:P,loadData:gt,loading:Ct,errorBoundary:Ot,icon:pt,...St}=q;return St}),Y=[...h].filter(q=>q.component),Z=(q=0)=>{if(!Y.length)return null;const W=Y.shift(),{component:P,resolve:gt,loadData:Ct,icon:Ot,key:pt,...St}=W;if(typeof P=="function"||Ft(P)){const Tt=St.path;let ct=me[Tt];const{cachedResolve:st,restResolve:Nt}=He(gt,g.store,St),Kt={loadPromise:xe(Ct,St),restResolve:Nt,params:{current:m,...g,...St,...st}},ne=Z(q+1);if(ct)return Le(ct,Kt,ne,Tt);try{ct=P(),ct=H(ct)?P:ct}catch{ct=P}return Ft(ct)?ct.then(ue=>(ct=ue.default??ue,me[Tt]=ct,Le(ct,Kt,ne,Tt))):(me[Tt]=ct,Le(ct,Kt,ne,Tt))}return typeof P=="string"?nr(P):P};return Z()},vr=l=>{const[h,w]=(0,N.useState)(l),[g,m]=(0,N.useState)(),[Y,Z]=(0,N.useState)(),q=(0,N.useRef)(),W=(0,N.useRef)(),P=(0,N.useRef)(),gt=(0,N.useRef)(),Ct=()=>{typeof q.current=="function"&&(q.current({cancel:O.cancelMsg}),q.current=null)},Ot=(0,N.useCallback)(st=>{typeof st=="function"?w(Nt=>({...Nt,...st(Nt)})):V(st)&&w(Nt=>({...Nt,...st}))},[]),pt=(st,Nt="pushState")=>{const{basepath:Kt,browserRouter:ne}=gt.current,ue=P.current,{path:ye,params:Xe}=Yr(st,Kt,ne,ue);ye!==ue&&ct({inputPath:ye,inputParams:Xe},()=>history[Nt](st?.state,"",ye))},St=(0,N.useCallback)(st=>pt(st),[]),Tt=(0,N.useCallback)(st=>pt(st,"replaceState"),[]),ct=(0,N.useCallback)(({inputPath:st="",inputParams:Nt={}},Kt)=>{const ne=+new Date,{browserRouter:ue,childKey:ye,idKey:Xe,title:Oe,routers:De,beforeRender:lr,afterRender:Fr,basepath:We,allowedNotFound:Ee,...Gr}=gt.current;if(!st){const{path:se,params:qe}=Qe(ue);st=se,Nt={...Nt,...qe}}const Or=P.current;new Promise((se,qe)=>{De?.length||qe("\u8DEF\u7531\u4E3A\u7A7A\uFF01"),st!==P.current&&typeof lr=="function"?lr({path:st,params:Nt,prevPath:Or},se,qe):se()}).then(se=>{if(se===!1)return;const qe=se?.path;if(qe&&_t(We,qe,ue)!==st){Tt(se);return}W.current=W.current??st;const{redirect:ge,current:wr,menu:Dr}=Ut(vt(De),st.split("?")[0],Nt,ye,Xe);if(ge){if(Ee&&ge===$&&(typeof Ee=="boolean"||typeof Ee=="string"&&tr(W.current,Ee)||B(Ee)&&Ee.find(Ke=>tr(W.current,Ke))))return;if(B(ge)){console.error(`\u522B\u95F9\uFF0C[${[st,...ge].join(" -> ")}] \u91CD\u5B9A\u5411\u6B7B\u5FAA\u73AF\uFF01\uFF01\uFF01`);return}return ge===$?Tt({path:ge}):St({path:ge,exact:!0})}Kt?.(),st?.split("?")[0]!==P.current?.split("?")[0]&&K(),he(wr,Oe);const Ur={eventBus:or,store:mr,useStore:oe,...Gr,updateRouter:Ot,emitRouter:fe.subscribe,router:{push:St,replace:Tt},current:wr,menu:Dr,inputPath:W.current,prevPath:Or,basepath:We,title:Oe,history:{...C,goBack:Ke=>St({...Ke,path:Or})}};fe.setState({...Ur,browserRouter:ue});const je=ar(Ur);if(P.current=st,W.current=null,Ct(),Ft(je)){const{promiseFn:Ke,cancelFn:Jr}=Pt(je,{delay:O.delay,msg:{timeout:O.timeoutMsg}});return q.current=Jr,Z(!0),Ke.then(Se=>{q.current=null;const{result:sr,errMsg:Tr}=Se,be=Tr===!1?sr:Tr?.timeout?Zt({error:{errMsg:`${st} ${Tr.timeout}`}}):null;be&&(Z(!1),Me(Fr,wr.slice(-1)[0],ne),m(be))}).catch(Se=>{throw q.current=null,Z(!1),Me(Fr,wr.slice(-1)[0],ne),m(Zt({error:Se})),Se})}Me(Fr,wr.slice(-1)[0],ne),m(je)}).catch(se=>{throw m(Zt({error:se})),se})},[]);return(0,N.useEffect)(()=>{const{childKey:st="children",idKey:Nt="path",browserRouter:Kt=!1,routers:ne=[],basepath:ue="",exact:ye=!1,inputPath:Xe="",inputParams:Oe={},...De}=h,lr=lt(ue),Fr=qt(vt(ne),Kt,st,Nt,lr,ye);gt.current={...De,childKey:st,idKey:Nt,browserRouter:Kt,routers:Fr,basepath:lr};const We=Kt?"popstate":"hashchange",Ee=()=>ct({});return ct({inputPath:Xe,inputParams:Oe}),rr.on(St),Ae.on(Tt),window.addEventListener(We,Ee,!1),()=>{Ct(),rr.off(St),Ae.off(Tt),window.removeEventListener(We,Ee,!1)}},[h]),{updateRouter:Ot,output:g,loading:Y}},Fe=l=>{const{to:h,onClick:w,preventDefault:g,stopPropagation:m=!0,exact:Y=!0,target:Z,...q}=l,W=()=>{const P=typeof h=="string"?{exact:Y,path:h}:{exact:Y,...h};rr.emit(P)};return P=>{if(P.preventDefault(),m&&P.stopPropagation(),!q?.disabled){if(!g){if(Z){const{browserRouter:gt}=fe.getState(),Ct=typeof h=="string"?h:h?.path??"",Ot=le(h?.query),pt=gt||Ct.indexOf("#/")>-1||Q(Ct);window?.open(`${pt?"":"#"}${Ct}${Ot}`,Z);return}W()}typeof w=="function"&&w()}}};var ke=ft(267),Ce={};Ce.styleTagTransform=$r(),Ce.setAttributes=zr(),Ce.insert=Sr().bind(null,"head"),Ce.domAPI=$e(),Ce.insertStyleElement=Ze();var lo=ve()(ke.Z,Ce);const Ue=ke.Z&&ke.Z.locals?ke.Z.locals:void 0,Re=l=>{if(!l)return Ue.link;const h=l.trim().split(" ").filter(Boolean),w=h.find(g=>g==="active")?[Ue.active]:[];return[Ue.link,...w,...h].join(" ")},no=l=>{const{to:h,onClick:w,preventDefault:g,stopPropagation:m,exact:Y,target:Z,className:q,...W}=l;return(0,$t.jsx)("span",{onClick:Fe(l),className:Re(q),...W})},_r=()=>{const[l,h]=(0,N.useState)(fe.getState());return(0,N.useEffect)(()=>fe.subscribe(w=>h(w)),[]),l},Zr=fe.getState,Hr=fe.subscribe})();var ut=A.rU,jt=A.cb,Wr=A.Bv,Vt=A.yj,Ht=A.tv},8124:function(Rr,zt,te){var Bt;te.d(zt,{Nr:function(){return N},PQ:function(){return $t},Vd:function(){return Ht},Wy:function(){return B},fH:function(){return ut},xd:function(){return Zt}});var u=te(7378),ze={837:(k,Lt,Rt)=>{var Wt,ae=Rt(810),L=Symbol.for("react.element"),ot=Symbol.for("react.fragment"),c=Object.prototype.hasOwnProperty,S=ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,x={key:!0,ref:!0,__self:!0,__source:!0};function E(F,O,$){var C,U={},xt=null,kt=null;$!==void 0&&(xt=""+$),O.key!==void 0&&(xt=""+O.key),O.ref!==void 0&&(kt=O.ref);for(C in O)c.call(O,C)&&!x.hasOwnProperty(C)&&(U[C]=O[C]);if(F&&F.defaultProps)for(C in O=F.defaultProps,O)U[C]===void 0&&(U[C]=O[C]);return{$$typeof:L,type:F,key:xt,ref:kt,props:U,_owner:S.current}}Wt=ot,Lt.jsx=E,Wt=E},322:(k,Lt,Rt)=>{k.exports=Rt(837)},810:k=>{var Lt=Wt=>{var ae={};return ft.d(ae,Wt),ae},Rt=Wt=>()=>Wt;k.exports=Bt||(Bt=te.t(u,2))}},Ne={};function ft(k){var Lt=Ne[k];if(Lt!==void 0)return Lt.exports;var Rt=Ne[k]={exports:{}};return ze[k](Rt,Rt.exports,ft),Rt.exports}ft.d=(k,Lt)=>{for(var Rt in Lt)ft.o(Lt,Rt)&&!ft.o(k,Rt)&&Object.defineProperty(k,Rt,{enumerable:!0,get:Lt[Rt]})},ft.o=(k,Lt)=>Object.prototype.hasOwnProperty.call(k,Lt);var A={};(()=>{ft.d(A,{fH:()=>Lt,r5:()=>S,Nd:()=>O,KY:()=>c,Vd:()=>U,Nr:()=>kt,D:()=>Xt,Wy:()=>Me,zX:()=>Yr,Cd:()=>Ut,Yz:()=>tr,D9:()=>hr,cb:()=>Qe,vO:()=>er,Rx:()=>Mr,OH:()=>Ie,oR:()=>$e,rE:()=>br,PQ:()=>we,rf:()=>Q,xd:()=>pe});var k=ft(810);const Lt=s=>(b,y)=>{const[z,T]=(0,k.useState)(()=>{const at=s?.getState(b);return at!==void 0?at:(y!==void 0&&s?.setState({[b]:y},!0),y)}),X=(0,k.useCallback)(at=>s?.setState({[b]:typeof at=="function"?at(s?.getState(b)):at}),[]),yt=(0,k.useCallback)(at=>s?.subscribe(b,at),[]),dt=(0,k.useCallback)((at=at)=>s?.clean(at),[]);return(0,k.useEffect)(()=>{s?.subscribe(b,at=>T(at))},[]),[z,X,yt,dt]},Rt=s=>Object.prototype.toString.call(s).slice(8,-1).toLowerCase(),Wt=s=>Rt(s)==="object",ae=s=>Rt(s)==="function",L=s=>Rt(s)==="promise"||Wt(s)&&ae(s.then),ot=(s,b=12e4,y="\u8BF7\u6C42\u8D85\u65F6\uFF01")=>{if(!L(s))return{};let z=null,T=null;return{promiseFn:new Promise((X,yt)=>{z=(dt="canceled")=>{clearTimeout(T),X({canceled:!0,errMsg:dt})},b&&(b=typeof b!="number"?12e4:b,T=setTimeout(()=>z(y),b)),s.then(dt=>{clearTimeout(T),X({result:dt,errMsg:!1})}).catch(dt=>{clearTimeout(T),yt(dt)})}),cancelFn:z}},c=()=>{const s=(0,k.useRef)([]);return(0,k.useEffect)(()=>()=>{s.current.map(b=>b.cancelFn()),s.current=[]},[]),{cancelablePromise:(0,k.useCallback)((b,y=!0)=>{const z=ot(b,y);return s.current.indexOf(z)===-1&&s.current.push(z),z.promiseFn},[])}},S=(s={})=>{const{cancelablePromise:b}=c(),[y,z]=(0,k.useState)(s),T=(0,k.useRef)({}),X=(0,k.useRef)({}),yt=(0,k.useCallback)((at=null)=>{Array.isArray(at)&&at.length?at.map(It=>T.current[It]=s[It]):T.current=s},[]),dt=(0,k.useCallback)((at,It,me=!1)=>{const Le=Object.keys(at),He=JSON.stringify(Le.sort());if(!X.current[He]){X.current[He]=!0,me&&yt(Array.isArray(me)?me:Le),Le.map(xe=>{T.current[xe]||(T.current[xe]={}),T.current[xe].pending=!0}),z({...T.current});for(let xe=0,ar=Le.length;xe<ar;xe++){const vr=Le[xe];b(at[vr]).then(Fe=>{let{result:ke,errMsg:Ce}=Fe;xe===ar-1&&(X.current[He]=!1),typeof It=="function"&&(ke=It(ke)||ke),T.current[vr]={...ke,pending:!1},Ce===!1&&z({...T.current})}).catch(Fe=>{throw xe===ar-1&&(X.current[He]=!1),T.current[vr]={error:Fe,pending:!1},z({...T.current}),Fe})}}},[]);return[y,dt,yt]},x=s=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(s),E=s=>new Promise((b,y)=>{const z=new FileReader;z.readAsDataURL(s),z.addEventListener("load",()=>b(z.result)),z.addEventListener("error",T=>y(T))}),F=async s=>{if(!x(s))return s;const b=await(await fetch(s)).blob();return await E(b)},O=s=>{const[b,y]=(0,k.useState)(s);return(0,k.useEffect)(()=>{(async z=>{const T=await F(z);y(T)})(s)},[]),b},$=(s,b)=>Object.prototype.hasOwnProperty.call(s??{},b),C=s=>$(s,"current"),U=(s,b,y="click")=>{(0,k.useEffect)(()=>{const z=X=>{const yt=C(s)?s.current:s;yt?.contains&&!yt.contains(X.target)&&b(X)},T=typeof y=="string"?[y]:y;return T.map(X=>{document.addEventListener(X,z,!1)}),()=>{T.map(X=>{document.removeEventListener(X,z,!1)})}},[s,b,y])},xt=(s=()=>{},b=60)=>{let y=null;return function(...z){clearTimeout(y),y=setTimeout(()=>s.apply(this,z),b)}},kt=(s,b=60)=>(0,k.useMemo)(()=>xt(s,b),[b]),Ut=()=>{const s=(0,k.useRef)(!0);return s.current?(s.current=!1,!0):!1},Q=(s,b=[])=>{const y=Ut();(0,k.useEffect)(()=>{if(!y)return s()},b)},Xt=(s,b=450)=>{const[y,z]=(0,k.useState)(s);return Q(()=>{let T;return s||b===0?z(s):T=setTimeout(()=>z(s),b),()=>T&&clearTimeout(T)},[s]),[y,z]},_t=()=>![typeof window,typeof document].includes("undefined"),qt=s=>Rt(s).indexOf("element")>-1,le=(s=null)=>_t()?qt(s)?{width:s.clientWidth,height:s.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},ee=(s,b)=>{const y=[],z=s.children??[];for(let T=0,X=z.length;T<X;T++){const yt=z[T];yt.className.indexOf(b)>-1&&y.push(yt)}return y.length===0?null:y.length===1?y[0]:y},K=(s,b)=>{getComputedStyle(s).position==="static"&&(s.style.position="relative");const y=document.createElement("object");return y.setAttribute("style","display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0"),y.setAttribute("class","resize-sensor"),y.onload=()=>{y.contentDocument.defaultView.addEventListener("resize",b,!1),b()},y.type="text/html",s.appendChild(y),y.data="about:blank",y},he=(s,b=60)=>{if(!_t())return;s=C(s)?s.current:s??document.body;let y=ee(s,"resize-sensor"),z=[];const T=xt(()=>z.map(at=>at(s)),b),X=at=>{ee(s,"resize-sensor")||(y=K(s,T)),z.indexOf(at)===-1&&z.push(at)},yt=at=>{const It=z.indexOf(at);It!==-1&&z.splice(It,1),z.length===0&&y&&dt()},dt=()=>{y&&y.parentNode&&(y.contentDocument&&y.contentDocument.defaultView.removeEventListener("resize",T,!1),y.parentNode.removeChild(y),y=void 0,z=[])};return{element:s,bind:X,unbind:yt,destroy:dt}},Qe=(s={})=>{const b=(0,k.useRef)(0),[y,z]=(0,k.useState)(s),T=(0,k.useCallback)(X=>{cancelAnimationFrame(b.current),b.current=requestAnimationFrame(()=>z(X))},[]);return(0,k.useEffect)(()=>()=>cancelAnimationFrame(b.current),[]),[y,T]},Me=(s=null,b=60)=>{const y=C(s)?s.current:s,{bind:z,destroy:T}=he(y,b),[X,yt]=Qe(le(y));return(0,k.useEffect)(()=>(z(()=>y&&yt(le(y))),()=>T()),[y]),X},Yr=s=>{const b=(0,k.useRef)(null);return(0,k.useLayoutEffect)(()=>{b.current=s}),(0,k.useCallback)(b.current,[])},tr=(s,b)=>{const y=(0,k.useRef)();(0,k.useEffect)(()=>{y.current=s},[s]),(0,k.useEffect)(()=>{if(b){const z=setInterval(()=>y.current(),b);return()=>clearInterval(z)}},[b])},hr=s=>{const b=(0,k.useRef)();return(0,k.useEffect)(()=>{b.current=s},[s]),b.current},fr=(s=null)=>_t()?qt(s)?{left:s.scrollLeft,top:s.scrollTop}:{left:window.pageXOffset??document.documentElement.scrollLeft??document.body.scrollLeft,top:window.pageYOffset??document.documentElement.scrollTop??document.body.scrollTop}:{left:0,top:0},er=(s=null)=>{const[b,y]=Qe(fr(s));return(0,k.useEffect)(()=>{const z=()=>y(fr(s)),T=qt(s)?s:window;return T.addEventListener("scroll",z,{capture:!1,passive:!0}),()=>T.removeEventListener("scroll",z)},[s]),b},pr=s=>Rt(s)==="array",ce=s=>pr(s)&&!!s.length,rr=(s,b,y=[],z=!1,T=null)=>ce(s)?b?(y=typeof y=="string"?y.split(","):y,s.filter(X=>(y=y.length>0?y:Object.keys(X),y.filter(yt=>{const dt=X[yt];if(dt==null)return!1;if(z)return dt===b;const at=new RegExp(b,"gi"),It=dt.toString().match(at);return It&&T&&(X[yt]=T(dt.toString().replace(at,`<span style="background-color:yellow">${It[0]}</span>`),{display:"inline-block"})),It}).length))):s:[],Ae=(s,b="id")=>{if(!ce(s))return s;const y=[],z=[];return s.map(T=>{const X=Wt(T)?T[b]:T;z.includes(X)||(z.push(X),y.push(T))}),y},fe=s=>s?.$$typeof&&typeof s.$$typeof=="symbol"&&s.$$typeof.description==="react.element",or=s=>s?.__v_isVNode,mr=s=>{if(!pr(s)&&!Wt(s))return s;const b=pr(s)?[]:{};for(const y in s)if($(s,y)){const z=s[y];b[y]=fe(z)||or(z)||typeof z!="object"?z:z!==s?mr(z):"cyclic"}else Object.setPrototypeOf(b,{[y]:s[y]});return b},oe=mr,jr=s=>(b,y="children")=>{if(!Array.isArray(b))return b;const z=oe(b),T=X=>{const yt=[];return X.map(dt=>{if(ce(dt[y])){const at=T(dt[y])||[];dt[y]=at,at.length>0&&yt.push(dt)}}),s(X,yt)};return T(z)},nr=(s,b,y,z="name",T="id",X="children",yt=!1)=>jr((dt,at)=>Ae([...rr(dt,b,z,yt,y),...at],T))(s,X);var Vr=ft(322);const xr=(s,b)=>(0,Vr.jsx)("div",{dangerouslySetInnerHTML:{__html:s},...b}),Mr=(s=null,b=xr)=>{const[y,z]=(0,k.useState)(s),T=(0,k.useCallback)((...X)=>{const[yt,dt,...at]=X;if(!dt)z(null);else{X=[yt,dt,b,...at];const It=nr(...X);z(It)}},[]);return[y,T]},Ie=s=>{const[b,y]=(0,k.useState)(s);return(0,k.useEffect)(()=>y(s),[s]),[b,y]},Pe=()=>{const s={};return{on:(b,y)=>{s[b]||(s[b]=[]),s[b].indexOf(y)===-1&&s[b].push(y)},emit:(b,y)=>{s[b]&&s[b].map(z=>z(y))},off:(b,y=null)=>{if(s[b]){if(typeof y!="function")return delete s[b];const z=s[b].indexOf(y);z>-1&&(s[b].splice(z,1),s[b].length||delete s[b])}}}},ir=s=>{const b={};for(let y in s)$(s,y)||(b[y]=s[y]);return b},ve=(s,b)=>{if(!Wt(s))return b;if(!Wt(b))return s;const y={...ir(s),...ir(b)},z={...s,...b};return Object.keys(y).map(T=>{Object.setPrototypeOf(z,{[T]:y[T]})}),z},yr=(()=>{const{on:s,emit:b,off:y}=Pe(),z={};return{getState:T=>oe(z[T]),setState:(T,X=!1)=>{if(typeof T=="function"&&(T=T(oe(z))),!Wt(T))throw TypeError("\u5FC5\u987B\u4F20\u5165object\u5BF9\u8C61\uFF01");const yt=oe(T);Object.keys(yt).map(dt=>{const at=z[dt],It=yt[dt],me=Wt(It)&&Wt(at)?ve(at,It):It;!X&&b(dt,me),z[dt]=me})},subscribe:(T,X)=>(s(T,X),()=>y(T,X)),unsubscribe:y,clean:T=>{typeof T=="string"?z[T]=void 0:Array.isArray(T)?T.map(X=>z[X]=void 0):Object.keys(z).map(X=>z[X]=void 0)}}})(),$e=Lt(yr),_e=s=>s<10?"0"+s:s,Sr=(s=new Date)=>{const b=new Date(s),y=b.getFullYear(),z=b.getDay(),T=_e(b.getMonth()+1),X=_e(b.getDate()),yt=_e(b.getHours()),dt=_e(b.getMinutes()),at=_e(b.getSeconds());return[y,T,X,yt,dt,at,z]},gr=["\u661F\u671F\u65E5","\u661F\u671F\u4E00","\u661F\u671F\u4E8C","\u661F\u671F\u4E09","\u661F\u671F\u56DB","\u661F\u671F\u4E94","\u661F\u671F\u516D"],zr=(s,b,y="-")=>s.replace(new RegExp(y,"g"),b),Be=(s=new Date,b=["-","-"," ",":",":",""],y=gr)=>{const z=Sr(s);let T="";return b.map((X,yt)=>T+=(yt===6?y[z[yt]]:z[yt]??"")+X),T},Ze=()=>Be(new Date,["-","-"," ",":",":"," ",""]),br=()=>{const[s,b]=(0,k.useState)("");return tr(()=>{b(Ze())},1e3),[s]},$r=s=>++s,we=()=>{const[,s]=(0,k.useState)(0);return(0,k.useCallback)(()=>s($r),[])},pe=()=>{const[s,b]=Qe(le());return(0,k.useEffect)(()=>{const y=()=>b(le());return window.addEventListener("resize",y,!1),()=>window.removeEventListener("resize",y,!1)},[]),s}})();var ut=A.fH,jt=A.r5,Wr=A.Nd,Vt=A.KY,Ht=A.Vd,N=A.Nr,M=A.D,B=A.Wy,V=A.zX,H=A.Cd,tt=A.Yz,J=A.D9,rt=A.cb,vt=A.vO,wt=A.Rx,Ft=A.OH,Pt=A.oR,lt=A.rE,$t=A.PQ,Mt=A.rf,Zt=A.xd},1090:function(Rr,zt,te){te.d(zt,{A_F:function(){return Ki},JaC:function(){return Ni},MTn:function(){return Bi},NA2:function(){return Zi},PTJ:function(){return Vi},Vcq:function(){return Ji},_O2:function(){return ta},_iG:function(){return Li},afD:function(){return Yi},azd:function(){return Qi},eyl:function(){return Mi},f9u:function(){return ra},fHt:function(){return Pi},gVz:function(){return qi},jg2:function(){return Xi},k$y:function(){return ea},mrB:function(){return Wi},muM:function(){return Ai},qg7:function(){return Ri},rWO:function(){return Hi},tOc:function(){return Gi},vQq:function(){return Ii},ywV:function(){return Ui}});var Bt={};(function(){Bt.d=function(t,e){for(var r in e)Bt.o(e,r)&&!Bt.o(t,r)&&Object.defineProperty(t,r,{enumerable:!0,get:e[r]})}})(),function(){Bt.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)}}();var u={};Bt.d(u,{NzM:function(){return Ne},wBC:function(){return N},O39:function(){return B},cnu:function(){return J},E4D:function(){return vt},TRp:function(){return Ft},zI1:function(){return lt},Ufj:function(){return Mt},GxO:function(){return Rt},cu2:function(){return ae},BcS:function(){return ot},lPd:function(){return xt},dC1:function(){return Ut},$L2:function(){return Xt},Vji:function(){return S},YxP:function(){return C},UhT:function(){return ce},JaC:function(){return Ae},o4B:function(){return oe},Hlr:function(){return gr},muM:function(){return T},OiV:function(){return yr},KTn:function(){return yt},lwL:function(){return at},d9v:function(){return y},yCD:function(){return me},qCK:function(){return He},vQq:function(){return ar},fHt:function(){return Fe},azq:function(){return Ue},dSY:function(){return g},MTn:function(){return gt},RYO:function(){return Ce},WAo:function(){return Ot},GVc:function(){return Be},Emy:function(){return St},v9O:function(){return ct},DsO:function(){return Nt},_lj:function(){return ne},vO6:function(){return ye},xDX:function(){return Gr},hf3:function(){return zo},ip7:function(){return Xr},uYe:function(){return Y},DgJ:function(){return br},rae:function(){return $o},YBu:function(){return uo},_iG:function(){return fo},hXT:function(){return to},gQq:function(){return To},D_D:function(){return eo},$nD:function(){return mo},dtG:function(){return xo},Y0R:function(){return go},qg7:function(){return Cr},Xxf:function(){return Po},tSM:function(){return bo},Few:function(){return i},xHg:function(){return j},aoj:function(){return R},Dlm:function(){return ht},mrB:function(){return At},dKu:function(){return Te},v1d:function(){return Tr},afD:function(){return Ye},Lz5:function(){return vo},xZX:function(){return Yo},G_1:function(){return wo},osI:function(){return Vo},PTJ:function(){return sn},Qfx:function(){return cn},bti:function(){return ge},XBv:function(){return un},eyl:function(){return dn},y35:function(){return hn},hKD:function(){return it},BWC:function(){return Mo},oLi:function(){return A},NA2:function(){return mn},S3Y:function(){return se},pvT:function(){return Zo},m2f:function(){return ee},rWO:function(){return xn},A$w:function(){return yn},kJL:function(){return jt},S9U:function(){return ir},dYC:function(){return gn},jUY:function(){return k},J_U:function(){return bn},kKo:function(){return H},VZO:function(){return vn},mf2:function(){return Ie},w1q:function(){return wn},Kn2:function(){return E},ncl:function(){return kn},LWC:function(){return we},dqb:function(){return he},Kjn:function(){return Cn},TaN:function(){return ko},CBv:function(){return We},rTd:function(){return qr},B73:function(){return En},SSA:function(){return s},CLv:function(){return jn},F$z:function(){return Sn},XT_:function(){return Ho},omS:function(){return zn},poV:function(){return $n},VXY:function(){return _n},xsP:function(){return Fn},HPs:function(){return On},TSy:function(){return Dn},B5o:function(){return Co},u1A:function(){return Tn},WAY:function(){return Eo},I8J:function(){return W},ywV:function(){return Bn},bEN:function(){return Ln},$45:function(){return Rn},TUk:function(){return Wn},T7B:function(){return O},CEd:function(){return Yn},IHq:function(){return Vn},SkG:function(){return qo},Smz:function(){return xr},nL5:function(){return nr},ON:function(){return Hn},eiS:function(){return Un},Frc:function(){return Xn},z5J:function(){return qn},scT:function(){return Kn},hd2:function(){return So},AnA:function(){return Gn},kYX:function(){return Jn},yZP:function(){return Qn},IVd:function(){return jo},SIr:function(){return ei},jg2:function(){return ri},gVz:function(){return oi},puc:function(){return ai},Azz:function(){return li},X5u:function(){return Me},dPh:function(){return si},SMZ:function(){return qt},kro:function(){return Vt},nPi:function(){return ci},US:function(){return ui},A_F:function(){return je},_vH:function(){return Se},gmH:function(){return Jr},DYV:function(){return di},qi2:function(){return hi},tOc:function(){return fi},hau:function(){return mi},FaZ:function(){return Dr},uyF:function(){return xi},Vcq:function(){return yi},XKW:function(){return gi},azd:function(){return or},P2K:function(){return bi},XBe:function(){return Ci},JZ7:function(){return tn},ABi:function(){return Oe},ogC:function(){return Ei},_O2:function(){return f},P0C:function(){return ji},Uo5:function(){return Si},Two:function(){return Pr},tYQ:function(){return zi},tVn:function(){return h},pHy:function(){return $i},k$y:function(){return lr},yfi:function(){return _i},fl8:function(){return Fi},f9u:function(){return Oi},ZV1:function(){return Di},Lgs:function(){return Ti}});var Ne=(t,e="key",r="value")=>{const o={};return(t||[]).map(n=>o[n[e]]=n[r]),o},A=t=>Object.prototype.toString.call(t).slice(8,-1).toLowerCase(),jt=t=>A(t)==="array",Vt=t=>(e,r,o="id",n="children")=>{if(!jt(e))return null;const d=(p,_="")=>{for(let D=0,et=p.length;D<et;D++){const Et=p[D];if(Et[o]===r)return t(p,D,_)||p[D];if(jt(Et[n])){const Jt=d(Et[n],Et[o]);if(Jt)return Jt}}};return d(e),e},N=(t,e,r,o="id",n="children")=>Vt((d,p)=>d.splice(p,0,r))(t,e,o,n),B=(t,e,r,o,n="id",d="children")=>Vt((p,_)=>{const D=p[_];D.children?D.children.splice(o,0,r):D.children=[r]})(t,e,n,d),H=t=>A(t).indexOf("element")>-1,J=(t,e="")=>{if(!H(t))return;const r=e.split(" ").filter(Boolean),o=t.className.split(" "),n=[...new Set([...r,...o])];t.className=n.join(" ")},vt=(t,e=new Date)=>{const r=new Date(e);return r.setDate(r.getDate()+t),r},Ft=(t,e=new Date)=>{const r=new Date(e);return r.setHours(r.getHours()+t),r},lt=(t,e=new Date)=>{const r=new Date(e);return r.setMonth(r.getMonth()+t),r},Mt=(t,e,r,o="id",n="children")=>Vt((d,p)=>{const _=d[p];return _[n]=[..._[n]||[],...r],_})(t,e,o,n),k=()=>![typeof window,typeof document].includes("undefined"),Rt=t=>{if(k())return new Promise((e,r)=>{if([...document.getElementsByTagName("script")].find(o=>o.src===t))e();else{const o=document.createElement("script");o.onerror=n=>r(new Error(`Failed to load '${t}'`)),o.onload=e,o.src=t,(document.head||document.getElementsByTagName("head")[0]).appendChild(o)}})},ae=(t,e)=>{if(k())return e?new Promise((r,o)=>{if([...document.getElementsByTagName("style")].map(n=>n.getAttribute("huxy-css-hash")).filter(Boolean).find(n=>n===e))r();else{const n=document.createElement("style");n.onerror=d=>o(new Error(`Failed to load '${e}' style`)),n.onload=r,n.innerHTML=t,n.setAttribute("huxy-css-hash",e),(document.head||document.getElementsByTagName("head")[0]).appendChild(n)}}):new Promise((r,o)=>{if([...document.getElementsByTagName("link")].find(n=>n.href===t))r();else{const n=document.createElement("link");n.onerror=d=>o(new Error(`Failed to load '${t}'`)),n.onload=r,n.href=t,n.rel="stylesheet",(document.head||document.getElementsByTagName("head")[0]).appendChild(n)}})},ot=(t,e=new Date)=>{const r=new Date(e);return r.setFullYear(r.getFullYear()+t),r},S=(t=[],e="name")=>{const r={};return t.map(({[e]:o,value:n})=>r[o]=n),r},E=t=>A(t)==="object";const F=(t={})=>{let e="";return Object.keys(t).map(r=>{const o=t[r];e=e&&`${e}, `,E(o)?e+=`${r}=${F(o)}`:Array.isArray(o)?e+=`${r}=${C(o)}`:e+=`${r}=${o}`}),`{${e}}`};var O=F;const $=(t=[])=>{let e="";return t.map(r=>{e=e&&`${e}, `,E(r)?e+=O(r):Array.isArray(r)?e+=$(r):e+=`${r}`}),`[${e}]`};var C=$,xt=t=>(e,r="id",o="children",n=-1)=>{if(!jt(e))return e;const d={},p=e.map(_=>_[r]);return[...e].map(_=>{const D={..._},{[r]:et}=D;if(et!=null){let{parentId:Et}=D;Et==null&&(Et=t?.(D)??n,D.parentId=Et),d[et]||(d[et]=[]),D[o]=d[et],d[Et]||(d[Et]=[]),d[n]||(d[n]=[]),p.includes(Et)?d[Et].push(D):d[n].push(D)}}),d[n]},Ut=(t,e="id",r="children",o=-1)=>xt(n=>n[e].match(/\S+(?=-\S+)/)?.[0]||o)(t,e,r,o),Xt=(t,e="path",r="children",o=null)=>xt(n=>{const d=n[e],p=d.match(/.*\/[^:/]+\/:[^/]+/);return p?p[0].match(/(.*)\/:+/)?.[1]??o:d.match(/(.*)\/+/)?.[1]??o})(t,e,r,o),qt=()=>k()&&(window.pageYOffset??document.documentElement.scrollTop??document.body.scrollTop),ee=(t,e)=>Object.prototype.hasOwnProperty.call(t??{},e),he=t=>ee(t,"current"),Me=(t=0,e)=>{k()&&(e=he(e)?e.current:e??window,e.scrollTo?.({top:t,behavior:"smooth"}))},tr=`.huxy-totop-bar {
  --size: 36px;
  --color: #fff;
  --bgColor: #666;
  --hoverBgColor: #40a9ff;
