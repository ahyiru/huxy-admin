(self.webpackChunk=self.webpackChunk||[]).push([[713],{5713:function($e,vr,Kt){var tr;Kt.d(vr,{Cd:function(){return ur},FM:function(){return wr},_k:function(){return yr},sA:function(){return fr}});var mr=Kt(7378),gr={496:(r,s,t)=>{t.d(s,{Z:()=>l});var n=t(601),a=t.n(n),d=t(609),o=t.n(d),e=o()(a());e.push([r.id,`@keyframes huxy-3d-models {
  0% {
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(C))))," */")),d.styleTagTransform(e,a,d.options)}function t(a){if(a.parentNode===null)return!1;a.parentNode.removeChild(a)}function n(a){var d=a.insertStyleElement(a);return{update:function(o){s(d,a,o)},remove:function(){t(d)}}}r.exports=n},464:r=>{function s(t,n){if(n.styleSheet)n.styleSheet.cssText=t;else{for(;n.firstChild;)n.removeChild(n.firstChild);n.appendChild(document.createTextNode(t))}}r.exports=s},810:r=>{var s=n=>{var a={};return g.d(a,n),a},t=n=>()=>n;r.exports=tr||(tr=Kt.t(mr,2))}},rr={};function g(r){var s=rr[r];if(s!==void 0)return s.exports;var t=rr[r]={id:r,exports:{}};return gr[r](t,t.exports,g),t.exports}g.n=r=>{var s=r&&r.__esModule?()=>r.default:()=>r;return g.d(s,{a:s}),s},g.d=(r,s)=>{for(var t in s)g.o(s,t)&&!g.o(r,t)&&Object.defineProperty(r,t,{enumerable:!0,get:s[t]})},g.o=(r,s)=>Object.prototype.hasOwnProperty.call(r,s),g.nc=void 0;var w={};(()=>{g.d(w,{$V:()=>Pr,Bp:()=>Er,Ak:()=>_r,Zb:()=>Rr,Cd:()=>Dr,W2:()=>Gr,M9:()=>Ar,V5:()=>er,A:()=>Br,QN:()=>kr,aI:()=>Sr,sA:()=>Cr,TK:()=>Nr,_k:()=>he,aV:()=>Fr,gb:()=>le,Ye:()=>ie,df:()=>Or,Ex:()=>Lr,gd:()=>ze,FM:()=>Jr,ol:()=>oe,z6:()=>ne,iA:()=>Vr,P8:()=>ce,Qp:()=>ge,QV:()=>ue,R8:()=>ye,By:()=>Ce,qp:()=>re,ql:()=>Ir,iL:()=>Tr,iC:()=>Qr});var r=g(322);const s=i=>i?.$$typeof&&typeof i.$$typeof=="symbol"&&i.$$typeof.description==="react.element",t=(i,c="px")=>`${i}`.replace(c,"")-0;var n=g(62),a=g.n(n),d=g(36),o=g.n(d),e=g(793),l=g.n(e),C=g(892),f=g.n(C),z=g(173),v=g.n(z),Z=g(464),y=g.n(Z),j=g(496),S={};S.styleTagTransform=y(),S.setAttributes=f(),S.insert=l().bind(null,"head"),S.domAPI=o(),S.insertStyleElement=v();var eo=a()(j.Z,S);const oo=j.Z&&j.Z.locals?j.Z.locals:void 0,er=({list:i=[],size:c="360px",cardSize:h="42px",bottom:p="60px",style:b,...x})=>{const m=360/i.length;return(0,r.jsx)("div",{className:"huxy-css-3d-models",style:{"--size":c,"--cardSize":h,"--bottom":p,...b},...x,children:(0,r.jsx)("div",{className:"model-container",children:i.map((u,k)=>(0,r.jsx)("div",{className:"model-item",style:{"--rotateY":`${m*k}deg`},children:(0,r.jsxs)("a",{className:"model-card huxy-css-3d-models-tooltip",tooltip:u.label,href:u.link,target:"_blank",children:[u.icon?(0,r.jsx)("img",{src:u.icon,alt:u.label}):null,s(u.icon)?u.icon:u.icon?(0,r.jsx)("img",{src:u.icon,alt:u.label}):null]})},u.label))})})};var mt=g(271),I={};I.styleTagTransform=y(),I.setAttributes=f(),I.insert=l().bind(null,"head"),I.domAPI=o(),I.insertStyleElement=v();var ao=a()(mt.Z,I);const io=mt.Z&&mt.Z.locals?mt.Z.locals:void 0,Cr=({objs:i=[],models:c=[],height:h="480px",style:p,className:b,...x})=>(0,r.jsxs)("div",{className:`huxy-icon-animate-container${b?` ${b}`:""}`,style:{"--height":h,...p},...x,children:[(0,r.jsx)("div",{className:"huxy-icon-animate-materiels",children:i.map(({value:m,label:u,icon:k,link:$,type:Y,style:xt})=>(0,r.jsx)("a",{className:`huxy-icon-animate-tooltip obj-${m}${Y?"":" obj-img"}`,tooltip:Y?void 0:u,href:$,target:"_blank",style:xt,children:s(k)?k:(0,r.jsx)("img",{src:k,alt:u})},u))}),(0,r.jsx)(er,{list:c,size:`${t(h)-120}px`})]});var gt=g(190),P={};P.styleTagTransform=y(),P.setAttributes=f(),P.insert=l().bind(null,"head"),P.domAPI=o(),P.insertStyleElement=v();var lo=a()(gt.Z,P);const ut=gt.Z&&gt.Z.locals?gt.Z.locals:void 0,kr=({front:i,back:c,...h})=>(0,r.jsx)("div",{className:ut["huxy-card-fliper"],...h,children:(0,r.jsxs)("div",{className:ut.card,children:[(0,r.jsx)("div",{className:ut.front,children:i}),(0,r.jsx)("div",{className:ut.back,children:c})]})});var _=g(810);const zr=(i={})=>{const c=(0,_.useRef)(0),[h,p]=(0,_.useState)(i),b=(0,_.useCallback)(x=>{cancelAnimationFrame(c.current),c.current=requestAnimationFrame(()=>p(x))},[]);return(0,_.useEffect)(()=>()=>cancelAnimationFrame(c.current),[]),[h,b]},Zr=(i,c)=>{const h=(0,_.useRef)();(0,_.useEffect)(()=>{h.current=i},[i]),(0,_.useEffect)(()=>{if(c){const p=setInterval(()=>h.current(),c);return()=>clearInterval(p)}},[c])};var ft=g(498),W={};W.styleTagTransform=y(),W.setAttributes=f(),W.insert=l().bind(null,"head"),W.domAPI=o(),W.insertStyleElement=v();var so=a()(ft.Z,W);const no=ft.Z&&ft.Z.locals?ft.Z.locals:void 0,$r=(i,c=60)=>(c=1.5*c,i.map((h,p)=>{const b=Math.random();let x=1;b<.3334?x=1.2:b<.6667&&(x=.8);const m=~~(p/3),u=p%3;let k=1.5*c*m;u===1&&(k+=c/2);const $=u*c+c/6*(u+1);return h.transform={x:k,y:$,s:x},h})),jr=(i,c=60)=>(c=2.25*c,i.map(h=>(h.transform.x-=2,h.transform.x+c<0&&(h.transform.x=~~(i.length/3)*c),h))),Nr=({width:i=60,wait:c=56,list:h=[],className:p,...b})=>{const x=(0,_.useMemo)(()=>$r(h,i),[]),[m,u]=zr(x),[k,$]=(0,_.useState)(c);Zr(()=>{const A=jr(m,i);u(A)},k);const Y=A=>{$(null)},xt=A=>{$(c)};return(0,r.jsx)("div",{className:`huxy-icon-carousel${p?` ${p}`:""}`,...b,children:(0,r.jsx)("div",{className:"icon-container",children:m.map((A,Ze)=>(0,r.jsx)("a",{className:`icon-item huxy-icon-carousel-tooltip-${Ze%3===0?"lt":"lb"}`,tooltip:A.label,style:{transform:`translate(${A.transform.x}px, ${A.transform.y}px) scale(${A.transform.s})`,width:i},onMouseEnter:Y,onMouseLeave:xt,href:A.link,target:"_blank",children:(0,r.jsx)("img",{src:A.icon,alt:A.label})},A.label))})})};var yt=g(317),E={};E.styleTagTransform=y(),E.setAttributes=f(),E.insert=l().bind(null,"head"),E.domAPI=o(),E.insertStyleElement=v();var co=a()(yt.Z,E);const or=yt.Z&&yt.Z.locals?yt.Z.locals:void 0,Tr=({title:i,borderColor:c,titleWidth:h,titleHeight:p,style:b,className:x,...m})=>(0,r.jsx)("div",{className:`${or["huxy-title-header-box"]}${x?` ${x}`:""}`,style:{"--borderColor":c,"--titleWidth":h,"--titleHeight":p,...b},...m,children:(0,r.jsx)("h2",{className:or.title,children:i})});var wt=g(548),R={};R.styleTagTransform=y(),R.setAttributes=f(),R.insert=l().bind(null,"head"),R.domAPI=o(),R.insertStyleElement=v();var po=a()(wt.Z,R);const vt=wt.Z&&wt.Z.locals?wt.Z.locals:void 0,Ar=({size:i="8px",borderColor:c="var(--appColor)",half1:h=!0,half2:p=!0,style:b,className:x,children:m,...u})=>(0,r.jsx)("div",{className:`${vt["corner-wrap"]}${x?` ${x}`:""}`,style:{"--cornerSize":i,"--borderColor":c,...b},...u,children:(0,r.jsxs)("div",{className:`${vt.corner}${h?` ${vt.half}`:""}`,children:[p?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("span",{className:vt["corner-tl"]}),(0,r.jsx)("span",{className:vt["corner-br"]})]}):null,m]})});var Ct=g(479),M={};M.styleTagTransform=y(),M.setAttributes=f(),M.insert=l().bind(null,"head"),M.domAPI=o(),M.insertStyleElement=v();var ho=a()(Ct.Z,M);const ar=Ct.Z&&Ct.Z.locals?Ct.Z.locals:void 0,Sr=({size:i="8px",borderColor:c="var(--appColor)",style:h,className:p,children:b,...x})=>(0,r.jsx)("div",{className:`${ar["corner-wrap"]}${p?` ${p}`:""}`,style:{"--cornerSize":i,"--borderColor":c,...h},...x,children:(0,r.jsx)("div",{className:ar["corner-half"],children:b})});var kt=g(289),D={};D.styleTagTransform=y(),D.setAttributes=f(),D.insert=l().bind(null,"head"),D.domAPI=o(),D.insertStyleElement=v();var bo=a()(kt.Z,D);const Yr=kt.Z&&kt.Z.locals?kt.Z.locals:void 0,_r=({type:i="dot",bgColor:c,cubeColor:h,url:p,style:b,className:x,children:m,...u})=>{i=p?"img":i;const k=p?{backgroundImage:`url(${p})`}:void 0;return(0,r.jsx)("div",{className:`${Yr[`bg-box-${i}`]}${x?` ${x}`:""}`,style:{"--bgColor":c,"--cubeColor":h,...k,...b},...u,children:m})};var zt=g(96),B={};B.styleTagTransform=y(),B.setAttributes=f(),B.insert=l().bind(null,"head"),B.domAPI=o(),B.insertStyleElement=v();var xo=a()(zt.Z,B);const Vt=zt.Z&&zt.Z.locals?zt.Z.locals:void 0,Ir=({children:i,title:c,fontSize:h,borderSize:p,borderColor:b="var(--appColor)",space:x="10px",style:m,className:u,...k})=>(0,r.jsxs)("div",{className:`${Vt["huxy-title-border-wrap"]}${u?` ${u}`:""}`,style:{"--borderColor":b,"--space":x,"--fontSize":h,"--borderSize":p,...m},...k,children:[(0,r.jsx)("div",{className:Vt["huxy-title-border-top"],children:c}),(0,r.jsx)("div",{className:Vt["huxy-title-border-box"],children:i})]});var Zt=g(804),F={};F.styleTagTransform=y(),F.setAttributes=f(),F.insert=l().bind(null,"head"),F.domAPI=o(),F.insertStyleElement=v();var vo=a()(Zt.Z,F);const ir=Zt.Z&&Zt.Z.locals?Zt.Z.locals:void 0,Pr=({type:i="solid",space:c="2px",borderColor:h="var(--appColor)",style:p,className:b,children:x,...m})=>(0,r.jsx)("div",{className:`${ir["huxy-border-wrap"]}${b?` ${b}`:""}`,style:{"--space":c,"--borderColor":h,...p},...m,children:(0,r.jsx)("div",{className:ir[`huxy-border-animate-${i==="dash"?"dash":"solid"}`],children:x})}),Wr=(i="",c=0,h="0")=>{const p=i.length;return p>=c?i:`${Array(c-p+1).join(h)}${i}`},N=()=>"#"+Wr((~~(Math.random()*(1<<24))).toString(16),6),T=(i=0,c=0,h=!0)=>(i<c&&(i=[c,c=i][0]),h?~~(Math.random()*(i-c+1))+c:Math.random()*(i-c)+c),qt=(i=[])=>i[T(i.length-1)];var $t=g(303),H={};H.styleTagTransform=y(),H.setAttributes=f(),H.insert=l().bind(null,"head"),H.domAPI=o(),H.insertStyleElement=v();var mo=a()($t.Z,H);const lr=$t.Z&&$t.Z.locals?$t.Z.locals:void 0,sr=i=>i?.length?qt(i):N(),Er=({list:i=10,height:c="240px",space:h="25px",itemWidth:p="30px",colors:b=[],color:x,style:m,className:u,...k})=>(0,r.jsx)("div",{className:`${lr["huxy-skeleton-barchart"]}${u?` ${u}`:""}`,style:{"--height":c,...m},...k,children:(Array.isArray(i)?i:[...new Array(i)]).map(($,Y)=>(0,r.jsx)("div",{className:lr["sk-bar-item"],style:{"--space":h,"--itemWidth":p,"--bgColor":$?.color??x??`linear-gradient(to top, ${sr(b)}, ${sr(b)})`,"--itemHeight":$?.height??`${T(15,100)}%`,left:`${Y*(t(h)+t(p))}px`}},`huxy-skeleton-barchart-${Y}`))});var jt=g(761),X={};X.styleTagTransform=y(),X.setAttributes=f(),X.insert=l().bind(null,"head"),X.domAPI=o(),X.insertStyleElement=v();var go=a()(jt.Z,X);const O=jt.Z&&jt.Z.locals?jt.Z.locals:void 0,Rr=({height:i="120px",leftColor:c,rightColor:h,topWidth:p,bottomWidth:b,style:x,className:m,...u})=>(0,r.jsxs)("div",{className:`${O["huxy-skeleton-card"]}${m?` ${m}`:""}`,style:{"--height":i,"--leftColor":c??N(),"--rightColor":h??N(),"--topWidth":p??`${T(30,60)}%`,"--bottomWidth":b??`${T(55,95)}%`,...x},...u,children:[(0,r.jsx)("div",{className:O["sk-card-left"],children:(0,r.jsx)("div",{className:O["sk-card-img"]})}),(0,r.jsxs)("div",{className:O["sk-card-right"],children:[(0,r.jsx)("h4",{className:O.title}),(0,r.jsx)("p",{className:O.text})]})]});var Nt=g(129),U={};U.styleTagTransform=y(),U.setAttributes=f(),U.insert=l().bind(null,"head"),U.domAPI=o(),U.insertStyleElement=v();var uo=a()(Nt.Z,U);const nr=Nt.Z&&Nt.Z.locals?Nt.Z.locals:void 0,Mr=[{borderWidth:"2px",borderRightColor:"rgba(2, 255, 255, 0.15)",borderTopColor:"rgba(2, 255, 255, 0.15)",borderBottomColor:"rgba(2, 255, 255, 0.15)",time:"5s"},{borderWidth:"5px",borderTopColor:"rgba(2, 255, 255, 0.7)",borderBottomColor:"rgba(2, 255, 255, 0.7)",time:"4s",rotateStart:"360deg",rotateEnd:"0deg"},{borderWidth:"3px",borderTopColor:"rgba(2, 255, 255, 0.5)",borderBottomColor:"rgba(2, 255, 255, 0.5)",time:"3s"},{borderWidth:"4px",borderTopColor:"rgba(2, 255, 255, 0.15)",time:"2s",rotateStart:"360deg",rotateEnd:"0deg"}],Dr=({size:i="300px",space:c="8px",style:h,className:p,...b})=>{let x=t(c)*3;return(0,r.jsx)("div",{className:`${nr["huxy-animate-border-circle"]}${p?` ${p}`:""}`,style:{"--size":i,...h},...b,children:Mr.map((m,u)=>(x=x+t(m.borderWidth)*2+t(c)*2,(0,r.jsx)("div",{className:nr["border-circle-item"],style:{"--itemSize":`calc(${i} - ${x}px)`,"--borderWidth":m.borderWidth,"--borderLeftColor":m.borderLeftColor,"--borderRightColor":m.borderRightColor,"--borderTopColor":m.borderTopColor,"--borderBottomColor":m.borderBottomColor,"--time":m.time,"--rotateStart":m.rotateStart,"--rotateEnd":m.rotateEnd}},`huxy-animate-border-circle-${u}`)))})};var Tt=g(696),L={};L.styleTagTransform=y(),L.setAttributes=f(),L.insert=l().bind(null,"head"),L.domAPI=o(),L.insertStyleElement=v();var fo=a()(Tt.Z,L);const dr=Tt.Z&&Tt.Z.locals?Tt.Z.locals:void 0,Br=({size:i="400px",width:c="20px",space:h="20px",colors:p=[],style:b,className:x,...m})=>(0,r.jsx)("div",{className:`${dr["huxy-skeleton-dashboard"]}${x?` ${x}`:""}`,style:{"--size":i,"--width":c,"--space":h,"--color1":p[0],"--color2":p[1],"--color3":p[2],"--color4":p[3],"--color5":p[4],"--color6":p[5],"--color7":p[6],...b},...m,children:(0,r.jsx)("div",{className:dr.point})});var At=g(263),J={};J.styleTagTransform=y(),J.setAttributes=f(),J.insert=l().bind(null,"head"),J.domAPI=o(),J.insertStyleElement=v();var yo=a()(At.Z,J);const cr=At.Z&&At.Z.locals?At.Z.locals:void 0,Fr=({row:i=8,leftColor:c="linear-gradient(to right, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.15))",rightColor:h="rgba(0, 0, 0, 0.2)",rightWidth:p="100px",itemHeight:b="20px",space:x="20px",className:m,...u})=>(0,r.jsx)("div",{className:`${cr["huxy-skeleton-list"]}${m?` ${m}`:""}`,style:{"--rightWidth":p,"--itemHeight":b,"--space":x,"--leftColor":c,"--rightColor":h},...u,children:[...new Array(i)].map((k,$)=>(0,r.jsx)("div",{className:cr["sk-list-item"]},`huxy-skeleton-list-${$}`))}),Hr=(i,c=100)=>{const h=[];return[...new Array(i)].map((p,b)=>{b===i-1?h[b]=c:(h[b]=T(1,c-1),c-=h[b])}),h};var St=g(955),G={};G.styleTagTransform=y(),G.setAttributes=f(),G.insert=l().bind(null,"head"),G.domAPI=o(),G.insertStyleElement=v();var wo=a()(St.Z,G);const Xr=St.Z&&St.Z.locals?St.Z.locals:void 0,Yt=i=>i?.length?qt(i):N(),K=Hr(4),Or=({height:i,colors:c=[],style:h,className:p,...b})=>(0,r.jsx)("div",{className:`${Xr["huxy-skeleton-piechart"]}${p?` ${p}`:""}`,style:{"--height":i,"--color1":Yt(c),"--color2":Yt(c),"--color3":Yt(c),"--color4":Yt(c),"--percent1":`${K[0]}%`,"--percent2":`${K[0]+K[1]}%`,"--percent3":`${K[0]+K[1]+K[2]}%`,"--percent4":"100%",...h},...b});var _t=g(709),V={};V.styleTagTransform=y(),V.setAttributes=f(),V.insert=l().bind(null,"head"),V.domAPI=o(),V.insertStyleElement=v();var Co=a()(_t.Z,V);const Ur=_t.Z&&_t.Z.locals?_t.Z.locals:void 0,Lr=({percent:i,height:c="20px",bgColor:h="rgba(0, 0, 0, 0.15)",progressColor:p,borderRadius:b="4px",waveColor:x="rgba(255, 255, 255, 0.2)",waveTime:m="3s",style:u,className:k,...$})=>(0,r.jsx)("div",{className:`${Ur["huxy-progress-wave"]}${k?` ${k}`:""}`,style:{"--percent":i??T(33,99),"--height":c,"--bgColor":h,"--progressColor":p??N(),"--borderRadius":b,"--waveColor":x,"--waveTime":m,...u},...$});var It=g(664),q={};q.styleTagTransform=y(),q.setAttributes=f(),q.insert=l().bind(null,"head"),q.domAPI=o(),q.insertStyleElement=v();var ko=a()(It.Z,q);const pr=It.Z&&It.Z.locals?It.Z.locals:void 0,Jr=({list:i=60,size:c="300px",itemWidth:h="30px",itemHeight:p="4px",bgColor:b="rgba(255, 255, 255 , 0.9)",shadowColor:x="rgba(255, 255, 255 , 0.6)",color:m,style:u,className:k,...$})=>(i=Array.isArray(i)?i:[...new Array(i)],(0,r.jsx)("div",{className:`${pr["huxy-animate-border-ring"]}${k?` ${k}`:""}`,style:{"--size":c,"--itemWidth":h,"--itemHeight":p,"--bgColor":b,"--shadowColor":x,...u},...$,children:i.map((Y,xt)=>(0,r.jsx)("div",{className:pr["border-ring-item"],style:{"--color":Y?.color??m??N(),transform:`rotate(${360/i.length*xt}deg)`}},`huxy-animate-border-ring-${xt}`))}));var Pt=g(917),Q={};Q.styleTagTransform=y(),Q.setAttributes=f(),Q.insert=l().bind(null,"head"),Q.domAPI=o(),Q.insertStyleElement=v();var zo=a()(Pt.Z,Q);const hr=Pt.Z&&Pt.Z.locals?Pt.Z.locals:void 0,Gr=({children:i,hasTitle:c,titleBgColor:h,style:p,className:b,...x})=>(0,r.jsx)("div",{className:`${hr["skeleton-container"]}${c?` ${hr.title}`:""}${b?` ${b}`:""}`,style:{"--titleBgColor":h??N(),...p},...x,children:i});var Wt=g(177),tt={};tt.styleTagTransform=y(),tt.setAttributes=f(),tt.insert=l().bind(null,"head"),tt.domAPI=o(),tt.insertStyleElement=v();var Zo=a()(Wt.Z,tt);const Kr=Wt.Z&&Wt.Z.locals?Wt.Z.locals:void 0,Vr=({row:i=6,col:c=8,...h})=>(0,r.jsx)("div",{className:Kr["huxy-skeleton-table"],...h,children:(0,r.jsxs)("table",{children:[(0,r.jsx)("thead",{children:(0,r.jsx)("tr",{children:[...new Array(c)].map((p,b)=>(0,r.jsx)("th",{children:(0,r.jsx)("span",{})},`skeleton-table-th-${b}`))})}),(0,r.jsx)("tbody",{children:[...new Array(i)].map((p,b)=>(0,r.jsx)("tr",{children:[...new Array(c)].map((x,m)=>(0,r.jsx)("td",{children:(0,r.jsx)("span",{})},`skeleton-table-tr-${b}-${m}`))},`tr-${b}`))})]})});var Et=g(202),rt={};rt.styleTagTransform=y(),rt.setAttributes=f(),rt.insert=l().bind(null,"head"),rt.domAPI=o(),rt.insertStyleElement=v();var $o=a()(Et.Z,rt);const qr=Et.Z&&Et.Z.locals?Et.Z.locals:void 0,Qr=({color:i="rgba(0, 0, 0, 0.06)",delay:c="2s",style:h,className:p,children:b,...x})=>(0,r.jsx)("div",{className:`${qr["huxy-loading-wave"]}${p?` ${p}`:""}`,style:{"--waveColor":i,"--waveTime":c,...h},...x,children:b});var Rt=g(833),et={};et.styleTagTransform=y(),et.setAttributes=f(),et.insert=l().bind(null,"head"),et.domAPI=o(),et.insertStyleElement=v();var jo=a()(Rt.Z,et);const te=Rt.Z&&Rt.Z.locals?Rt.Z.locals:void 0,re=i=>(0,r.jsx)("span",{className:te["huxy-timer"],...i});var Mt=g(845),ot={};ot.styleTagTransform=y(),ot.setAttributes=f(),ot.insert=l().bind(null,"head"),ot.domAPI=o(),ot.insertStyleElement=v();var No=a()(Mt.Z,ot);const ee=Mt.Z&&Mt.Z.locals?Mt.Z.locals:void 0,oe=i=>(0,r.jsx)("span",{className:ee["huxy-search"],...i});var Dt=g(871),at={};at.styleTagTransform=y(),at.setAttributes=f(),at.insert=l().bind(null,"head"),at.domAPI=o(),at.insertStyleElement=v();var To=a()(Dt.Z,at);const ae=Dt.Z&&Dt.Z.locals?Dt.Z.locals:void 0,ie=i=>(0,r.jsx)("span",{className:ae["huxy-location"],...i});var Bt=g(75),it={};it.styleTagTransform=y(),it.setAttributes=f(),it.insert=l().bind(null,"head"),it.domAPI=o(),it.insertStyleElement=v();var Ao=a()(Bt.Z,it);const br=Bt.Z&&Bt.Z.locals?Bt.Z.locals:void 0,le=({list:i=7,size:c="40px",shadowSize:h="50px",time:p="1.6s",style:b,className:x,...m})=>(p=t(p,"s"),(0,r.jsx)("div",{className:`${br["huxy-loading-ball"]}${x?` ${x}`:""}`,style:{"--size":c,"--shadowSize":h,"--time":`${p}s`,...b},...m,children:(Array.isArray(i)?i:[...new Array(i)]).map((u,k)=>(0,r.jsx)("div",{className:br.ball,style:{"--delay":u?.delay??`${p/((i?.length??i)+1)*(k+1)-p}s`,"--bgColor":u?.color??N()}},`huxy-loading-ball-${k}`))}));var Ft=g(943),lt={};lt.styleTagTransform=y(),lt.setAttributes=f(),lt.insert=l().bind(null,"head"),lt.domAPI=o(),lt.insertStyleElement=v();var So=a()(Ft.Z,lt);const se=Ft.Z&&Ft.Z.locals?Ft.Z.locals:void 0,ne=({type:i="spot",size:c,color:h,shadowColor:p,style:b,className:x,...m})=>(0,r.jsx)("span",{className:`${se[`huxy-${i}`]}${x?` ${x}`:""}`,style:{"--size":c??`${T(6,30)}px`,"--color":h??N(),"--shadowColor":p??N(),...b},...m});var Ht=g(389),st={};st.styleTagTransform=y(),st.setAttributes=f(),st.insert=l().bind(null,"head"),st.domAPI=o(),st.insertStyleElement=v();var Yo=a()(Ht.Z,st);const de=Ht.Z&&Ht.Z.locals?Ht.Z.locals:void 0,ce=({width:i,border:c,black:h,white:p,style:b,className:x,...m})=>(0,r.jsx)("div",{className:`${de["huxy-taiji"]} ${x}`,style:{"--width":i,"--border":c,"--black":h,"--white":p,...b},...m});var Xt=g(972),nt={};nt.styleTagTransform=y(),nt.setAttributes=f(),nt.insert=l().bind(null,"head"),nt.domAPI=o(),nt.insertStyleElement=v();var _o=a()(Xt.Z,nt);const pe=Xt.Z&&Xt.Z.locals?Xt.Z.locals:void 0,he=({width:i="200px",height:c="180px",space:h="12%",bgColor:p,style:b,className:x,...m})=>(0,r.jsx)("div",{className:`${pe.conic}${x?` ${x}`:""}`,style:{"--width":i,"--height":c,"--space":h,"--bgColor":p,...b},...m});var Ot=g(735),dt={};dt.styleTagTransform=y(),dt.setAttributes=f(),dt.insert=l().bind(null,"head"),dt.domAPI=o(),dt.insertStyleElement=v();var Io=a()(Ot.Z,dt);const Po=Ot.Z&&Ot.Z.locals?Ot.Z.locals:void 0,Qt=()=>Math.random()-.5,be=()=>~~(Qt()*T(5,10)*10),xe=()=>~~(Qt()*T(2,8)*10),ve=()=>(1-Qt())*T(1.1,1.4,!1),me=i=>i?.length?qt(i):N(),ge=({list:i=[],colors:c=[],width:h,padding:p,bgColor:b,style:x,...m})=>(0,r.jsx)("div",{className:"huxy-text-3d",style:{"--width":h,"--padding":p,"--bgColor":b,...x},...m,children:(0,r.jsx)("div",{className:"text-3d-container",children:i.map((u,k)=>{const $=u.time??T(6,24,!1).toFixed(2),Y=u.delay??-T(0,$,!1).toFixed(2);return(0,r.jsx)("div",{className:"text-3d-item",style:{"--time":`${$}s`,"--center":u.center??`${be()}%`,"--rotate":u.rotate??`${xe()}deg`,"--size":u.size??ve(),"--color":u.color??me(c),"--delay":`${Y}s`},children:(0,r.jsx)("div",{className:"text-3d-item-card",children:(0,r.jsx)("span",{className:"link animate-text",children:u.label})})},u.label)})})});var Ut=g(814),ct={};ct.styleTagTransform=y(),ct.setAttributes=f(),ct.insert=l().bind(null,"head"),ct.domAPI=o(),ct.insertStyleElement=v();var Wo=a()(Ut.Z,ct);const xr=Ut.Z&&Ut.Z.locals?Ut.Z.locals:void 0,ue=({time:i="3s",style:c,className:h,children:p,...b})=>(0,r.jsx)("div",{className:`${xr["huxy-text-filter"]}${h?` ${h}`:""}`,style:{"--time":i,...c},...b,children:(0,r.jsx)("div",{className:xr["text-filter"],children:p})});var Lt=g(325),pt={};pt.styleTagTransform=y(),pt.setAttributes=f(),pt.insert=l().bind(null,"head"),pt.domAPI=o(),pt.insertStyleElement=v();var Eo=a()(Lt.Z,pt);const fe=Lt.Z&&Lt.Z.locals?Lt.Z.locals:void 0,ye=({backColor:i="rgba(0, 0, 0, 0.3)",frontColor:c="rgba(255, 255, 255, 1)",time:h="4s",style:p,className:b,children:x,...m})=>(0,r.jsx)("div",{className:`${fe["huxy-text-loading"]}${b?` ${b}`:""}`,style:{"--backColor":i,"--frontColor":c,"--time":h,...p},...m,"data-text":x,children:x});var Jt=g(82),ht={};ht.styleTagTransform=y(),ht.setAttributes=f(),ht.insert=l().bind(null,"head"),ht.domAPI=o(),ht.insertStyleElement=v();var Ro=a()(Jt.Z,ht);const we=Jt.Z&&Jt.Z.locals?Jt.Z.locals:void 0,Ce=({startColor:i,endColor:c,style:h,className:p,children:b,...x})=>(0,r.jsx)("div",{className:`${we["huxy-text-masked"]}${p?` ${p}`:""}`,style:{"--startColor":i??N(),"--endColor":c??N(),...h},...x,children:b});var Gt=g(608),bt={};bt.styleTagTransform=y(),bt.setAttributes=f(),bt.insert=l().bind(null,"head"),bt.domAPI=o(),bt.insertStyleElement=v();var Mo=a()(Gt.Z,bt);const ke=Gt.Z&&Gt.Z.locals?Gt.Z.locals:void 0,ze=({score:i=0,backColor:c="rgba(0, 0, 0, 0.3)",frontColor:h="var(--yellow2)",style:p,className:b,children:x,backend:m,...u})=>(0,r.jsx)("div",{className:`${ke["huxy-rate-score"]}${b?` ${b}`:""}`,style:{"--backColor":c,"--frontColor":h,"--score":`${i}`.includes("%")?i:`${i*100}%`,...p},...u,"data-text":x,children:m??x})})();var je=w.$V,Ne=w.Bp,Te=w.Ak,Ae=w.Zb,ur=w.Cd,Se=w.W2,Ye=w.M9,_e=w.V5,Ie=w.A,Pe=w.QN,We=w.aI,fr=w.sA,Ee=w.TK,yr=w._k,Re=w.aV,Me=w.gb,De=w.Ye,Be=w.df,Fe=w.Ex,He=w.gd,wr=w.FM,Xe=w.ol,Oe=w.z6,Ue=w.iA,Le=w.P8,Je=w.Qp,Ge=w.QV,Ke=w.R8,Ve=w.By,qe=w.qp,Qe=w.ql,to=w.iL,ro=w.iC}}]);
