(self.webpackChunk=self.webpackChunk||[]).push([[506],{3323:function(Rr,$t){function re(L,nt){var c=L.length;L.push(nt);t:for(;0<c;){var $=c-1>>>1,x=L[$];if(0<ze(x,nt))L[$]=nt,L[c]=x,c=$;else break t}}function Bt(L){return L.length===0?null:L[0]}function u(L){if(L.length===0)return null;var nt=L[0],c=L.pop();if(c!==nt){L[0]=c;t:for(var $=0,x=L.length,E=x>>>1;$<E;){var F=2*($+1)-1,O=L[F],S=F+1,C=L[S];if(0>ze(O,c))S<x&&0>ze(C,O)?(L[$]=C,L[S]=c,$=S):(L[$]=O,L[F]=c,$=F);else if(S<x&&0>ze(C,c))L[$]=C,L[S]=c,$=S;else break t}}return nt}function ze(L,nt){var c=L.sortIndex-nt.sortIndex;return c!==0?c:L.id-nt.id}if(typeof performance=="object"&&typeof performance.now=="function"){var Te=performance;$t.unstable_now=function(){return Te.now()}}else{var mt=Date,I=mt.now();$t.unstable_now=function(){return mt.now()-I}}var ut=[],jt=[],Wr=1,Vt=null,Ht=3,N=!1,V=!1,B=!1,Z=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,tt=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function G(L){for(var nt=Bt(jt);nt!==null;){if(nt.callback===null)u(jt);else if(nt.startTime<=L)u(jt),nt.sortIndex=nt.expirationTime,re(ut,nt);else break;nt=Bt(jt)}}function rt(L){if(B=!1,G(L),!V)if(Bt(ut)!==null)V=!0,Yt(vt);else{var nt=Bt(jt);nt!==null&&ie(rt,nt.startTime-L)}}function vt(L,nt){V=!1,B&&(B=!1,M(Nt),Nt=-1),N=!0;var c=Ht;try{for(G(nt),Vt=Bt(ut);Vt!==null&&(!(Vt.expirationTime>nt)||L&&!Lt());){var $=Vt.callback;if(typeof $=="function"){Vt.callback=null,Ht=Vt.priorityLevel;var x=$(Vt.expirationTime<=nt);nt=$t.unstable_now(),typeof x=="function"?Vt.callback=x:Vt===Bt(ut)&&u(ut),G(nt)}else u(ut);Vt=Bt(ut)}if(Vt!==null)var E=!0;else{var F=Bt(jt);F!==null&&ie(rt,F.startTime-nt),E=!1}return E}finally{Vt=null,Ht=c,N=!1}}var wt=!1,Ft=null,Nt=-1,ct=5,_t=-1;function Lt(){return!($t.unstable_now()-_t<ct)}function Mt(){if(Ft!==null){var L=$t.unstable_now();_t=L;var nt=!0;try{nt=Ft(!0,L)}finally{nt?k():(wt=!1,Ft=null)}}else wt=!1}var k;if(typeof tt=="function")k=function(){tt(Mt)};else if(typeof MessageChannel<"u"){var Rt=new MessageChannel,Wt=Rt.port2;Rt.port1.onmessage=Mt,k=function(){Wt.postMessage(null)}}else k=function(){Z(Mt,0)};function Yt(L){Ft=L,wt||(wt=!0,k())}function ie(L,nt){Nt=Z(function(){L($t.unstable_now())},nt)}$t.unstable_IdlePriority=5,$t.unstable_ImmediatePriority=1,$t.unstable_LowPriority=4,$t.unstable_NormalPriority=3,$t.unstable_Profiling=null,$t.unstable_UserBlockingPriority=2,$t.unstable_cancelCallback=function(L){L.callback=null},$t.unstable_continueExecution=function(){V||N||(V=!0,Yt(vt))},$t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ct=0<L?Math.floor(1e3/L):5},$t.unstable_getCurrentPriorityLevel=function(){return Ht},$t.unstable_getFirstCallbackNode=function(){return Bt(ut)},$t.unstable_next=function(L){switch(Ht){case 1:case 2:case 3:var nt=3;break;default:nt=Ht}var c=Ht;Ht=nt;try{return L()}finally{Ht=c}},$t.unstable_pauseExecution=function(){},$t.unstable_requestPaint=function(){},$t.unstable_runWithPriority=function(L,nt){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var c=Ht;Ht=L;try{return nt()}finally{Ht=c}},$t.unstable_scheduleCallback=function(L,nt,c){var $=$t.unstable_now();switch(typeof c=="object"&&c!==null?(c=c.delay,c=typeof c=="number"&&0<c?$+c:$):c=$,L){case 1:var x=-1;break;case 2:x=250;break;case 5:x=1073741823;break;case 4:x=1e4;break;default:x=5e3}return x=c+x,L={id:Wr++,callback:nt,priorityLevel:L,startTime:c,expirationTime:x,sortIndex:-1},c>$?(L.sortIndex=c,re(jt,L),Bt(ut)===null&&L===Bt(jt)&&(B?(M(Nt),Nt=-1):B=!0,ie(rt,c-$))):(L.sortIndex=x,re(ut,L),V||N||(V=!0,Yt(vt))),L},$t.unstable_shouldYield=Lt,$t.unstable_wrapCallback=function(L){var nt=Ht;return function(){var c=Ht;Ht=nt;try{return L.apply(this,arguments)}finally{Ht=c}}}},1102:function(Rr,$t,re){Rr.exports=re(3323)},4335:function(Rr,$t,re){var Bt;re.d($t,{$j:function(){return Lt},AN:function(){return rt},BQ:function(){return wt},GK:function(){return Mt},Hn:function(){return M},JX:function(){return Ht},PC:function(){return jt},Ud:function(){return V},V7:function(){return G},X2:function(){return _t},dy:function(){return N},h_:function(){return ct},mH:function(){return B},pC:function(){return Yt},s_:function(){return Nt},u_:function(){return Ft},zd:function(){return vt}});var u=re(7378),ze=re(1542),Te={269:(c,$,x)=>{x.d($,{Z:()=>H});var E=x(601),F=x.n(E),O=x(609),S=x.n(O),C=S()(F());C.push([c.id,`/*@height:2px;
@width:18px;
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(xt))))," */")),O.styleTagTransform(C,F,O.options)}function x(F){if(F.parentNode===null)return!1;F.parentNode.removeChild(F)}function E(F){if(typeof document>"u")return{update:function(){},remove:function(){}};var O=F.insertStyleElement(F);return{update:function(S){$(O,F,S)},remove:function(){x(O)}}}c.exports=E},464:c=>{function $(x,E){if(E.styleSheet)E.styleSheet.cssText=x;else{for(;E.firstChild;)E.removeChild(E.firstChild);E.appendChild(document.createTextNode(x))}}c.exports=$},810:c=>{var $=E=>{var F={};return I.d(F,E),F},x=E=>()=>E;c.exports=Bt||(Bt=re.t(u,2))}},mt={};function I(c){var $=mt[c];if($!==void 0)return $.exports;var x=mt[c]={id:c,exports:{}};return Te[c](x,x.exports,I),x.exports}I.n=c=>{var $=c&&c.__esModule?()=>c.default:()=>c;return I.d($,{a:$}),$},I.d=(c,$)=>{for(var x in $)I.o($,x)&&!I.o(c,x)&&Object.defineProperty(c,x,{enumerable:!0,get:$[x]})},I.o=(c,$)=>Object.prototype.hasOwnProperty.call(c,$),I.nc=void 0;var ut={};(()=>{I.d(ut,{PC:()=>oe,rK:()=>hr,lr:()=>er,JX:()=>ve,dy:()=>_,Ud:()=>Ur,mH:()=>U,SV:()=>bt,Hn:()=>Re,rj:()=>me,V7:()=>xe,AN:()=>yr,zd:()=>Ae,BQ:()=>ge,u_:()=>Dr,s_:()=>To,h_:()=>Se,X2:()=>lr,$j:()=>fo,GK:()=>Bo,u:()=>g,mp:()=>Yo,C2:()=>zt,pC:()=>yt,ff:()=>Nr,d2:()=>Qr,Uw:()=>Io});var c=I(322),$=I(62),x=I.n($),E=I(36),F=I.n(E),O=I(793),S=I.n(O),C=I(892),H=I.n(C),xt=I(173),Et=I.n(xt),Ut=I(464),Q=I.n(Ut),Xt=I(269),St={};St.styleTagTransform=Q(),St.setAttributes=H(),St.insert=S().bind(null,"head"),St.domAPI=F(),St.insertStyleElement=Et();var qt=x()(Xt.Z,St);const ae=Xt.Z&&Xt.Z.locals?Xt.Z.locals:void 0,oe=i=>(0,c.jsx)("span",{className:ae.anico,children:(0,c.jsx)("span",{className:[ae.hline,...(i.type||"").split(" ").map(l=>ae[l]).filter(Boolean)].join(" ")})});var K=I(810);const de=i=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(i),Ge=i=>new Promise((l,f)=>{const w=new FileReader;w.readAsDataURL(i),w.addEventListener("load",()=>l(w.result)),w.addEventListener("error",j=>f(j))}),Ve=async i=>{if(!de(i))return i;const l=await(await fetch(decodeURIComponent(i))).blob();return await Ge(l)},kr=i=>{const[l,f]=(0,K.useState)(i);return(0,K.useEffect)(()=>{(async w=>{const j=await Ve(w);f(j)})(i)},[i]),l},hr=({src:i,...l})=>{const f=kr(i);return(0,c.jsx)("img",{...l,src:f})};var Je=i=>{var l={};return I.d(l,i),l},Cr=i=>()=>i;const Me=Je({createPortal:()=>ze.createPortal,flushSync:()=>ze.flushSync}),fr=(i,l)=>{const f=(0,K.useRef)();(0,K.useEffect)(()=>{f.current=i},[i]),(0,K.useEffect)(()=>{if(l){const w=setInterval(()=>f.current(),l);return()=>clearInterval(w)}},[l])},ce=()=>![typeof window,typeof document].includes("undefined"),Er=i=>Object.prototype.toString.call(i).slice(8,-1).toLowerCase(),$e=i=>Er(i).indexOf("element")>-1,He=(i=null)=>ce()?$e(i)?{width:i.clientWidth,height:i.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},he=(i=()=>{},l=60)=>{let f=null;return function(...w){clearTimeout(f),f=setTimeout(()=>i.apply(this,w),l)}},jr=(i,l)=>Object.prototype.hasOwnProperty.call(i??{},l),ne=i=>jr(i,"current"),zr=(i,l)=>{const f=[],w=i.children??[];for(let j=0,P=w.length;j<P;j++){const R=w[j];R.className.indexOf(l)>-1&&f.push(R)}return f.length===0?null:f.length===1?f[0]:f},Qe=(i,l)=>{getComputedStyle(i).position==="static"&&(i.style.position="relative");const f=document.createElement("object");return f.setAttribute("style","display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0"),f.setAttribute("class","resize-sensor"),f.onload=()=>{f.contentDocument.defaultView.addEventListener("resize",l,!1),l()},f.type="text/html",i.appendChild(f),f.data="about:blank",f},Yr=(i,l=60)=>{if(!ce())return;i=ne(i)?i.current:i??document.body;let f=zr(i,"resize-sensor"),w=[];const j=he(()=>w.map(ot=>ot(i)),l),P=ot=>{zr(i,"resize-sensor")||(f=Qe(i,j)),w.indexOf(ot)===-1&&w.push(ot)},R=ot=>{const at=w.indexOf(ot);at!==-1&&w.splice(at,1),w.length===0&&f&&et()},et=()=>{f&&f.parentNode&&(f.contentDocument&&f.contentDocument.defaultView.removeEventListener("resize",j,!1),f.parentNode.removeChild(f),f=void 0,w=[])};return{element:i,bind:P,unbind:R,destroy:et}},pr=(i={})=>{const l=(0,K.useRef)(0),[f,w]=(0,K.useState)(i),j=(0,K.useCallback)(P=>{cancelAnimationFrame(l.current),l.current=requestAnimationFrame(()=>w(P))},[]);return(0,K.useEffect)(()=>()=>cancelAnimationFrame(l.current),[]),[f,j]},Zr=(i=null,l=60)=>{const f=ne(i)?i.current:i,{bind:w,destroy:j}=Yr(f,l),[P,R]=pr(He(f));return(0,K.useEffect)(()=>(w(()=>f&&R(He(f))),()=>j()),[f]),P};var Ne=I(528),Ie={};Ie.styleTagTransform=Q(),Ie.setAttributes=H(),Ie.insert=S().bind(null,"head"),Ie.domAPI=F(),Ie.insertStyleElement=Et();var tr=x()(Ne.Z,Ie);const _e=Ne.Z&&Ne.Z.locals?Ne.Z.locals:void 0,er=({children:i,active:l=0,delay:f=5e3,className:w,...j})=>{const[P,R]=(0,K.useState)(l+1),[et,ot]=(0,K.useState)(!1),at=(0,K.useRef)(),kt=(0,K.useRef)(""),{width:st}=Zr(at);i=Array.isArray(i)?i:[i];const gt=i[0],Gt=[i[i.length-1],...i,gt],Qt=Gt.length;fr(()=>{let Zt=P+1;Zt=Zt===Qt?1:Zt,kt.current&&(kt.current=""),R(Zt),Zt===Qt-1&&setTimeout(()=>{kt.current="none",R(1)},500)},et?null:f);const Tt=(Zt,Jt)=>{Jt.stopPropagation(),kt.current="",R(Zt),(0,Me.flushSync)(()=>ot(!0)),ot(!1)},At={width:`${Qt*st}px`,transform:`translateX(${-st*P}px)`,transition:kt.current};return(0,c.jsxs)("div",{className:`${_e["huxy-carousel"]}${w?` ${w}`:""}`,...j,ref:at,children:[(0,c.jsx)("div",{className:_e["huxy-carousel-wrap"],style:At,children:Gt.map((Zt,Jt)=>(0,c.jsx)("div",{className:`${_e["carousel-item"]} ${P===Jt?_e.active:""}`,style:{width:`${st}px`},children:Zt},`huxy-carousel-${Jt}`))}),(0,c.jsx)("div",{className:_e["carousel-switch"],children:i.map((Zt,Jt)=>(0,c.jsx)("span",{className:`${_e.dot} ${P===Jt+1?_e.active:""}`,onClick:qe=>Tt(Jt+1,qe)},`huxy-carousel-switch-${Jt}`))})]})},Pe=(i,l)=>{let f="",w="";if(typeof l=="number"&&(f=`col-${i}-${l}`),typeof l=="object"){const{span:j,offset:P}=l;f=j?`col-${i}-${j}`:"",w=P?`offset-${i}-${P}`:""}return{sp:f,os:w}},ve=(0,K.forwardRef)(({span:i,offset:l,xl:f,lg:w,md:j,sm:P,xs:R,style:et,width:ot,auto:at,offsetWidth:kt="0px",className:st,...gt},Gt)=>{const Qt=st?` ${st}`:"",Tt=`col-${i||12}`,At=l?`offset-${l}`:"",{sp:Zt,os:Jt}=Pe("xs",R),{sp:qe,os:cr}=Pe("sm",P),{sp:Ar,os:Ee}=Pe("md",j),{sp:Br,os:Ke}=Pe("lg",w),{sp:Ze,os:je}=Pe("xl",f),ur=[Tt,Ze,Br,Ar,qe,Zt,At,je,Ke,Ee,cr,Jt].filter(Boolean).join(" "),wr=at?{width:"auto",flex:1,maxWidth:`calc(100% - ${kt})`}:{width:ot};return(0,c.jsx)("div",{className:`${ur}${Qt}`,...gt,style:{...wr,...et},ref:Gt})}),Vr=()=>{const i=(0,K.useRef)(!0);return i.current?(i.current=!1,!0):!1},rr=(i,l=[])=>{const f=Vr();(0,K.useEffect)(()=>{if(!f)return i()},l)},Mr=(i,l=450)=>{const[f,w]=(0,K.useState)(i);return rr(()=>{let j;return i||l===0?w(i):j=setTimeout(()=>w(i),l),()=>j&&clearTimeout(j)},[i]),[f,w]},Se=({children:i,mountNode:l=document.body})=>(0,Me.createPortal)(i,l),or={position:"fixed",top:0,left:0,bottom:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",zIndex:99999},nr={position:"fixed",top:0,left:0,bottom:0,right:0,background:"rgba(0, 0, 0, 0.5)",zIndex:1e5},Hr=document.body,Ae=({open:i,close:l,delay:f=300,children:w,mountNode:j,hasMask:P=!0,style:R,className:et="h-mask",relative:ot})=>{const[at]=Mr(i,f);(j??Hr).style.overflow=at?"hidden":"";const kt=ot?"absolute":"fixed";return(0,c.jsx)(Se,{mountNode:j,children:(0,c.jsx)("div",{children:at?(0,c.jsxs)("div",{className:et,style:{...or,position:kt},children:[P?(0,c.jsx)("div",{style:{...nr,position:kt},onClick:st=>l?.(st)}):null,K.Children.map(w,st=>(0,K.isValidElement)(st)?(0,K.cloneElement)(st,{style:{position:"relative",zIndex:100001,...st.props.style}}):st)]}):null})})};var Fe=I(434),s={};s.styleTagTransform=Q(),s.setAttributes=H(),s.insert=S().bind(null,"head"),s.domAPI=F(),s.insertStyleElement=Et();var v=x()(Fe.Z,s);const y=Fe.Z&&Fe.Z.locals?Fe.Z.locals:void 0,_=({open:i,close:l,footer:f,header:w,className:j,style:P,children:R,width:et="300px",mountNode:ot,position:at="right",relative:kt})=>{const st=["drawer-wrap",at,i?"open":"",...j?.split(" ")??[]].filter(Boolean).map(gt=>y[gt]).join(" ");return(0,c.jsx)(Ae,{open:i,close:l,delay:250,hasMask:!0,relative:kt,mountNode:ot,className:"huxy-drawer",children:(0,c.jsx)("div",{className:st,style:{width:et,position:kt?"absolute":"fixed",...P},children:(0,c.jsxs)("div",{className:y["drawer-container"],children:[(0,c.jsxs)("div",{className:y["drawer-header"],children:[(0,c.jsx)("span",{className:`link ${y["ico-close"]}`,onClick:gt=>l?.(gt)}),(0,c.jsx)("div",{children:w})]}),(0,c.jsx)("div",{className:y["drawer-content"],children:R}),f?(0,c.jsx)("div",{className:y["drawer-footer"],children:f}):null]})})})},D=(i,l,f="click")=>{(0,K.useEffect)(()=>{const w=P=>{const R=ne(i)?i.current:i;R?.contains&&!R.contains(P.target)&&l(P)},j=typeof f=="string"?[f]:f;return j.map(P=>{document.addEventListener(P,w,!1)}),()=>{j.map(P=>{document.removeEventListener(P,w,!1)})}},[i,l,f])},q=i=>i?.$$typeof&&typeof i.$$typeof=="symbol"&&i.$$typeof.description==="react.element",dt=(i="")=>i.replace(/^\S/,l=>l.toUpperCase()),ht=i=>{if(ce())return i=ne(i)?i.current:i??document.body,i.getBoundingClientRect?.()},lt=i=>{if(!ce())return;const l=document.createElement("div");return l.innerHTML=i,l.children[0]},It=(i,l={},f=!1)=>{if($e(i)){if(f){let w="";Object.keys(l).map(j=>{w+=`${j}: ${l[j]};`}),i.style=w;return}Object.keys(l).map(w=>i.style.setProperty(w,l[w]))}},we=(i=350)=>new Promise(l=>setTimeout(l,i)),Be=(i=100)=>{const l=Date.now();for(;Date.now()-l<=i;);},Oe=we,fe=async(i,l=15)=>{if(!ce())return;if(typeof i=="string"&&(i=lt(i)),i=ne(i)?i.current:i,!$e(i))return{};const f=i.cloneNode(!0);It(f,{"pointer-events":"none","z-index":-1,opacity:0,display:"block",animation:"none"}),i.parentNode.appendChild(f),await Oe(l);const w=ht(f);return i.parentNode.removeChild(f),w},ir=/(\s|^)(huxy-drop-arrow-lt|huxy-drop-arrow-rt|huxy-drop-arrow-lb|huxy-drop-arrow-rb|huxy-drop-arrow-tl|huxy-drop-arrow-tr|huxy-drop-arrow-bl|huxy-drop-arrow-br)(\s|$)/,mr=/huxy-drop-arrow-lt|huxy-drop-arrow-rt|huxy-drop-arrow-lb|huxy-drop-arrow-rb|huxy-drop-arrow-tl|huxy-drop-arrow-tr|huxy-drop-arrow-bl|huxy-drop-arrow-br/,De=(i,l)=>{l=`huxy-drop-arrow-${l}`;const f=i.getAttribute("class")??"";ir.test(f)?i.setAttribute("class",f.replace(mr,l)):i.setAttribute("class",`${f} ${l}`)},Ue=async(i,l,f)=>{const{left:w,right:j,top:P,bottom:R}=ht(i),{width:et,height:ot}=He(),{width:at,height:kt}=await fe(l);if(j<0||R<0||w>et||P>ot)return{};if(f==="vertical"){const st={left:w+"px",top:R+10+"px",right:"auto",bottom:"auto"};let gt="lt";w+at>et&&(st.left=j-at+"px",gt="rt"),R+10+kt>ot&&(st.top=P-10-kt+"px",gt=gt==="lt"?"lb":"rb"),It(l,st),De(l,gt)}else{const st={left:j+10+"px",top:P+"px",right:"auto",bottom:"auto"};let gt="tl";j+10+at>et&&(st.left=w-10-at+"px",gt="tr"),P+kt>ot&&(st.top=R-kt+"px",gt=gt==="tl"?"bl":"br"),It(l,st),De(l,gt)}},Le=(i,l,f="horizontal")=>{const w=he(Ue),j=()=>w(i,l,f);window.addEventListener("scroll",j,!1),window.addEventListener("resize",j,!1);const P=()=>{window.removeEventListener("scroll",j),window.removeEventListener("resize",j),It(l,{left:"",top:"",right:"",bottom:""})};return Ue(i,l,f),P},ar=({open:i,delay:l=280,children:f,mountNode:w,style:j,...P})=>{const[R]=Mr(i,l);return(0,c.jsx)(Se,{mountNode:w,children:(0,c.jsx)("div",{children:(0,c.jsx)("div",{style:{...j,display:R?"block":"none"},...P,children:f})})})};var $r=I(503),ke={};ke.styleTagTransform=Q(),ke.setAttributes=H(),ke.insert=S().bind(null,"head"),ke.domAPI=F(),ke.insertStyleElement=Et();var ao=x()($r.Z,ke);const _r=$r.Z&&$r.Z.locals?$r.Z.locals:void 0,Ur=({trigger:i="click",type:l,dropList:f,className:w,children:j,targetProps:P,...R})=>{const[et,ot]=(0,K.useState)(!1),at=(0,K.useRef)(),kt=(0,K.useRef)(),st=(0,K.useRef)();D(at,At=>et&&ot(!1),[...new Set(["click",i.toLowerCase()])]),(0,K.useEffect)(()=>()=>st.current?.(),[]);const gt=At=>{At.preventDefault(),ot(!0),st.current=Le(at.current,kt.current,l)},Gt={[`on${dt(i)}`]:gt},Qt=["drop-wrap",et?"open":"",w].filter(Boolean).map(At=>_r[At]).join(" "),Tt=q(f)?f:f?.(()=>ot(!1),et);return(0,c.jsxs)("span",{ref:at,className:_r["drop-target"],...P,...Gt,children:[j,(0,c.jsx)(ar,{open:et,className:"huxy-drop",children:(0,c.jsx)("div",{ref:kt,className:Qt,...R,children:Tt})})]})},Xr=(i,l,f)=>{if(!ce())return;f=ne(f)?f.current:f??document.body;const w=document.createElement("span");w.setAttribute("style","pointer-events: none; z-index: -1; opacity: 0;"),l&&It(w,l),w.innerText=(i??"").replace(/[\r\n]/g,""),f.appendChild(w);const j=w.getBoundingClientRect();return f.removeChild(w),j};var Sr=I(918),a={};a.styleTagTransform=Q(),a.setAttributes=H(),a.insert=S().bind(null,"head"),a.domAPI=F(),a.insertStyleElement=Et();var h=x()(Sr.Z,a);const b=Sr.Z&&Sr.Z.locals?Sr.Z.locals:void 0,g=({title:i,placement:l="topRight",children:f,ellipsis:w,className:j,...P})=>(0,c.jsx)("span",{className:`${b[`huxy-tooltip-${l}`]}${j?` ${j}`:""}`,tooltip:i??f,...P,children:(0,c.jsx)("span",{className:w?b.ellipsis:"",children:f})}),p={overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",display:"inline-block",width:"100%"},W=i=>{const{children:l,style:f}=i,w=typeof l=="string",j=w?l:l?.props?.title??l?.props?.children,P=(0,K.useRef)(),[R,et]=(0,K.useState)(!0);return(0,K.useEffect)(()=>{if(P.current){const{width:ot}=Xr(j,null,P.current.parentNode),{width:at}=ht(P.current),kt=~~ot>~~at;kt!==R&&et(kt)}},[j]),(0,c.jsx)("span",{ref:P,style:{display:"flex",width:"100%",...f},children:R?w?(0,c.jsx)(g,{...i,ellipsis:!0}):(0,c.jsx)("span",{style:p,children:l}):w?l:l?.props?.children})},U=i=>i.children==null?"":(0,c.jsx)(W,{...i});var X=Object.defineProperty,Y=(i,l,f)=>l in i?X(i,l,{enumerable:!0,configurable:!0,writable:!0,value:f}):i[l]=f,A=(i,l,f)=>(Y(i,typeof l!="symbol"?l+"":l,f),f);class bt extends K.default.Component{constructor(){super(...arguments),A(this,"state",{error:null})}static getDerivedStateFromError(l){return{error:l}}componentDidCatch(l,f){const{errorReport:w}=this.props;typeof w=="function"&&w({error:l,info:f.componentStack})}render(){const{error:l}=this.state,{fallback:f,children:w}=this.props;return l?f(l):w}}const zt=i=>l=>{if(typeof l=="function"||typeof l?.render=="function")return(0,c.jsx)(l,{});if(typeof l=="string"){const f=i?.[l];return f?(0,c.jsx)(f,{}):(0,c.jsx)("i",{className:l})}return l??null},Pt=i=>zt(i),yt=i=>({icon:l,defaultIcon:f})=>l?Pt(i)(l):l===!1?null:f,Ct=["","webkit","moz","ms"],Ot=i=>Ct.map(l=>l?`${l}FullscreenElement`:"fullscreenElement").find(l=>i[l]),ft=i=>Ct.map(l=>l?`${l}RequestFullscreen`:"requestFullscreen").find(l=>i[l]),it=i=>Ct.map(l=>l?`${l}ExitFullscreen`:"exitFullscreen").find(l=>i[l]),Dt=Ct.map(i=>`${i}fullscreenchange`),Kt=i=>{if(!ce())return;i=ne(i)?i.current:i??document.body;const l=Ot(document),f=ft(i),w=it(document);document[l]?document[w]?.():i[f]?.()},le=i=>ce()?(Dt.map(l=>document.addEventListener(l,i,!1)),()=>Dt.map(l=>document.removeEventListener(l,i,!1))):void 0,se=i=>(0,c.jsx)("i",{...i,children:"..."}),Re=({panel:i,fullIcon:l=se,exitIcon:f=se,...w})=>{const j=ne(i)?i.current:i,[P,R]=(0,K.useState)();(0,K.useEffect)(()=>{const ot=le(()=>{R(at=>!at)});return()=>ot()},[]);const et=P?f:l;return(0,c.jsx)(et,{onClick:ot=>Kt(j),...w})};var ue=I(249),pe={};pe.styleTagTransform=Q(),pe.setAttributes=H(),pe.insert=S().bind(null,"head"),pe.domAPI=F(),pe.insertStyleElement=Et();var xr=x()(ue.Z,pe);const Fr=ue.Z&&ue.Z.locals?ue.Z.locals:void 0,We=({gutter:i=10,className:l,overflow:f="hidden",...w},j)=>{const P=l?` ${l}`:"";let R=10;if(Array.isArray(i)){const et=[...i];i=et[0],R=et[1]??et[0]}return(0,c.jsx)("div",{className:"row-wrap",style:{"--gutter":`${Math.floor(i/2)}px`,"--rowgap":`${Math.floor(R/2)}px`,overflow:f},children:(0,c.jsx)("div",{className:`row${P}`,...w,ref:j})})},lr=(0,K.forwardRef)(We),me=({rowProps:i,colProps:l,children:f,Row:w=lr,Col:j=ve})=>{const P=[];return K.Children.map(f,R=>{R&&(R.type?.description==="react.fragment"?P.push(...R.props.children):P.push(R))}),(0,c.jsx)(w,{...i,children:P.map((R,et)=>(0,c.jsx)(j,{...l,...R.props.itemprops,children:R},`huuxy_grid_${et}`))})},Qr=(i,l)=>(0,c.jsx)("div",{dangerouslySetInnerHTML:{__html:i},...l}),yr=i=>{const{error:l={},info:f=""}=i||{},{message:w,stack:j,errMsg:P}=l;let R=P||j||l.toString();R=`${R}
${f}`.replace(/\r|\n|\r\n/g,"<br/>"),R=R.replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;"),R=R.replace(/\s/g,"&nbsp;");const et=w?.slice(0,120).split(". ").slice(0,2).join(". ");return(0,c.jsxs)("div",{style:{padding:"15px 20px",backgroundColor:"#fff",wordWrap:"break-word"},children:[Qr(R,{style:{color:"red"}}),et&&(0,c.jsxs)("a",{style:{display:"inline-block",padding:"15px",color:"#00b4cf"},href:`https://stackoverflow.com/search?q=${et}`,target:"_blank",children:[" ","--> \u53BB\u7F51\u4E0A\u67E5\u627E\u9519\u8BEF\u539F\u56E0\uFF1F"]})]})},xe=({children:i,report:l})=>{const f=(0,K.useRef)();return f.current?.state&&(f.current.state.error=null),(0,c.jsx)(bt,{ref:f,fallback:(w,j)=>yr({error:w,info:j}),errorReport:l,children:i})},ye=(i,l)=>Object.keys(l).map(f=>i.style[f]=l[f]),Xe=(i,l)=>Object.keys(l).map(f=>i.style[f]=""),Ye={overflow:"auto",position:"fixed",zIndex:5555,transition:"all .2s"},to=({left:i,top:l,width:f,height:w})=>({left:`${i}px`,top:`${l}px`,width:`${f}px`,height:`${w}px`}),sr=i=>(0,c.jsx)("i",{...i,children:"..."}),Or=i=>{const{left:l,top:f}=ht(i),{width:w,height:j}=He(i);return{left:l,top:f,width:w,height:j}},ge=({panel:i,target:l,fullIcon:f=sr,exitIcon:w=sr})=>{i=ne(i)?i.current:i||document.body;const[j,P]=(0,K.useState)(),R=(0,K.useRef)();(0,K.useEffect)(()=>{R.current={...Ye,...to(Or(i))}},[i]);const et=(at,kt)=>{if(at){const st=to(Or((typeof l=="function"?l:()=>document.getElementsByClassName(l)[0])()));ye(kt,R.current),setTimeout(()=>{ye(kt,st)},0)}else Xe(kt,R.current);P(at)},ot=j?w:f;return(0,c.jsx)(ot,{onClick:at=>et(!j,i)})};var gr=I(548),Ce={};Ce.styleTagTransform=Q(),Ce.setAttributes=H(),Ce.insert=S().bind(null,"head"),Ce.domAPI=F(),Ce.insertStyleElement=Et();var qr=x()(gr.Z,Ce);const be=gr.Z&&gr.Z.locals?gr.Z.locals:void 0,Dr=({open:i,close:l,hasMask:f=!0,cancelText:w="\u53D6\u6D88",submit:j,submitText:P="\u786E\u5B9A",title:R="Modal \u5F39\u7A97",className:et,children:ot,delay:at=250,...kt})=>{const st=["modal-wrap",i?"open":"",...et?.split(" ")??[]].filter(Boolean).map(gt=>be[gt]).join(" ");return(0,c.jsx)(Ae,{open:i,close:l,delay:at,hasMask:f,className:"huxy-modal",children:(0,c.jsx)("div",{className:st,...kt,children:(0,c.jsxs)("div",{className:be["modal-container"],children:[(0,c.jsx)("div",{className:be["modal-header"],children:R}),(0,c.jsx)("div",{className:be["modal-content"],children:ot}),(0,c.jsxs)("div",{className:be["modal-footer"],children:[(0,c.jsx)("div",{className:`${be.btn} ${be.left}`,onClick:gt=>l?.(gt),children:w}),(0,c.jsx)("div",{className:`${be.btn} ${be.right}`,onClick:gt=>j?.(gt),children:P})]})]})})})};var Kr=I(990),br={};br.styleTagTransform=Q(),br.setAttributes=H(),br.insert=S().bind(null,"head"),br.domAPI=F(),br.insertStyleElement=Et();var uo=x()(Kr.Z,br);const ho=Kr.Z&&Kr.Z.locals?Kr.Z.locals:void 0,fo=({global:i,absolute:l})=>(0,c.jsx)("div",{className:`spinner${i?" global":""}${l?" absolute":""}`,children:(0,c.jsx)("figure",{className:"spinning"})});var Gr=I(232),Tr={};Tr.styleTagTransform=Q(),Tr.setAttributes=H(),Tr.insert=S().bind(null,"head"),Tr.domAPI=F(),Tr.insertStyleElement=Et();var Do=x()(Gr.Z,Tr);const Jr=Gr.Z&&Gr.Z.locals?Gr.Z.locals:void 0,po=i=>i?.filter?.(l=>typeof l=="function"),mo=(i,l)=>{const f=(0,K.useRef)(),{loading:w,title:j,plugins:P,children:R,className:et,...ot}=i,at=po(P),kt=at?.length,st=et?` ${et}`:"",gt=ne(l)?l:f;return(0,c.jsxs)("div",{className:`${Jr.panel}${st}`,...ot,ref:gt,children:[(j||kt)&&(0,c.jsxs)("div",{className:Jr["panel-header"],children:[j&&(0,c.jsx)("h4",{className:Jr["panel-title"],children:j}),kt&&(0,c.jsx)("div",{className:Jr["panel-plugins"],children:at.map((Gt,Qt)=>(0,c.jsx)("span",{className:"link",children:(0,c.jsx)(Gt,{panel:gt})},Qt))})]}),(0,c.jsx)("div",{className:Jr["panel-body"],children:R}),w&&(0,c.jsx)(fo,{})]})},To=(0,K.forwardRef)(mo),eo=i=>Er(i)==="array",xo=i=>eo(i)&&!!i.length,yo=({to:i,preventDefault:l,stopPropagation:f,...w})=>l?(0,c.jsx)("span",{...w}):(0,c.jsx)("a",{href:i,...w}),No=({item:i,...l})=>(0,c.jsx)("ul",{...l}),go=(i,...l)=>{const f={};return Object.keys(i).filter(Boolean).map(w=>{f[w]=j=>i[w](j,...l)}),f},bo=({data:i=[],events:l={},List:f=No,Link:w=yo,leftIcon:j,rightIcon:P,isHorizontal:R,isCollapsed:et,level:ot=0,parentOpen:at=!0})=>{const kt=et&&!ot,st=!R&&!et&&!at;return i.map(gt=>{const{name:Gt,path:Qt,icon:Tt,rightIcon:At,active:Zt,open:Jt,children:qe,linkProps:cr}=gt,Ar=xo(qe),Ee=gt.id||Qt||Gt,Br=kt?gt.title??Gt:void 0,Ke=st?"hidden":"",Ze=Tt??j,je=At??P,ur=Ze?(0,c.jsx)("div",{className:"node-left-icon",children:Ze===!0?(0,c.jsx)("i",{className:"default-left-icon"}):Ze}):null,wr=Gt?(0,c.jsx)("div",{className:"node-text",children:(0,c.jsx)("span",{children:Gt})}):null;if(Ar){const no=go(l,gt,ot),lo=[Ke,Jt?"open":""].filter(Boolean).join(" ");return(0,c.jsxs)("li",{className:lo,"has-children":"true",...no,children:[(0,c.jsxs)(w,{title:Br,className:`link${Zt?" active":""}`,to:Qt,preventDefault:!0,stopPropagation:!1,...cr,children:[ur,wr,je?(0,c.jsx)("div",{className:"node-right-icon",children:je===!0?(0,c.jsx)("i",{className:"default-right-icon"}):je}):null]}),(0,c.jsx)(f,{item:gt,children:bo({data:qe,events:l,List:f,Link:w,leftIcon:j,rightIcon:P,isHorizontal:R,isCollapsed:et,level:ot+1,parentOpen:!!Jt})})]},Ee)}return(0,c.jsx)("li",{className:Ke,children:(0,c.jsxs)(w,{title:Br,className:`link${Zt?" active":""}`,to:Qt,...cr,children:[ur,wr]})},Ee)})},Nr=bo,Io=(i,...l)=>(0,c.jsx)("div",{"v-html":i,...l});var Ir=I(575),Pr={};Pr.styleTagTransform=Q(),Pr.setAttributes=H(),Pr.insert=S().bind(null,"head"),Pr.domAPI=F(),Pr.insertStyleElement=Et();var vo=x()(Ir.Z,Pr);const Po=Ir.Z&&Ir.Z.locals?Ir.Z.locals:void 0,Ao=i=>(0,c.jsx)("div",{style:{padding:"6px 15px"},children:i}),wo=({activekey:i,tabs:l=[],switchTab:f,trackColor:w,flex:j,...P},R)=>{const[et,ot]=(0,K.useState)(i??l[0]?.key),[at,kt]=(0,K.useState)({}),st=(0,K.useRef)({}),gt=(0,K.useRef)();(0,K.useEffect)(()=>{const Tt=st.current[et];Tt&&Gt(Tt)},[]);const Gt=Tt=>{const{left:At,width:Zt}=ht(Tt),Jt=ht(gt.current).left;kt({left:At-Jt,width:Zt})},Qt=(Tt,At)=>{Tt.stopPropagation(),ot(At),typeof f=="function"&&f(At),Gt(Tt.currentTarget)};return(0,c.jsxs)("div",{className:"tabs-header-wrap",...P,ref:R,children:[(0,c.jsx)("ul",{className:`tabs-header${j?" flex":""}`,ref:gt,children:l.map(Tt=>(0,c.jsx)("li",{ref:At=>st.current[Tt.key]=At,className:`th-item${et===Tt.key?" active":""}`,onClick:At=>Qt(At,Tt.key),children:typeof Tt.renderTabs=="function"?Tt.renderTabs(Tt,et===Tt.key):Ao(Tt.value)},Tt.key))}),(0,c.jsx)("div",{className:"th-track",style:{...at,color:w}})]})},Bo=(0,K.forwardRef)(wo),ro=(i,l,f="id",w="children")=>{if(!eo(i))return null;const j=P=>{for(let R=0,et=P.length;R<et;R++){const ot=P[R];if(ot[f]===l)return[ot];if(eo(ot[w])){const at=j(ot[w]);if(at)return[ot].concat(at)}}};return j(i)},Lo=i=>++i,ko=()=>{const[,i]=(0,K.useState)(0);return(0,K.useCallback)(()=>i(Lo),[])},Co=i=>{const{children:l,open:f}=i;let w=0;if(f&&l?.length){w=l.length;let j=0;return l.map(P=>j+=Co(P)),w+j}return w},Eo=({item:i,style:l,...f})=>(0,c.jsx)("ul",{style:{...l,"--count":Co(i)},...f});var oo=I(942),vr={};vr.styleTagTransform=Q(),vr.setAttributes=H(),vr.insert=S().bind(null,"head"),vr.domAPI=F(),vr.insertStyleElement=Et();var nn=x()(oo.Z,vr);const Ro=oo.Z&&oo.Z.locals?oo.Z.locals:void 0,Wo=i=>(0,c.jsx)("ul",{...i}),jo=(i,l)=>i?Eo:({item:f,...w})=>(0,c.jsx)(Wo,{className:l==="right"?"left":"",...w}),Yo=i=>{const{data:l=[],collapsed:f=!1,type:w="vertical",Link:j,width:P,bgColor:R,itemHeight:et,collapsedWidth:ot,itemPadding:at,style:kt,className:st,...gt}=i,Gt=(0,K.useRef)(),Qt=(0,K.useRef)();(0,K.useEffect)(()=>()=>clearTimeout(Gt.current),[]);const Tt=ko(),At=w==="horizontal",Zt=!At&&f,Jt={onClick:(Ke,Ze)=>{if(Ke.stopPropagation(),!At&&!Zt){const je=ro(l,Ze.path,"path"),ur=je[je.length-1];ur.open=!ur.open,Tt()}},onMouseEnter:(Ke,Ze,je)=>{Zt&&!je&&(clearTimeout(Gt.current),Qt.current.style.width="var(--maxWidth)")},onMouseLeave:(Ke,Ze,je)=>{Zt&&!je&&(Gt.current=setTimeout(()=>Qt.current.style.width="",200))}},qe=(At?["huxy-horizontal-tree",st]:["huxy-tree",st,Zt?"collapsed":""]).filter(Boolean).join(" "),{float:cr,...Ar}=gt?.style??{},Ee={"--bgColor":R,"--itemHeight":et,"--nodeListWidth":P,...Ar};At?(Ee["--itemPadding"]=at,Ee["--nodeFloat"]=cr):(Ee["--width"]=P,Ee["--collapsedWidth"]=ot);const Br=jo(!At&&!Zt,cr);return(0,c.jsx)("div",{ref:Qt,className:qe,style:Ee,...gt,children:(0,c.jsx)("div",{className:"huxy-tree-track",children:(0,c.jsx)("ul",{className:"huxy-tree-root",children:Nr({data:l,events:Jt,List:Br,Link:j,leftIcon:!0,rightIcon:!0,isHorizontal:At,isCollapsed:Zt})})})})}})();var jt=ut.PC,Wr=ut.rK,Vt=ut.lr,Ht=ut.JX,N=ut.dy,V=ut.Ud,B=ut.mH,Z=ut.SV,M=ut.Hn,tt=ut.rj,G=ut.V7,rt=ut.AN,vt=ut.zd,wt=ut.BQ,Ft=ut.u_,Nt=ut.s_,ct=ut.h_,_t=ut.X2,Lt=ut.$j,Mt=ut.GK,k=ut.u,Rt=ut.mp,Wt=ut.C2,Yt=ut.pC,ie=ut.ff,L=ut.d2,nt=ut.Uw},8611:function(Rr,$t,re){var Bt;re.d($t,{Bv:function(){return Wr},rU:function(){return ut},tv:function(){return Ht},yj:function(){return Vt}});var u=re(7378),ze={990:(N,V,B)=>{B.d(V,{Z:()=>vt});var Z=B(601),M=B.n(Z),tt=B(609),G=B.n(tt),rt=G()(M());rt.push([N.id,`@keyframes before {
  0% {
    width: 0.6rem;
    box-shadow: 1.2rem -0.6rem #ff3e38, -1.2rem 0.6rem #318ffa;
  }
...
`,""]),rt.locals={};const vt=rt},267:(N,V,B)=>{B.d(V,{Z:()=>vt});var Z=B(601),M=B.n(Z),tt=B(609),G=B.n(tt),rt=G()(M());rt.push([N.id,`.Iuy_e {
  text-decoration: none;
  cursor: pointer;
  color: var(--linkColor);
...
`,""]),rt.locals={link:"Iuy_e",active:"D3oJg"};const vt=rt},609:N=>{N.exports=function(V){var B=[];return B.toString=function(){return this.map(function(Z){var M="",tt=typeof Z[5]<"u";return Z[4]&&(M+="@supports (".concat(Z[4],") {")),Z[2]&&(M+="@media ".concat(Z[2]," {")),tt&&(M+="@layer".concat(Z[5].length>0?" ".concat(Z[5]):""," {")),M+=V(Z),tt&&(M+="}"),Z[2]&&(M+="}"),Z[4]&&(M+="}"),M}).join("")},B.i=function(Z,M,tt,G,rt){typeof Z=="string"&&(Z=[[null,Z,void 0]]);var vt={};if(tt)for(var wt=0;wt<this.length;wt++){var Ft=this[wt][0];Ft!=null&&(vt[Ft]=!0)}for(var Nt=0;Nt<Z.length;Nt++){var ct=[].concat(Z[Nt]);tt&&vt[ct[0]]||(typeof rt<"u"&&(typeof ct[5]>"u"||(ct[1]="@layer".concat(ct[5].length>0?" ".concat(ct[5]):""," {").concat(ct[1],"}")),ct[5]=rt),M&&(ct[2]&&(ct[1]="@media ".concat(ct[2]," {").concat(ct[1],"}")),ct[2]=M),G&&(ct[4]?(ct[1]="@supports (".concat(ct[4],") {").concat(ct[1],"}"),ct[4]=G):ct[4]="".concat(G)),B.push(ct))}},B}},601:N=>{N.exports=function(V){return V[1]}},837:(N,V,B)=>{var Z,M=B(810),tt=Symbol.for("react.element"),G=Symbol.for("react.fragment"),rt=Object.prototype.hasOwnProperty,vt=M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,wt={key:!0,ref:!0,__self:!0,__source:!0};function Ft(Nt,ct,_t){var Lt,Mt={},k=null,Rt=null;_t!==void 0&&(k=""+_t),ct.key!==void 0&&(k=""+ct.key),ct.ref!==void 0&&(Rt=ct.ref);for(Lt in ct)rt.call(ct,Lt)&&!wt.hasOwnProperty(Lt)&&(Mt[Lt]=ct[Lt]);if(Nt&&Nt.defaultProps)for(Lt in ct=Nt.defaultProps,ct)Mt[Lt]===void 0&&(Mt[Lt]=ct[Lt]);return{$$typeof:tt,type:Nt,key:k,ref:Rt,props:Mt,_owner:vt.current}}Z=G,V.jsx=Ft,V.jsxs=Ft},322:(N,V,B)=>{N.exports=B(837)},62:N=>{var V=[];function B(tt){for(var G=-1,rt=0;rt<V.length;rt++)if(V[rt].identifier===tt){G=rt;break}return G}function Z(tt,G){for(var rt={},vt=[],wt=0;wt<tt.length;wt++){var Ft=tt[wt],Nt=G.base?Ft[0]+G.base:Ft[0],ct=rt[Nt]||0,_t="".concat(Nt," ").concat(ct);rt[Nt]=ct+1;var Lt=B(_t),Mt={css:Ft[1],media:Ft[2],sourceMap:Ft[3],supports:Ft[4],layer:Ft[5]};if(Lt!==-1)V[Lt].references++,V[Lt].updater(Mt);else{var k=M(Mt,G);G.byIndex=wt,V.splice(wt,0,{identifier:_t,updater:k,references:1})}vt.push(_t)}return vt}function M(tt,G){var rt=G.domAPI(G);rt.update(tt);var vt=function(wt){if(wt){if(wt.css===tt.css&&wt.media===tt.media&&wt.sourceMap===tt.sourceMap&&wt.supports===tt.supports&&wt.layer===tt.layer)return;rt.update(tt=wt)}else rt.remove()};return vt}N.exports=function(tt,G){G=G||{},tt=tt||[];var rt=Z(tt,G);return function(vt){vt=vt||[];for(var wt=0;wt<rt.length;wt++){var Ft=rt[wt],Nt=B(Ft);V[Nt].references--}for(var ct=Z(vt,G),_t=0;_t<rt.length;_t++){var Lt=rt[_t],Mt=B(Lt);V[Mt].references===0&&(V[Mt].updater(),V.splice(Mt,1))}rt=ct}}},793:N=>{var V={};function B(M){if(typeof V[M]>"u"){var tt=document.querySelector(M);if(window.HTMLIFrameElement&&tt instanceof window.HTMLIFrameElement)try{tt=tt.contentDocument.head}catch{tt=null}V[M]=tt}return V[M]}function Z(M,tt){var G=B(M);if(!G)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");G.appendChild(tt)}N.exports=Z},173:N=>{function V(B){var Z=document.createElement("style");return B.setAttributes(Z,B.attributes),B.insert(Z,B.options),Z}N.exports=V},892:(N,V,B)=>{function Z(M){var tt=B.nc;tt&&M.setAttribute("nonce",tt)}N.exports=Z},36:N=>{function V(M,tt,G){var rt="";G.supports&&(rt+="@supports (".concat(G.supports,") {")),G.media&&(rt+="@media ".concat(G.media," {"));var vt=typeof G.layer<"u";vt&&(rt+="@layer".concat(G.layer.length>0?" ".concat(G.layer):""," {")),rt+=G.css,vt&&(rt+="}"),G.media&&(rt+="}"),G.supports&&(rt+="}");var wt=G.sourceMap;wt&&typeof btoa<"u"&&(rt+=`
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(wt))))," */")),tt.styleTagTransform(rt,M,tt.options)}function B(M){if(M.parentNode===null)return!1;M.parentNode.removeChild(M)}function Z(M){if(typeof document>"u")return{update:function(){},remove:function(){}};var tt=M.insertStyleElement(M);return{update:function(G){V(tt,M,G)},remove:function(){B(tt)}}}N.exports=Z},464:N=>{function V(B,Z){if(Z.styleSheet)Z.styleSheet.cssText=B;else{for(;Z.firstChild;)Z.removeChild(Z.firstChild);Z.appendChild(document.createTextNode(B))}}N.exports=V},810:N=>{var V=Z=>{var M={};return mt.d(M,Z),M},B=Z=>()=>Z;N.exports=Bt||(Bt=re.t(u,2))}},Te={};function mt(N){var V=Te[N];if(V!==void 0)return V.exports;var B=Te[N]={id:N,exports:{}};return ze[N](B,B.exports,mt),B.exports}mt.n=N=>{var V=N&&N.__esModule?()=>N.default:()=>N;return mt.d(V,{a:V}),V},mt.d=(N,V)=>{for(var B in V)mt.o(V,B)&&!mt.o(N,B)&&Object.defineProperty(N,B,{enumerable:!0,get:V[B]})},mt.o=(N,V)=>Object.prototype.hasOwnProperty.call(N,V),mt.nc=void 0;var I={};(()=>{mt.d(I,{rU:()=>_r,cb:()=>Sr,Bv:()=>Xr,yj:()=>Ur,tv:()=>De});var N=mt(810);const V=a=>Object.prototype.toString.call(a).slice(8,-1).toLowerCase(),B=a=>V(a)==="array",Z=a=>V(a)==="object",M=a=>a?.$$typeof&&typeof a.$$typeof=="symbol"&&a.$$typeof.description==="react.element",tt=a=>a?.__v_isVNode,G=(a,h)=>Object.prototype.hasOwnProperty.call(a??{},h),rt=a=>{if(!B(a)&&!Z(a))return a;const h=B(a)?[]:{};for(const b in a)if(G(a,b)){const g=a[b];h[b]=M(g)||tt(g)||typeof g!="object"?g:g!==a?rt(g):"cyclic"}else Object.setPrototypeOf(h,{[b]:a[b]});return h},vt=rt,wt=a=>V(a)==="function",Ft=a=>V(a)==="promise"||Z(a)&&wt(a.then),Nt=(a,h=12e4,b="\u8BF7\u6C42\u8D85\u65F6\uFF01")=>{if(!Ft(a))return{};let g=null,p=null;return{promiseFn:new Promise((W,U)=>{g=(X="canceled")=>{clearTimeout(p),W({canceled:!0,errMsg:X})},h&&(h=typeof h!="number"?12e4:h,p=setTimeout(()=>g(b),h)),a.then(X=>{clearTimeout(p),W({result:X,errMsg:!1})}).catch(X=>{clearTimeout(p),U(X)})}),cancelFn:g}},ct=a=>a?a.charAt(a.length-1)==="/"?a.slice(0,-1):a:"";var _t=mt(322);const Lt=(a,h)=>(0,_t.jsx)("div",{dangerouslySetInnerHTML:{__html:a},...h}),Mt=a=>{const{error:h={},info:b=""}=a||{},{message:g,stack:p,errMsg:W}=h;let U=W||p||h.toString();U=`${U}
${b}`.replace(/\r|\n|\r\n/g,"<br/>"),U=U.replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;"),U=U.replace(/\s/g,"&nbsp;");const X=g?.slice(0,120).split(". ").slice(0,2).join(". ");return(0,_t.jsxs)("div",{style:{padding:"15px 20px",backgroundColor:"#fff",wordWrap:"break-word"},children:[Lt(U,{style:{color:"red"}}),X&&(0,_t.jsxs)("a",{style:{display:"inline-block",padding:"15px",color:"#00b4cf"},href:`https://stackoverflow.com/search?q=${X}`,target:"_blank",children:[" ","--> \u53BB\u7F51\u4E0A\u67E5\u627E\u9519\u8BEF\u539F\u56E0\uFF1F"]})]})},k=()=>{const a={};return{on:(h,b)=>{a[h]||(a[h]=[]),a[h].indexOf(b)===-1&&a[h].push(b)},emit:(h,b)=>{a[h]&&a[h].map(g=>g(b))},off:(h,b=null)=>{if(a[h]){if(typeof b!="function")return delete a[h];const g=a[h].indexOf(b);g>-1&&(a[h].splice(g,1),a[h].length||delete a[h])}}}},Rt=a=>{const h={};for(let b in a)G(a,b)||(h[b]=a[b]);return h},Wt=(a,h)=>{if(!Z(a))return h;if(!Z(h))return a;const b={...Rt(a),...Rt(h)},g={...a,...h};return Object.keys(b).map(p=>{Object.setPrototypeOf(g,{[p]:b[p]})}),g},Yt=()=>{const{on:a,emit:h,off:b}=k(),g={};return{getState:p=>vt(g[p]),setState:(p,W=!1)=>{if(typeof p=="function"&&(p=p(vt(g))),!Z(p))throw TypeError("\u5FC5\u987B\u4F20\u5165object\u5BF9\u8C61\uFF01");const U=vt(p);Object.keys(U).map(X=>{const Y=g[X],A=U[X],bt=Z(A)&&Z(Y)?Wt(Y,A):A;!W&&h(X,bt),g[X]=bt})},subscribe:(p,W)=>(a(p,W),()=>b(p,W)),unsubscribe:b,clean:p=>{typeof p=="string"?g[p]=void 0:Array.isArray(p)?p.map(W=>g[W]=void 0):Object.keys(g).map(W=>g[W]=void 0)}}},ie=a=>(h,b)=>{const[g,p]=(0,N.useState)(()=>{const Y=a?.getState(h);return Y!==void 0?Y:(b!==void 0&&a?.setState({[h]:b},!0),b)}),W=(0,N.useCallback)(Y=>a?.setState({[h]:typeof Y=="function"?Y(a?.getState(h)):Y}),[]),U=(0,N.useCallback)(Y=>a?.subscribe(h,Y),[]),X=(0,N.useCallback)((Y=Y)=>a?.clean(Y),[]);return(0,N.useEffect)(()=>{a?.subscribe(h,Y=>p(Y))},[]),[g,W,U,X]},L=Yt(),nt=ie(L),c=k(),$=k(),x="push-emitter",E="replace-emitter",F="useRoute-emitter",O={delay:8e3,timeoutMsg:"\u8BF7\u6C42\u8D85\u65F6\uFF01",cancelMsg:"\u8BF7\u6C42\u5DF2\u53D6\u6D88\uFF01"},S="/404",C={getState:()=>history.state,go:a=>history.go(a),forward:()=>history.forward(),back:()=>history.back()},H=(a,h,b,g,p=[])=>{const W=Y=>{for(let A=0,bt=Y.length;A<bt;A++){const zt=Y[A],Pt=zt[g].split("?")[0];if(new RegExp("^"+Pt.replace(/:[^/]+/g,"[^/]+")+"$").test(h))return zt;if(B(zt[b])){const yt=W(zt[b]);if(yt)return yt}}},U=W(a);if(!U)return S;const{redirect:X}=U;return X?p.includes(X)?p:(p.push(X),H(a,X.split("?")[0],b,g,p)):p[p.length-1]},xt=(a,h,b,g,p)=>{if(!B(a))return null;const W=bt=>{const zt=bt.split("/"),Pt=h.split("/"),yt={};return zt.map((Ct,Ot)=>Ct.indexOf(":")===0&&(yt[Ct.slice(1)]=Pt[Ot])),yt},U=(bt,zt)=>{const Pt=[],yt=zt.split("/:")[0];for(let Ct=0,Ot=bt.length;Ct<Ot;Ct++){const ft=bt[Ct];if(ft[p]===yt){ft.active=!0;const{name:it,title:Dt,icon:Kt,params:le}=ft;Pt.push({name:it,title:Dt,icon:Kt,params:le,[p]:yt})}else if(zt.indexOf(`${ft[p]}/`)===0){ft.active=!0;const it=W(ft[p]),Dt=Object.keys(it).map(ue=>it[ue]).join("/"),{name:Kt,title:le,icon:se}=ft,Re=Dt?`${yt}/${Dt}`:ft[p];Pt.push({name:Kt,title:le,icon:se,[p]:Re,params:{...ft.params,...it}})}else if(ft[p]===zt){ft.active=!0;const it=W(ft[p]),{[g]:Dt,...Kt}=ft;Pt.push({...Kt,[p]:h,params:{...Kt.params,...b,...it}})}}return Pt},X=(bt,zt)=>{for(let Pt=0,yt=bt.length;Pt<yt;Pt++){const Ct=bt[Pt];if(zt.indexOf(`${Ct[p]}/`)===0){Ct.active=!0;return}}},Y=bt=>{for(let zt=0,Pt=bt.length;zt<Pt;zt++){const yt=bt[zt],Ct=(yt[p]||"").split("?")[0];if(Ct===h){yt.hideMenu&&X(bt,yt.parentPath||Ct),yt.active=!0;const{[g]:Ot,...ft}=yt;return[{...ft,params:{...ft.params,...b}}]}if(new RegExp("^"+Ct.replace(/:[^/]+/g,"[^/]+")+"$").test(h))return U(bt,Ct);if(B(yt[g])){const Ot=Y(yt[g]);if(Ot){yt.active=!0,yt.open=!0;const{[g]:ft,...it}=yt;return[it,...Ot]}}}},A=Y(a)||[];return{result:a,current:A}},Et=(a,h,b)=>a.filter(g=>g.hideMenu||g[b].indexOf("/:")>-1?!1:(B(g[h])&&(g[h]=Et(g[h],h,b)),!0)),Ut=(a,h,b,g="children",p="path")=>{const W=H(a,h,g,p);if(W)return{redirect:W};const{result:U,current:X}=xt(a,h,b,g,p),Y=Et(U,g,p);return{current:X,menu:Y}},Q=a=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(a),Xt=(a,h)=>{const b=["#/","/"],g=b[!!h-0];if(!a||b.includes(a))return g;const p=a.charAt(a.length-1)==="/"?a.slice(0,-1):a;return h||p.indexOf("#/")>-1?p:`#${p}`},St=(a,h,b,g=!1)=>{const p=Xt(h,b);return g?p:b?a&&p==="/"?a:`${a}${p}`:a?`${a}/${p}`:p},qt=(a,h,b,g,p,W)=>{if(!B(a))return a;const U=(X,Y="")=>X.filter(A=>!A.denied).map(A=>{if(!W&&!A.exact&&!Q(A[g])){(!A[g]||A[g]==="javascript:;")&&(A[g]="");const bt=A[g].charAt(0)==="/"&&Y.charAt(Y.length-1)==="/"?A[g].slice(1):A[g].charAt(0)!=="/"&&Y.charAt(Y.length-1)!=="/"?`/${A[g]}`:A[g];A[g]=Y?Y+bt:St(p,bt,h)}return A.redirect&&(A.redirect=St(p,A.redirect,h)),B(A[b])&&(A[b]=U(A[b],A[g]),!A.redirect&&A[b].length&&(A.redirect=A[b][0][g])),A});return U(a)},ae=a=>{if(!Z(a))return"";const h=[];return Object.keys(a).map((b,g)=>{const p=g>0?"&":"?";h.push(`${p}${b}=${a[b]}`)}),h.join("")},oe=(a="")=>{const[h,b]=a.split("?");if(b){const g={};return b.split("&").map(p=>{const[W,U]=p.split("=");g[W]=U}),{path:h,params:g}}return{path:h}},K=()=>{document.documentElement.scrollTop?document.documentElement.scrollTop=0:document.body.scrollTop&&(document.body.scrollTop=0)},de=(a,h)=>{for(let b=a.length-1,g;g=a[b--];){const{title:p,name:W}=g;if(typeof p=="string"&&p.length)return document.title=p;if((p==null||p===!0)&&W)return document.title=h?`${W}-${h}`:W;if(h)return document.title=h}},Ge=a=>{const{pathname:h,search:b,hash:g}=location;if(a){const X=Xt(h,a),Y=decodeURIComponent(`${X}${b}`),{params:A}=oe(Y);return{path:Y,params:A}}const p=decodeURIComponent(Xt(g,a)),{params:W}=oe(p),U=ct(h);return{path:U?`${U}/${p}`:p,params:W}},Ve=(a,h,b)=>{typeof a=="function"&&a({...h,stay:new Date-b})},kr=(a,h,b,g)=>{let p=typeof a=="string"?a:a.path??"";const W=ae(a.query);Q(p)||(p=St(b,p,g,a.exact)),window?.open(`${p}${W}`,h)},hr=(a,h,b,g)=>{if(a.target){kr(a,a.target,h,b);return}let p,W,U;if(typeof a=="string")p=a;else if(Z(a))p=a.path,W=a.params,U=a.query;else return;!p||p==="."||p==="./"?p=g:p.indexOf("./")===0?p=`${g.split("?")[0]}${p.replace("./","/")}`:p.indexOf("../")===0&&(p=`${g.split("?")[0].split("/").slice(0,-1).join("/")}${p.replace("../","/")}`),p=St(h,p,b,a?.exact);const X=oe(p);p=X.path;const Y={...X.params,...U},A=ae(Y);return p=`${p}${A}`,W={...W,...Y},p===g?!1:{path:p,params:W}},Je=(a,h)=>{const b=a.split(h);return b.length>1?["","/"].includes(b[1].slice(0,1)):!1},Cr=k(),Me=a=>{const{on:h,emit:b,off:g}=Cr;return{on:p=>h(a,p),emit:p=>b(a,p),off:p=>g(a,p)}},fr=a=>(h,b)=>{const{getState:g,setState:p,subscribe:W,unsubscribe:U,clean:X}=a;return b!==void 0&&p({[h]:b},!0),{getState:()=>g(h),setState:(Y,A)=>p({[h]:Y},A),subscribe:Y=>W(h,Y),unsubscribe:()=>U(h),clean:()=>X(h)}},ce=Yt(),Er=fr(ce),$e=Me("push-emitter"),He=Me("replace-emitter"),he=Er("route-store"),jr=k(),ne=Yt(),zr=ie(ne),Qe=()=>![typeof window,typeof document].includes("undefined"),Yr=a=>{if(!Qe())return;const h=document.createElement("div");return h.innerHTML=a,h.children[0]};var pr=Object.defineProperty,Zr=(a,h,b)=>h in a?pr(a,h,{enumerable:!0,configurable:!0,writable:!0,value:b}):a[h]=b,Ne=(a,h,b)=>(Zr(a,typeof h!="symbol"?h+"":h,b),b);class Ie extends N.default.Component{constructor(){super(...arguments),Ne(this,"state",{error:null})}static getDerivedStateFromError(h){return{error:h}}componentDidCatch(h,b){const{errorReport:g}=this.props;typeof g=="function"&&g({error:h,info:b.componentStack})}render(){const{error:h}=this.state,{fallback:b,children:g}=this.props;return h?b(h):g}}const tr=({children:a,report:h})=>{const b=(0,N.useRef)();return b.current?.state&&(b.current.state.error=null),(0,_t.jsx)(Ie,{ref:b,fallback:(g,p)=>Mt({error:g,info:p}),errorReport:h,children:a})};var _e=mt(62),er=mt.n(_e),Pe=mt(36),ve=mt.n(Pe),Vr=mt(793),rr=mt.n(Vr),Mr=mt(892),Se=mt.n(Mr),or=mt(173),nr=mt.n(or),Hr=mt(464),Ae=mt.n(Hr),Fe=mt(990),s={};s.styleTagTransform=Ae(),s.setAttributes=Se(),s.insert=rr().bind(null,"head"),s.domAPI=ve(),s.insertStyleElement=nr();var v=er()(Fe.Z,s);const y=Fe.Z&&Fe.Z.locals?Fe.Z.locals:void 0,_=({global:a,absolute:h})=>(0,_t.jsx)("div",{className:`spinner${a?" global":""}${h?" absolute":""}`,children:(0,_t.jsx)("figure",{className:"spinning"})}),D=()=>{const a=(0,N.useRef)([]);return(0,N.useEffect)(()=>()=>{a.current.map(h=>h.cancelFn()),a.current=[]},[]),{cancelablePromise:(0,N.useCallback)((h,b=!0)=>{const g=Nt(h,b);return a.current.indexOf(g)===-1&&a.current.push(g),g.promiseFn},[])}},q=(a={})=>{const{cancelablePromise:h}=D(),[b,g]=(0,N.useState)(a),p=(0,N.useRef)({}),W=(0,N.useRef)({}),U=(0,N.useCallback)((Y=null)=>{Array.isArray(Y)&&Y.length?Y.map(A=>p.current[A]=a[A]):p.current=a},[]),X=(0,N.useCallback)((Y,A,bt=!1)=>{const zt=Object.keys(Y),Pt=JSON.stringify(zt.sort());if(!W.current[Pt]){W.current[Pt]=!0,bt&&U(Array.isArray(bt)?bt:zt),zt.map(yt=>{p.current[yt]||(p.current[yt]={}),p.current[yt].pending=!0}),g({...p.current});for(let yt=0,Ct=zt.length;yt<Ct;yt++){const Ot=zt[yt];h(Y[Ot]).then(ft=>{let{result:it,errMsg:Dt}=ft;yt===Ct-1&&(W.current[Pt]=!1),typeof A=="function"&&(it=A(it)||it),p.current[Ot]={...it,pending:!1},Dt===!1&&g({...p.current})}).catch(ft=>{throw yt===Ct-1&&(W.current[Pt]=!1),p.current[Ot]={error:ft,pending:!1},g({...p.current}),ft})}}},[]);return[b,X,U]},dt=a=>Object.keys(a).length,ht=a=>{const{Comp:h,restResolve:b,loadPromise:g,params:p,children:W}=a,[U,X]=q(),[Y,A]=q();return(0,N.useEffect)(()=>{dt(b)&&X(b),dt(g)&&A(g)},[b,g]),(0,N.useEffect)(()=>{const bt=dt(U);bt&&bt===dt(b)&&p.store.setState(U)},[U]),(0,_t.jsx)(h,{...p,...U,...Y,children:W})},lt=a=>a===!1?null:M(a)?a:wt(a)?(0,_t.jsx)(a,{}):(0,_t.jsx)(_,{}),It=({Loading:a,ErrorBoundary:h,loadedComp:b})=>{const g=(0,_t.jsx)(N.Suspense,{fallback:lt(a),children:b});return h===!1?g:wt(h)?(0,_t.jsx)(h,{children:g}):(0,_t.jsx)(tr,{children:g})},we=({Comp:a,routerProps:h,children:b})=>{const{params:g,...p}=h,{loading:W,errorBoundary:U,...X}=g,Y=(0,_t.jsx)(ht,{Comp:a,...p,params:X,children:b});return It({Loading:W,ErrorBoundary:U,loadedComp:Y})},Be={},Oe=(a,h,b,g)=>Ft(b)?b.then(p=>we({Comp:a,routerProps:h,children:p.default??p})):we({Comp:a,routerProps:h,children:b}),fe=(a,h,b)=>{const g={},p={};return Z(a)?(Object.keys(a).map(W=>{const U=h.getState(W);U==null?p[W]=a[W](b):g[W]=U}),{cachedResolve:g,restResolve:p}):{cachedResolve:g,restResolve:p}},ir=(a,h)=>{if(!Z(a))return{};const b={};return Object.keys(a).map(g=>b[g]=a[g](h)),b},mr=a=>{const{current:h,menu:b,...g}=a,p=h.map(X=>{const{component:Y,resolve:A,loadData:bt,loading:zt,errorBoundary:Pt,icon:yt,...Ct}=X;return Ct}),W=[...h].filter(X=>X.component),U=(X=0)=>{if(!W.length)return null;const Y=W.shift(),{component:A,resolve:bt,loadData:zt,icon:Pt,key:yt,...Ct}=Y;if(typeof A=="function"||Ft(A)){const Ot=Ct.path;let ft=Be[Ot];const{cachedResolve:it,restResolve:Dt}=fe(bt,g.store,Ct),Kt={loadPromise:ir(zt,Ct),restResolve:Dt,params:{current:p,...g,...Ct,...it}},le=U(X+1);if(ft)return Oe(ft,Kt,le,Ot);try{ft=A(),ft=M(ft)?A:ft}catch{ft=A}return Ft(ft)?ft.then(se=>(ft=se.default??se,Be[Ot]=ft,Oe(ft,Kt,le,Ot))):(Be[Ot]=ft,Oe(ft,Kt,le,Ot))}return typeof A=="string"?Yr(A):A};return U()},De=a=>{const[h,b]=(0,N.useState)(a),[g,p]=(0,N.useState)(),[W,U]=(0,N.useState)(),X=(0,N.useRef)(),Y=(0,N.useRef)(),A=(0,N.useRef)(),bt=(0,N.useRef)(),zt=()=>{typeof X.current=="function"&&(X.current({cancel:O.cancelMsg}),X.current=null)},Pt=(0,N.useCallback)(it=>{typeof it=="function"?b(Dt=>({...Dt,...it(Dt)})):Z(it)&&b(Dt=>({...Dt,...it}))},[]),yt=(it,Dt="pushState")=>{const{basepath:Kt,browserRouter:le}=bt.current,se=A.current,Re=hr(it,Kt,le,se);if(!Re)return;const{path:ue,params:pe}=Re;ft({inputPath:ue,inputParams:pe},()=>history[Dt](it?.state,"",ue))},Ct=(0,N.useCallback)(it=>yt(it),[]),Ot=(0,N.useCallback)(it=>yt(it,"replaceState"),[]),ft=(0,N.useCallback)(({inputPath:it="",inputParams:Dt={}},Kt)=>{const le=+new Date,{browserRouter:se,childKey:Re,idKey:ue,title:pe,routers:xr,beforeRender:Fr,afterRender:We,basepath:lr,allowedNotFound:me,...Qr}=bt.current;if(!it){const{path:xe,params:ye}=Ge(se);it=xe,Dt={...Dt,...ye}}const yr=A.current;new Promise((xe,ye)=>{xr?.length||ye("\u8DEF\u7531\u4E3A\u7A7A\uFF01"),it!==A.current&&typeof Fr=="function"?Fr({path:it,params:Dt,prevPath:yr},xe,ye):xe()}).then(xe=>{if(xe===!1)return;const ye=xe?.path;if(ye&&St(lr,ye,se)!==it){Ot(xe);return}Y.current=Y.current??it;const{redirect:Xe,current:Ye,menu:to}=Ut(vt(xr),it.split("?")[0],Dt,Re,ue);if(Xe){if(me&&Xe===S&&(typeof me=="boolean"||typeof me=="string"&&Je(Y.current,me)||B(me)&&me.find(ge=>Je(Y.current,ge))))return;if(B(Xe)){console.error(`\u522B\u95F9\uFF0C[${[it,...Xe].join(" -> ")}] \u91CD\u5B9A\u5411\u6B7B\u5FAA\u73AF\uFF01\uFF01\uFF01`);return}return Xe===S?Ot({path:Xe}):Ct({path:Xe,exact:!0})}Kt?.(),it?.split("?")[0]!==A.current?.split("?")[0]&&K(),de(Ye,pe);const sr={eventBus:jr,store:ne,useStore:zr,...Qr,updateRouter:Pt,emitRouter:he.subscribe,router:{push:Ct,replace:Ot},current:Ye,menu:to,inputPath:Y.current,prevPath:yr,browserRouter:se,basepath:lr,title:pe,history:{...C,goBack:ge=>Ct({...ge,path:yr})}};he.setState(sr);const Or=mr(sr);if(A.current=it,Y.current=null,zt(),Ft(Or)){const{promiseFn:ge,cancelFn:gr}=Nt(Or,{delay:O.delay,msg:{timeout:O.timeoutMsg}});return X.current=gr,U(!0),ge.then(Ce=>{X.current=null;const{result:qr,errMsg:be}=Ce,Dr=be===!1?qr:be?.timeout?Mt({error:{errMsg:`${it} ${be.timeout}`}}):null;Dr&&(U(!1),Ve(We,Ye.slice(-1)[0],le),p(Dr))}).catch(Ce=>{throw X.current=null,U(!1),Ve(We,Ye.slice(-1)[0],le),p(Mt({error:Ce})),Ce})}Ve(We,Ye.slice(-1)[0],le),p(Or)}).catch(xe=>{throw p(Mt({error:xe})),xe})},[]);return(0,N.useEffect)(()=>{const{childKey:it="children",idKey:Dt="path",browserRouter:Kt=!1,routers:le=[],basepath:se="",exact:Re=!1,inputPath:ue="",inputParams:pe={},...xr}=h,Fr=ct(se),We=qt(vt(le),Kt,it,Dt,Fr,Re);bt.current={...xr,childKey:it,idKey:Dt,browserRouter:Kt,routers:We,basepath:Fr};const lr=Kt?"popstate":"hashchange",me=()=>ft({});return ft({inputPath:ue,inputParams:pe}),$e.on(Ct),He.on(Ot),window.addEventListener(lr,me,!1),()=>{zt(),$e.off(Ct),He.off(Ot),window.removeEventListener(lr,me,!1)}},[h]),{updateRouter:Pt,output:g,loading:W}},Ue=a=>{const{to:h,onClick:b,preventDefault:g,stopPropagation:p=!0,exact:W=!0,target:U,...X}=a,Y=()=>{const A=typeof h=="string"?{exact:W,path:h}:{exact:W,...h};$e.emit(A)};return A=>{if(A.preventDefault(),p&&A.stopPropagation(),!X?.disabled){if(!g){if(U){const{browserRouter:bt,basepath:zt}=he.getState();kr(h,U,zt,bt);return}Y()}typeof b=="function"&&b()}}};var Le=mt(267),ar={};ar.styleTagTransform=Ae(),ar.setAttributes=Se(),ar.insert=rr().bind(null,"head"),ar.domAPI=ve(),ar.insertStyleElement=nr();var $r=er()(Le.Z,ar);const ke=Le.Z&&Le.Z.locals?Le.Z.locals:void 0,ao=a=>{if(!a)return ke.link;const h=a.trim().split(" ").filter(Boolean),b=h.find(g=>g==="active")?[ke.active]:[];return[ke.link,...b,...h].join(" ")},_r=a=>{const{to:h,onClick:b,preventDefault:g,stopPropagation:p,exact:W,target:U,className:X,...Y}=a;return(0,_t.jsx)("span",{onClick:Ue(a),className:ao(X),...Y})},Ur=()=>{const[a,h]=(0,N.useState)(he.getState());return(0,N.useEffect)(()=>he.subscribe(b=>h(b)),[]),a},Xr=he.getState,Sr=he.subscribe})();var ut=I.rU,jt=I.cb,Wr=I.Bv,Vt=I.yj,Ht=I.tv},8124:function(Rr,$t,re){var Bt;re.d($t,{Nr:function(){return N},PQ:function(){return _t},Vd:function(){return Ht},Wy:function(){return B},fH:function(){return ut},rf:function(){return Lt},xd:function(){return Mt}});var u=re(7378),ze={837:(k,Rt,Wt)=>{var Yt,ie=Wt(810),L=Symbol.for("react.element"),nt=Symbol.for("react.fragment"),c=Object.prototype.hasOwnProperty,$=ie.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,x={key:!0,ref:!0,__self:!0,__source:!0};function E(F,O,S){var C,H={},xt=null,Et=null;S!==void 0&&(xt=""+S),O.key!==void 0&&(xt=""+O.key),O.ref!==void 0&&(Et=O.ref);for(C in O)c.call(O,C)&&!x.hasOwnProperty(C)&&(H[C]=O[C]);if(F&&F.defaultProps)for(C in O=F.defaultProps,O)H[C]===void 0&&(H[C]=O[C]);return{$$typeof:L,type:F,key:xt,ref:Et,props:H,_owner:$.current}}Yt=nt,Rt.jsx=E,Yt=E},322:(k,Rt,Wt)=>{k.exports=Wt(837)},810:k=>{var Rt=Yt=>{var ie={};return mt.d(ie,Yt),ie},Wt=Yt=>()=>Yt;k.exports=Bt||(Bt=re.t(u,2))}},Te={};function mt(k){var Rt=Te[k];if(Rt!==void 0)return Rt.exports;var Wt=Te[k]={exports:{}};return ze[k](Wt,Wt.exports,mt),Wt.exports}mt.d=(k,Rt)=>{for(var Wt in Rt)mt.o(Rt,Wt)&&!mt.o(k,Wt)&&Object.defineProperty(k,Wt,{enumerable:!0,get:Rt[Wt]})},mt.o=(k,Rt)=>Object.prototype.hasOwnProperty.call(k,Rt);var I={};(()=>{mt.d(I,{fH:()=>Rt,r5:()=>$,Nd:()=>O,KY:()=>c,Vd:()=>H,Nr:()=>Et,D:()=>Xt,Wy:()=>Ve,zX:()=>kr,Cd:()=>Ut,Yz:()=>hr,D9:()=>Je,cb:()=>Ge,vO:()=>Me,Rx:()=>Zr,OH:()=>Ne,oR:()=>Pe,rE:()=>nr,PQ:()=>Ae,rf:()=>Q,xd:()=>Fe});var k=mt(810);const Rt=s=>(v,y)=>{const[_,D]=(0,k.useState)(()=>{const lt=s?.getState(v);return lt!==void 0?lt:(y!==void 0&&s?.setState({[v]:y},!0),y)}),q=(0,k.useCallback)(lt=>s?.setState({[v]:typeof lt=="function"?lt(s?.getState(v)):lt}),[]),dt=(0,k.useCallback)(lt=>s?.subscribe(v,lt),[]),ht=(0,k.useCallback)((lt=lt)=>s?.clean(lt),[]);return(0,k.useEffect)(()=>{s?.subscribe(v,lt=>D(lt))},[]),[_,q,dt,ht]},Wt=s=>Object.prototype.toString.call(s).slice(8,-1).toLowerCase(),Yt=s=>Wt(s)==="object",ie=s=>Wt(s)==="function",L=s=>Wt(s)==="promise"||Yt(s)&&ie(s.then),nt=(s,v=12e4,y="\u8BF7\u6C42\u8D85\u65F6\uFF01")=>{if(!L(s))return{};let _=null,D=null;return{promiseFn:new Promise((q,dt)=>{_=(ht="canceled")=>{clearTimeout(D),q({canceled:!0,errMsg:ht})},v&&(v=typeof v!="number"?12e4:v,D=setTimeout(()=>_(y),v)),s.then(ht=>{clearTimeout(D),q({result:ht,errMsg:!1})}).catch(ht=>{clearTimeout(D),dt(ht)})}),cancelFn:_}},c=()=>{const s=(0,k.useRef)([]);return(0,k.useEffect)(()=>()=>{s.current.map(v=>v.cancelFn()),s.current=[]},[]),{cancelablePromise:(0,k.useCallback)((v,y=!0)=>{const _=nt(v,y);return s.current.indexOf(_)===-1&&s.current.push(_),_.promiseFn},[])}},$=(s={})=>{const{cancelablePromise:v}=c(),[y,_]=(0,k.useState)(s),D=(0,k.useRef)({}),q=(0,k.useRef)({}),dt=(0,k.useCallback)((lt=null)=>{Array.isArray(lt)&&lt.length?lt.map(It=>D.current[It]=s[It]):D.current=s},[]),ht=(0,k.useCallback)((lt,It,we=!1)=>{const Be=Object.keys(lt),Oe=JSON.stringify(Be.sort());if(!q.current[Oe]){q.current[Oe]=!0,we&&dt(Array.isArray(we)?we:Be),Be.map(fe=>{D.current[fe]||(D.current[fe]={}),D.current[fe].pending=!0}),_({...D.current});for(let fe=0,ir=Be.length;fe<ir;fe++){const mr=Be[fe];v(lt[mr]).then(De=>{let{result:Ue,errMsg:Le}=De;fe===ir-1&&(q.current[Oe]=!1),typeof It=="function"&&(Ue=It(Ue)||Ue),D.current[mr]={...Ue,pending:!1},Le===!1&&_({...D.current})}).catch(De=>{throw fe===ir-1&&(q.current[Oe]=!1),D.current[mr]={error:De,pending:!1},_({...D.current}),De})}}},[]);return[y,ht,dt]},x=s=>/^https?:\/\/[^\s/?.#]+\.[^\s]+/.test(s),E=s=>new Promise((v,y)=>{const _=new FileReader;_.readAsDataURL(s),_.addEventListener("load",()=>v(_.result)),_.addEventListener("error",D=>y(D))}),F=async s=>{if(!x(s))return s;const v=await(await fetch(s)).blob();return await E(v)},O=s=>{const[v,y]=(0,k.useState)(s);return(0,k.useEffect)(()=>{(async _=>{const D=await F(_);y(D)})(s)},[]),v},S=(s,v)=>Object.prototype.hasOwnProperty.call(s??{},v),C=s=>S(s,"current"),H=(s,v,y="click")=>{(0,k.useEffect)(()=>{const _=q=>{const dt=C(s)?s.current:s;dt?.contains&&!dt.contains(q.target)&&v(q)},D=typeof y=="string"?[y]:y;return D.map(q=>{document.addEventListener(q,_,!1)}),()=>{D.map(q=>{document.removeEventListener(q,_,!1)})}},[s,v,y])},xt=(s=()=>{},v=60)=>{let y=null;return function(..._){clearTimeout(y),y=setTimeout(()=>s.apply(this,_),v)}},Et=(s,v=60)=>(0,k.useMemo)(()=>xt(s,v),[v]),Ut=()=>{const s=(0,k.useRef)(!0);return s.current?(s.current=!1,!0):!1},Q=(s,v=[])=>{const y=Ut();(0,k.useEffect)(()=>{if(!y)return s()},v)},Xt=(s,v=450)=>{const[y,_]=(0,k.useState)(s);return Q(()=>{let D;return s||v===0?_(s):D=setTimeout(()=>_(s),v),()=>D&&clearTimeout(D)},[s]),[y,_]},St=()=>![typeof window,typeof document].includes("undefined"),qt=s=>Wt(s).indexOf("element")>-1,ae=(s=null)=>St()?qt(s)?{width:s.clientWidth,height:s.clientHeight}:{width:window.innerWidth??document.documentElement.clientWidth,height:window.innerHeight??document.documentElement.clientHeight}:{width:0,height:0},oe=(s,v)=>{const y=[],_=s.children??[];for(let D=0,q=_.length;D<q;D++){const dt=_[D];dt.className.indexOf(v)>-1&&y.push(dt)}return y.length===0?null:y.length===1?y[0]:y},K=(s,v)=>{getComputedStyle(s).position==="static"&&(s.style.position="relative");const y=document.createElement("object");return y.setAttribute("style","display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0"),y.setAttribute("class","resize-sensor"),y.onload=()=>{y.contentDocument.defaultView.addEventListener("resize",v,!1),v()},y.type="text/html",s.appendChild(y),y.data="about:blank",y},de=(s,v=60)=>{if(!St())return;s=C(s)?s.current:s??document.body;let y=oe(s,"resize-sensor"),_=[];const D=xt(()=>_.map(lt=>lt(s)),v),q=lt=>{oe(s,"resize-sensor")||(y=K(s,D)),_.indexOf(lt)===-1&&_.push(lt)},dt=lt=>{const It=_.indexOf(lt);It!==-1&&_.splice(It,1),_.length===0&&y&&ht()},ht=()=>{y&&y.parentNode&&(y.contentDocument&&y.contentDocument.defaultView.removeEventListener("resize",D,!1),y.parentNode.removeChild(y),y=void 0,_=[])};return{element:s,bind:q,unbind:dt,destroy:ht}},Ge=(s={})=>{const v=(0,k.useRef)(0),[y,_]=(0,k.useState)(s),D=(0,k.useCallback)(q=>{cancelAnimationFrame(v.current),v.current=requestAnimationFrame(()=>_(q))},[]);return(0,k.useEffect)(()=>()=>cancelAnimationFrame(v.current),[]),[y,D]},Ve=(s=null,v=60)=>{const y=C(s)?s.current:s,{bind:_,destroy:D}=de(y,v),[q,dt]=Ge(ae(y));return(0,k.useEffect)(()=>(_(()=>y&&dt(ae(y))),()=>D()),[y]),q},kr=s=>{const v=(0,k.useRef)(null);return(0,k.useLayoutEffect)(()=>{v.current=s}),(0,k.useCallback)(v.current,[])},hr=(s,v)=>{const y=(0,k.useRef)();(0,k.useEffect)(()=>{y.current=s},[s]),(0,k.useEffect)(()=>{if(v){const _=setInterval(()=>y.current(),v);return()=>clearInterval(_)}},[v])},Je=s=>{const v=(0,k.useRef)();return(0,k.useEffect)(()=>{v.current=s},[s]),v.current},Cr=(s=null)=>St()?qt(s)?{left:s.scrollLeft,top:s.scrollTop}:{left:window.pageXOffset??document.documentElement.scrollLeft??document.body.scrollLeft,top:window.pageYOffset??document.documentElement.scrollTop??document.body.scrollTop}:{left:0,top:0},Me=(s=null)=>{const[v,y]=Ge(Cr(s));return(0,k.useEffect)(()=>{const _=()=>y(Cr(s)),D=qt(s)?s:window;return D.addEventListener("scroll",_,{capture:!1,passive:!0}),()=>D.removeEventListener("scroll",_)},[s]),v},fr=s=>Wt(s)==="array",ce=s=>fr(s)&&!!s.length,Er=(s,v,y=[],_=!1,D=null)=>ce(s)?v?(y=typeof y=="string"?y.split(","):y,s.filter(q=>(y=y.length>0?y:Object.keys(q),y.filter(dt=>{const ht=q[dt];if(ht==null)return!1;if(_)return ht===v;const lt=new RegExp(v,"gi"),It=ht.toString().match(lt);return It&&D&&(q[dt]=D(ht.toString().replace(lt,`<span style="background-color:yellow">${It[0]}</span>`),{display:"inline-block"})),It}).length))):s:[],$e=(s,v="id")=>{if(!ce(s))return s;const y=[],_=[];return s.map(D=>{const q=Yt(D)?D[v]:D;_.includes(q)||(_.push(q),y.push(D))}),y},He=s=>s?.$$typeof&&typeof s.$$typeof=="symbol"&&s.$$typeof.description==="react.element",he=s=>s?.__v_isVNode,jr=s=>{if(!fr(s)&&!Yt(s))return s;const v=fr(s)?[]:{};for(const y in s)if(S(s,y)){const _=s[y];v[y]=He(_)||he(_)||typeof _!="object"?_:_!==s?jr(_):"cyclic"}else Object.setPrototypeOf(v,{[y]:s[y]});return v},ne=jr,zr=s=>(v,y="children")=>{if(!Array.isArray(v))return v;const _=ne(v),D=q=>{const dt=[];return q.map(ht=>{if(ce(ht[y])){const lt=D(ht[y])||[];ht[y]=lt,lt.length>0&&dt.push(ht)}}),s(q,dt)};return D(_)},Qe=(s,v,y,_="name",D="id",q="children",dt=!1)=>zr((ht,lt)=>$e([...Er(ht,v,_,dt,y),...lt],D))(s,q);var Yr=mt(322);const pr=(s,v)=>(0,Yr.jsx)("div",{dangerouslySetInnerHTML:{__html:s},...v}),Zr=(s=null,v=pr)=>{const[y,_]=(0,k.useState)(s),D=(0,k.useCallback)((...q)=>{const[dt,ht,...lt]=q;if(!ht)_(null);else{q=[dt,ht,v,...lt];const It=Qe(...q);_(It)}},[]);return[y,D]},Ne=s=>{const[v,y]=(0,k.useState)(s);return(0,k.useEffect)(()=>y(s),[s]),[v,y]},Ie=()=>{const s={};return{on:(v,y)=>{s[v]||(s[v]=[]),s[v].indexOf(y)===-1&&s[v].push(y)},emit:(v,y)=>{s[v]&&s[v].map(_=>_(y))},off:(v,y=null)=>{if(s[v]){if(typeof y!="function")return delete s[v];const _=s[v].indexOf(y);_>-1&&(s[v].splice(_,1),s[v].length||delete s[v])}}}},tr=s=>{const v={};for(let y in s)S(s,y)||(v[y]=s[y]);return v},_e=(s,v)=>{if(!Yt(s))return v;if(!Yt(v))return s;const y={...tr(s),...tr(v)},_={...s,...v};return Object.keys(y).map(D=>{Object.setPrototypeOf(_,{[D]:y[D]})}),_},er=(()=>{const{on:s,emit:v,off:y}=Ie(),_={};return{getState:D=>ne(_[D]),setState:(D,q=!1)=>{if(typeof D=="function"&&(D=D(ne(_))),!Yt(D))throw TypeError("\u5FC5\u987B\u4F20\u5165object\u5BF9\u8C61\uFF01");const dt=ne(D);Object.keys(dt).map(ht=>{const lt=_[ht],It=dt[ht],we=Yt(It)&&Yt(lt)?_e(lt,It):It;!q&&v(ht,we),_[ht]=we})},subscribe:(D,q)=>(s(D,q),()=>y(D,q)),unsubscribe:y,clean:D=>{typeof D=="string"?_[D]=void 0:Array.isArray(D)?D.map(q=>_[q]=void 0):Object.keys(_).map(q=>_[q]=void 0)}}})(),Pe=Rt(er),ve=s=>s<10?"0"+s:s,Vr=(s=new Date)=>{const v=new Date(s),y=v.getFullYear(),_=v.getDay(),D=ve(v.getMonth()+1),q=ve(v.getDate()),dt=ve(v.getHours()),ht=ve(v.getMinutes()),lt=ve(v.getSeconds());return[y,D,q,dt,ht,lt,_]},rr=["\u661F\u671F\u65E5","\u661F\u671F\u4E00","\u661F\u671F\u4E8C","\u661F\u671F\u4E09","\u661F\u671F\u56DB","\u661F\u671F\u4E94","\u661F\u671F\u516D"],Mr=(s,v,y="-")=>s.replace(new RegExp(y,"g"),v),Se=(s=new Date,v=["-","-"," ",":",":",""],y=rr)=>{const _=Vr(s);let D="";return v.map((q,dt)=>D+=(dt===6?y[_[dt]]:_[dt]??"")+q),D},or=()=>Se(new Date,["-","-"," ",":",":"," ",""]),nr=()=>{const[s,v]=(0,k.useState)("");return hr(()=>{v(or())},1e3),[s]},Hr=s=>++s,Ae=()=>{const[,s]=(0,k.useState)(0);return(0,k.useCallback)(()=>s(Hr),[])},Fe=()=>{const[s,v]=Ge(ae());return(0,k.useEffect)(()=>{const y=()=>v(ae());return window.addEventListener("resize",y,!1),()=>window.removeEventListener("resize",y,!1)},[]),s}})();var ut=I.fH,jt=I.r5,Wr=I.Nd,Vt=I.KY,Ht=I.Vd,N=I.Nr,V=I.D,B=I.Wy,Z=I.zX,M=I.Cd,tt=I.Yz,G=I.D9,rt=I.cb,vt=I.vO,wt=I.Rx,Ft=I.OH,Nt=I.oR,ct=I.rE,_t=I.PQ,Lt=I.rf,Mt=I.xd},1090:function(Rr,$t,re){re.d($t,{A_F:function(){return Ki},JaC:function(){return Ni},MTn:function(){return Bi},NA2:function(){return Mi},PTJ:function(){return Zi},Vcq:function(){return Ji},_O2:function(){return ta},_iG:function(){return Li},afD:function(){return Yi},azd:function(){return Qi},eyl:function(){return Vi},f9u:function(){return ra},fHt:function(){return Ai},gVz:function(){return qi},jg2:function(){return Xi},k$y:function(){return ea},mrB:function(){return Wi},muM:function(){return Ii},qg7:function(){return Ri},rWO:function(){return Hi},tOc:function(){return Gi},vQq:function(){return Pi},ywV:function(){return Ui}});var Bt={};(function(){Bt.d=function(t,e){for(var r in e)Bt.o(e,r)&&!Bt.o(t,r)&&Object.defineProperty(t,r,{enumerable:!0,get:e[r]})}})(),function(){Bt.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)}}();var u={};Bt.d(u,{NzM:function(){return Te},wBC:function(){return N},O39:function(){return B},cnu:function(){return G},E4D:function(){return vt},TRp:function(){return Ft},zI1:function(){return ct},Ufj:function(){return Lt},GxO:function(){return Wt},cu2:function(){return ie},BcS:function(){return nt},lPd:function(){return xt},dC1:function(){return Ut},$L2:function(){return Xt},Vji:function(){return $},YxP:function(){return C},UhT:function(){return ce},JaC:function(){return $e},o4B:function(){return ne},Hlr:function(){return rr},muM:function(){return D},OiV:function(){return er},KTn:function(){return dt},lwL:function(){return lt},d9v:function(){return y},yCD:function(){return we},qCK:function(){return Oe},vQq:function(){return ir},fHt:function(){return De},azq:function(){return $r},dSY:function(){return b},MTn:function(){return A},RYO:function(){return Le},WAo:function(){return zt},GVc:function(){return Se},Emy:function(){return yt},v9O:function(){return Ot},DsO:function(){return it},_lj:function(){return Kt},vO6:function(){return se},xDX:function(){return yr},hf3:function(){return Gr},ip7:function(){return Do},uYe:function(){return p},DgJ:function(){return nr},rae:function(){return po},YBu:function(){return eo},_iG:function(){return go},hXT:function(){return Ir},gQq:function(){return wo},D_D:function(){return ro},$nD:function(){return ko},dtG:function(){return Eo},Y0R:function(){return vr},qg7:function(){return Ro},Xxf:function(){return jo},tSM:function(){return i},Few:function(){return f},xHg:function(){return R},aoj:function(){return ot},Dlm:function(){return Gt},mrB:function(){return Zt},dKu:function(){return Ke},v1d:function(){return Dr},afD:function(){return ur},Lz5:function(){return an},xZX:function(){return Vo},G_1:function(){return zo},osI:function(){return Mo},PTJ:function(){return cn},Qfx:function(){return un},bti:function(){return Ye},XBv:function(){return dn},eyl:function(){return hn},y35:function(){return fn},hKD:function(){return st},BWC:function(){return Ho},oLi:function(){return I},NA2:function(){return xn},S3Y:function(){return ye},pvT:function(){return Uo},m2f:function(){return oe},rWO:function(){return yn},A$w:function(){return gn},kJL:function(){return jt},S9U:function(){return tr},dYC:function(){return me},jUY:function(){return k},J_U:function(){return bn},kKo:function(){return M},VZO:function(){return vn},mf2:function(){return Ne},w1q:function(){return wn},Kn2:function(){return E},ncl:function(){return kn},LWC:function(){return Ae},dqb:function(){return de},Kjn:function(){return Cn},TaN:function(){return $o},CBv:function(){return We},rTd:function(){return Nr},B73:function(){return En},SSA:function(){return s},CLv:function(){return jn},F$z:function(){return zn},XT_:function(){return Xo},omS:function(){return $n},poV:function(){return _n},VXY:function(){return Sn},xsP:function(){return Fn},HPs:function(){return On},TSy:function(){return Dn},B5o:function(){return _o},u1A:function(){return Tn},WAY:function(){return So},I8J:function(){return X},ywV:function(){return Bn},bEN:function(){return Ln},$45:function(){return Rn},TUk:function(){return Wn},T7B:function(){return O},CEd:function(){return Yn},IHq:function(){return Zn},SkG:function(){return Go},Smz:function(){return pr},nL5:function(){return Qe},ON:function(){return Hn},eiS:function(){return Un},Frc:function(){return Xn},z5J:function(){return qn},scT:function(){return Kn},hd2:function(){return Oo},AnA:function(){return Gn},kYX:function(){return Jn},yZP:function(){return Qn},IVd:function(){return Fo},SIr:function(){return ei},jg2:function(){return ri},gVz:function(){return oi},puc:function(){return ai},Azz:function(){return li},X5u:function(){return Ve},dPh:function(){return si},SMZ:function(){return qt},kro:function(){return Vt},nPi:function(){return ci},US:function(){return ui},A_F:function(){return ge},_vH:function(){return qr},gmH:function(){return Ce},DYV:function(){return di},qi2:function(){return hi},tOc:function(){return fi},hau:function(){return mi},FaZ:function(){return sr},uyF:function(){return xi},Vcq:function(){return yi},XKW:function(){return gi},azd:function(){return he},P2K:function(){return bi},XBe:function(){return Ci},JZ7:function(){return rn},ABi:function(){return ue},ogC:function(){return Ei},_O2:function(){return j},P0C:function(){return ji},Uo5:function(){return zi},Two:function(){return vo},tYQ:function(){return $i},tVn:function(){return a},pHy:function(){return _i},k$y:function(){return xr},yfi:function(){return Si},fl8:function(){return Fi},f9u:function(){return Oi},ZV1:function(){return Di},Lgs:function(){return Ti}});var Te=(t,e="key",r="value")=>{const o={};return(t||[]).map(n=>o[n[e]]=n[r]),o},I=t=>Object.prototype.toString.call(t).slice(8,-1).toLowerCase(),jt=t=>I(t)==="array",Vt=t=>(e,r,o="id",n="children")=>{if(!jt(e))return null;const d=(m,z="")=>{for(let T=0,J=m.length;T<J;T++){const pt=m[T];if(pt[o]===r)return t(m,T,z)||m[T];if(jt(pt[n])){const te=d(pt[n],pt[o]);if(te)return te}}};return d(e),e},N=(t,e,r,o="id",n="children")=>Vt((d,m)=>d.splice(m,0,r))(t,e,o,n),B=(t,e,r,o,n="id",d="children")=>Vt((m,z)=>{const T=m[z];T.children?T.children.splice(o,0,r):T.children=[r]})(t,e,n,d),M=t=>I(t).indexOf("element")>-1,G=(t,e="")=>{if(!M(t))return;const r=e.split(" ").filter(Boolean),o=t.className.split(" "),n=[...new Set([...r,...o])];t.className=n.join(" ")},vt=(t,e=new Date)=>{const r=new Date(e);return r.setDate(r.getDate()+t),r},Ft=(t,e=new Date)=>{const r=new Date(e);return r.setHours(r.getHours()+t),r},ct=(t,e=new Date)=>{const r=new Date(e);return r.setMonth(r.getMonth()+t),r},Lt=(t,e,r,o="id",n="children")=>Vt((d,m)=>{const z=d[m];return z[n]=[...z[n]||[],...r],z})(t,e,o,n),k=()=>![typeof window,typeof document].includes("undefined"),Wt=t=>{if(k())return new Promise((e,r)=>{if([...document.getElementsByTagName("script")].find(o=>o.src===t))e();else{const o=document.createElement("script");o.onerror=n=>r(new Error(`Failed to load '${t}'`)),o.onload=e,o.src=t,(document.head||document.getElementsByTagName("head")[0]).appendChild(o)}})},ie=(t,e)=>{if(k())return e?new Promise((r,o)=>{if([...document.getElementsByTagName("style")].map(n=>n.getAttribute("huxy-css-hash")).filter(Boolean).find(n=>n===e))r();else{const n=document.createElement("style");n.onerror=d=>o(new Error(`Failed to load '${e}' style`)),n.onload=r,n.innerHTML=t,n.setAttribute("huxy-css-hash",e),(document.head||document.getElementsByTagName("head")[0]).appendChild(n)}}):new Promise((r,o)=>{if([...document.getElementsByTagName("link")].find(n=>n.href===t))r();else{const n=document.createElement("link");n.onerror=d=>o(new Error(`Failed to load '${t}'`)),n.onload=r,n.href=t,n.rel="stylesheet",(document.head||document.getElementsByTagName("head")[0]).appendChild(n)}})},nt=(t,e=new Date)=>{const r=new Date(e);return r.setFullYear(r.getFullYear()+t),r},$=(t=[],e="name")=>{const r={};return t.map(({[e]:o,value:n})=>r[o]=n),r},E=t=>I(t)==="object";const F=(t={})=>{let e="";return Object.keys(t).map(r=>{const o=t[r];e=e&&`${e}, `,E(o)?e+=`${r}=${F(o)}`:Array.isArray(o)?e+=`${r}=${C(o)}`:e+=`${r}=${o}`}),`{${e}}`};var O=F;const S=(t=[])=>{let e="";return t.map(r=>{e=e&&`${e}, `,E(r)?e+=O(r):Array.isArray(r)?e+=S(r):e+=`${r}`}),`[${e}]`};var C=S,xt=t=>(e,r="id",o="children",n=-1)=>{if(!jt(e))return e;const d={},m=e.map(z=>z[r]);return[...e].map(z=>{const T={...z},{[r]:J}=T;if(J!=null){let{parentId:pt}=T;pt==null&&(pt=t?.(T)??n,T.parentId=pt),d[J]||(d[J]=[]),T[o]=d[J],d[pt]||(d[pt]=[]),d[n]||(d[n]=[]),m.includes(pt)?d[pt].push(T):d[n].push(T)}}),d[n]},Ut=(t,e="id",r="children",o=-1)=>xt(n=>n[e].match(/\S+(?=-\S+)/)?.[0]||o)(t,e,r,o),Xt=(t,e="path",r="children",o=null)=>xt(n=>{const d=n[e],m=d.match(/.*\/[^:/]+\/:[^/]+/);return m?m[0].match(/(.*)\/:+/)?.[1]??o:d.match(/(.*)\/+/)?.[1]??o})(t,e,r,o),qt=()=>k()&&(window.pageYOffset??document.documentElement.scrollTop??document.body.scrollTop),oe=(t,e)=>Object.prototype.hasOwnProperty.call(t??{},e),de=t=>oe(t,"current"),Ve=(t=0,e)=>{k()&&(e=de(e)?e.current:e??window,e.scrollTo?.({top:t,behavior:"smooth"}))},hr=`.huxy-totop-bar {
  --size: 36px;
  --color: #fff;
  --bgColor: #666;
  --hoverBgColor: #40a9ff;
...
`;var Hn={xml2Obj:Vn,obj2Xml:(t,e)=>{let r="";return Object.keys(t).map(o=>{r+=Mn(o,e[o],t[o])}),`<xml>
    ...
    background-image:url('${Lr}')`),t.style.position="relative",t.insertBefore(dr,t.firstChild)},Di=(t=new Date)=>{const e=new Date(t).getDay();return[vt(1-e),vt(7-e)]},Ti=t=>{if(!tr(t))return{};let e="pending",r;const o=t.then(n=>{e="success",r=n}).catch(n=>{e="error",r=n});return{read:()=>{if(e==="pending")throw o;if(e==="error")throw r;if(e==="success")return r}}},$l=u.NzM,_l=u.wBC,Sl=u.O39,Fl=u.cnu,Ol=u.E4D,Dl=u.TRp,Tl=u.zI1,Nl=u.Ufj,Il=u.GxO,Pl=u.cu2,Al=u.BcS,Bl=u.lPd,Ll=u.dC1,Rl=u.$L2,Wl=u.Vji,Yl=u.YxP,Zl=u.UhT,Ni=u.JaC,Vl=u.o4B,Ml=u.Hlr,Ii=u.muM,Hl=u.OiV,Ul=u.KTn,Xl=u.lwL,ql=u.d9v,Kl=u.yCD,Gl=u.qCK,Pi=u.vQq,Ai=u.fHt,Jl=u.azq,Ql=u.dSY,Bi=u.MTn,ts=u.RYO,es=u.WAo,rs=u.GVc,os=u.Emy,ns=u.v9O,is=u.DsO,as=u._lj,ls=u.vO6,ss=u.xDX,cs=u.hf3,us=u.ip7,ds=u.uYe,hs=u.DgJ,fs=u.rae,ps=u.YBu,Li=u._iG,ms=u.hXT,xs=u.gQq,ys=u.D_D,gs=u.$nD,bs=u.dtG,vs=u.Y0R,Ri=u.qg7,ws=u.Xxf,ks=u.tSM,Cs=u.Few,Es=u.xHg,js=u.aoj,zs=u.Dlm,Wi=u.mrB,$s=u.dKu,_s=u.v1d,Yi=u.afD,Ss=u.Lz5,Fs=u.xZX,Os=u.G_1,Ds=u.osI,Zi=u.PTJ,Ts=u.Qfx,Ns=u.bti,Is=u.XBv,Vi=u.eyl,Ps=u.y35,As=u.hKD,Bs=u.BWC,Ls=u.oLi,Mi=u.NA2,Rs=u.S3Y,Ws=u.pvT,Ys=u.m2f,Hi=u.rWO,Zs=u.A$w,Vs=u.kJL,Ms=u.S9U,Hs=u.dYC,Us=u.jUY,Xs=u.J_U,qs=u.kKo,Ks=u.VZO,Gs=u.mf2,Js=u.w1q,Qs=u.Kn2,tc=u.ncl,ec=u.LWC,rc=u.dqb,oc=u.Kjn,nc=u.TaN,ic=u.CBv,ac=u.rTd,lc=u.B73,sc=u.SSA,cc=u.CLv,uc=u.F$z,dc=u.XT_,hc=u.omS,fc=u.poV,pc=u.VXY,mc=u.xsP,xc=u.HPs,yc=u.TSy,gc=u.B5o,bc=u.u1A,vc=u.WAY,wc=u.I8J,Ui=u.ywV,kc=u.bEN,Cc=u.$45,Ec=u.TUk,jc=u.T7B,zc=u.CEd,$c=u.IHq,_c=u.SkG,Sc=u.Smz,Fc=u.nL5,Oc=u.ON,Dc=u.eiS,Tc=u.Frc,Nc=u.z5J,Ic=u.scT,Pc=u.hd2,Ac=u.AnA,Bc=u.kYX,Lc=u.yZP,Rc=u.IVd,Wc=u.SIr,Xi=u.jg2,qi=u.gVz,Yc=u.puc,Zc=u.Azz,Vc=u.X5u,Mc=u.dPh,Hc=u.SMZ,Uc=u.kro,Xc=u.nPi,qc=u.US,Ki=u.A_F,Kc=u._vH,Gc=u.gmH,Jc=u.DYV,Qc=u.qi2,Gi=u.tOc,tu=u.hau,eu=u.FaZ,ru=u.uyF,Ji=u.Vcq,ou=u.XKW,Qi=u.azd,nu=u.P2K,iu=u.XBe,au=u.JZ7,lu=u.ABi,su=u.ogC,ta=u._O2,cu=u.P0C,uu=u.Uo5,du=u.Two,hu=u.tYQ,fu=u.tVn,pu=u.pHy,ea=u.k$y,mu=u.yfi,xu=u.fl8,ra=u.f9u,yu=u.ZV1,gu=u.Lgs}}]);
